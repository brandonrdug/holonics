...
**Scheduler:** [`THE_ROADMAP.md`](../../docs/plans/THE_ROADMAP.md) records `**RH line position:** DB complete`.
...
[definition] **Jurisdiction.** The RH line is mathematics on octets in `formal/`; no
