...
adapters**. The only crossing is `crates/holonic-life/src/exact_world.rs`, 95 lines, exercised by **1 of 27**
...
**5 · Plate I/O.** Each of the ~25 `crates/holonic-life/examples` sites keeps its hash **and** writes the
