...
#include <holonics/codec/hodge_realization_explanation_renderer.hpp>
#include <holonics/codec/hodge_realization_renderer.hpp>
...
#include <holonics/event/hodge_realization_surface_law.hpp>
#include <holonics/organ/hodge_realization_law.hpp>

namespace holonics::event {
class resident_hodge_realization final {
 public:
  resident_hodge_realization() = delete;
  resident_hodge_realization(const resident_hodge_realization&) = delete;
  resident_hodge_realization& operator=(const resident_hodge_realization&) = delete;
  resident_hodge_realization(resident_hodge_realization&&) = delete;
  resident_hodge_realization& operator=(resident_hodge_realization&&) = delete;
  HOLONICS_CALLABLE resident_hodge_realization(const organ::hodge_realization_foundation& foundation,
      const expression_geometry_rest_record& record,
      expression_geometry_remount_receipt& receipt) noexcept;
  HOLONICS_CALLABLE resident_hodge_realization(const hodge_realization_rest_record& record,
  ...
  [[nodiscard]] HOLONICS_CALLABLE bool form(hodge_realization_observation& out) noexcept;
  [[nodiscard]] HOLONICS_CALLABLE bool resume(const checker_raw_return& raw,
      hodge_realization_observation& out) noexcept;
  [[nodiscard]] HOLONICS_CALLABLE hodge_realization_rest_receipt rest(
 ...
 private:
  ...
  organ::hodge_realization_foundation foundation_{}; body::continuing_body body_;
...
static_assert(std::is_trivially_destructible_v<resident_hodge_realization>);
