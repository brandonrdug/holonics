...
#include <holonics/event/phase_crystal_return.hpp>

namespace holonics::event::phase_crystal_checker_detail {
...
HOLONICS_CALLABLE constexpr void normalize(const checker_raw_return& raw,
    const codec::phase_crystal_face& face, checker_typed_return& typed) noexcept {
  constexpr char declaration[] = "Soma.Holonics.R18.generated_coprime_diagonal_return";
  constexpr char source[] = "theorem generated_coprime_diagonal_return";
