...
add_library(r21_blind_reconstruction_store STATIC
  src/apparatus/host/blind_reconstruction_card_adapter.cpp
  src/apparatus/host/blind_reconstruction_store_adapter.cpp)
...
add_library(r21_blind_reconstruction_executor STATIC
  ...
  src/cuda/executor/r21_blind_reconstruction_executor.cu
  src/cuda/executor/r21_blind_reconstruction_kernels.cu
  src/cuda/executor/r21_blind_reconstruction_probe.cu)
...
add_executable(r21_blind_reconstruction_device_deed
  src/apparatus/host/r21_blind_reconstruction_deed.cpp
...
set(R21_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/src/cuda/executor/r21_blind_reconstruction_kernels.cu")
...
set(R21_DECLARED_COMMANDS
  "device_ptx=<CUDA_COMPILER> ${R21_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r21_blind_reconstruction_kernels.cu -o <BUILD>/generated/r21_blind_reconstruction_kernels.ptx\n"
  "device_cubin=<CUDA_COMPILER> ${R21_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r21_blind_reconstruction_kernels.cu -o <BUILD>/generated/r21_blind_reconstruction_kernels.cubin\n"
...
holonic_found(NAME r21.blind_reconstruction_device_deed
  ...
  COMMAND
    ...
    "${PROJECT_SOURCE_DIR}/src/apparatus/cards/R21_BINARY_CODE_PROBLEM.card"
    "${PROJECT_SOURCE_DIR}/src/apparatus/cards/R21_GAPCVP_MOMENTS.card" "${R21_CODE_SOURCE}"
