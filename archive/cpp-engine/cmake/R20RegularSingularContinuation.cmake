...
add_library(r20_regular_singular_store STATIC
  src/apparatus/host/regular_singular_store_adapter.cpp)
...
add_library(r20_regular_singular_executor STATIC
  ...
  src/cuda/executor/r20_regular_singular_executor.cu
  src/cuda/executor/r20_regular_singular_kernels.cu)
...
add_executable(r20_regular_singular_device_deed
  src/apparatus/host/r20_regular_singular_deed.cpp
...
set(R20_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/src/cuda/executor/r20_regular_singular_kernels.cu")
...
set(R20_DECLARED_COMMANDS
  "device_ptx=<CUDA_COMPILER> ${R20_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r20_regular_singular_kernels.cu -o <BUILD>/generated/r20_regular_singular_kernels.ptx\n"
  "device_cubin=<CUDA_COMPILER> ${R20_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r20_regular_singular_kernels.cu -o <BUILD>/generated/r20_regular_singular_kernels.cubin\n"
