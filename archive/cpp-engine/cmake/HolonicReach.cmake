...
file(GLOB_RECURSE reach_headers LIST_DIRECTORIES false
  "${SCAN_ROOT}/src/include/holonics/*.hpp" "${SCAN_ROOT}/src/include/holonics/*.cuh")
...
foreach(path IN LISTS reach_headers)
  ...
  foreach(line IN LISTS lines)
    ...
    set(edge "${SCAN_ROOT}/src/include/holonics/${target}")
...
foreach(seed IN LISTS reach_seeds)
  set(path "${SCAN_ROOT}/src/include/holonics/${seed}")
  if(NOT EXISTS "${path}")
