...
add_library(r34_trace_fiber_store STATIC src/apparatus/host/trace_fiber_card_adapter.cpp
  src/apparatus/host/trace_fiber_rest_adapter.cpp)
target_link_libraries(r34_trace_fiber_store PRIVATE holonics::apparatus holonics_contract_options)
add_library(r34_trace_fiber_executor STATIC src/apparatus/host/lean_checker_process.cpp
  src/apparatus/host/returned_theorem_checker_process.cpp src/cuda/executor/r34_trace_fiber_currents.cu
  src/cuda/executor/r34_trace_fiber_kernels.cu src/cuda/executor/r34_heldout_trace_fiber_kernels.cu
  src/cuda/executor/r34_trace_fiber_discovery_executor.cu
  src/cuda/executor/r34_trace_fiber_application_executor.cu)
...
add_executable(r34_trace_fiber_discovery_device_deed
  src/apparatus/host/r34_trace_fiber_discovery_deed.cpp)
...
add_executable(r34_trace_fiber_application_device_deed
  src/apparatus/host/r34_trace_fiber_application_deed.cpp)
...
set(R34_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/src/cuda/executor/r34_trace_fiber_kernels.cu")
...
set(R34_HELDOUT_DEVICE_SOURCE
  "${PROJECT_SOURCE_DIR}/src/cuda/executor/r34_heldout_trace_fiber_kernels.cu")
...
set(R34_DECLARED_COMMANDS
  "device_ptx=<CUDA_COMPILER> ${R34_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r34_trace_fiber_kernels.cu -o <BUILD>/generated/r34_trace_fiber_kernels.ptx\n"
  "device_cubin=<CUDA_COMPILER> ${R34_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r34_trace_fiber_kernels.cu -o <BUILD>/generated/r34_trace_fiber_kernels.cubin\n"
  "heldout_device_ptx=<CUDA_COMPILER> ${R34_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r34_heldout_trace_fiber_kernels.cu -o <BUILD>/generated/r34_heldout_trace_fiber_kernels.ptx\n"
  "heldout_device_cubin=<CUDA_COMPILER> ${R34_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r34_heldout_trace_fiber_kernels.cu -o <BUILD>/generated/r34_heldout_trace_fiber_kernels.cubin\n"
