#!/usr/bin/env python3
"""Require the live framework authority, public interfaces and standing owners in the Git index."""
...
REQUIRED = [
    ...
    "docs/plans/THE_HNA_FRAMEWORK_HAS_ONE_PUBLIC_LIFECYCLE_AND_ONE_NAVIGABLE_REPOSITORY.md",
    "crates/holonics/src/lib.rs",
    "crates/holonics-hna/src/hna.rs",
    "applications/holonics-workbench/src/adapters/hna.rs",
    "AGENTS.md",
    "CLAUDE.md",
    "CONSTRUCTION_STATE.md",
    "docs/plans/THE_ROADMAP.md",
    "archive/plans/THE_HOLONIC_INTELLIGENCE_FRAMEWORK_RETURNS_INTRINSIC_HOLONS_AND_PACKAGES_DISMANTLING_INFERENCE_CULTIVATION_AND_GENERATION.md",
    "archive/plans/THE_HOLONIC_NEURAL_ECOLOGY_RETURNS_EVERY_CLASSICAL_ARCHITECTURE_AS_A_RECEIVER_CHART_AND_EROS_CULTIVATES_ATHENA_THROUGH_PHYSICAL_INFORMATION_TRANSPORT.md",
    "archive/plans/THE_CLASSICAL_MACHINE_LEARNING_CHART_DESCENDS_FROM_HOLONIC_TRANSPORT_AND_HIGHER_CAUSAL_FIBRES_REOPEN_ITS_COLLAPSED_STATES.md",
    ...
    "crates/holonic-life/src/native_intelligence/source_neutral_relational.rs",
    "crates/holonic-life/src/native_intelligence/source_neutral_rest.rs",
    "formal/elementary-holonics/ElementaryHolonics/Computation/HolonicMachineLearning.lean",
    "formal/elementary-holonics/ElementaryHolonics/Computation/IntrinsicHolonProfile.lean",
    "formal/elementary-holonics/ElementaryHolonics/Computation/HolonicIntelligenceLifecycle.lean",
    "formal/elementary-holonics/ElementaryHolonics/Computation/ExactForeignWeight.lean",
    "formal/elementary-holonics/ElementaryHolonics/Computation/HolonicIntelligenceFramework.lean",
    ...
    "crates/holonic-engine/src/holonic_intelligence/circulation.rs",
    "crates/holonic-engine/src/holonic_intelligence/cultivation.rs",
    "crates/holonic-engine/src/foreign_map/coverage.rs",
    "crates/holonic-engine/examples/inspect_foreign_model_charts_hif2.rs",
    "crates/holonic-engine/examples/inspect_native_inference_circulation_hif3.rs",
