...
The vocabulary is read from `docs/canon/EPISTEMIC_GRADES.md`; this tool owns no parallel list. A
...
GRADES = ROOT / "docs/canon" / "EPISTEMIC_GRADES.md"
LIVE = [
    ROOT / "AGENTS.md",
    ROOT / "docs/ARCHITECTURE.md",
    ROOT / "docs/SOULKILLER.md",
    ROOT / "docs/ATHENA.md",
    ROOT / "docs/INTEROPERABILITY.md",
    ROOT / "CONSTRUCTION_STATE.md",
    ROOT / "docs/plans" / "THE_ROADMAP.md",
    ROOT
    / "archive/plans"
...
def vocabulary() -> tuple[set[str], set[str]]:
    ...
    if not truth or not evidence:
        raise RuntimeError("epistemic vocabulary could not be read from docs/canon/EPISTEMIC_GRADES.md")
