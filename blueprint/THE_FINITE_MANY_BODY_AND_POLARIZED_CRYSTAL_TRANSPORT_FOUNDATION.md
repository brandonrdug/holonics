...
**Status:** COMPLETED FORMAL CAMPAIGN UNDER [`THE_ROADMAP.md`](THE_ROADMAP.md). QLT1--QLT6
...
`rg -n "Fock|CAR|creation|annihilation" soma/formal/elementary-holonics/ElementaryHolonics -g '*.lean'`
