...
**Evidence:** `measured` where stated; the arrow's own source is `soma/body/src/arrow.rs:17-26` and
`:114-125`, read today.
...
**Plan:** sits under [`blueprint/THE_ROADMAP.md`](THE_ROADMAP.md). It supersedes nothing and it is
...
**`soma/body/src/arrow.rs:17-26` already carries exactly this** as `Arrow`, in the law body, which is
