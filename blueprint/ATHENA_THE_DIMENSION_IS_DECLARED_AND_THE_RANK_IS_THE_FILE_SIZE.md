...
**Plan:** sits under [`blueprint/THE_ROADMAP.md`](THE_ROADMAP.md). It succeeds
...
`canon/TABLET_THE_REASONING_CYCLE.md` already types it: *router → conditional transport junction*,
