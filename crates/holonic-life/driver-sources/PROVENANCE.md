# `crates/holonic-life/driver-sources/` — the inputs the `eros_*` drivers refuse without

Twenty-four drivers under `crates/holonic-life/examples/` take a declared input file as `argv[1]` and refuse
...
| `eros-morphological-language-generation-01/` | **CONSTRUCTED** | `eros_morphological_language_generation` | built by `crates/holonic-life/examples/morphological_language/freeze_source.py`, a port of the laboratory's `experiments/causal-language/sidecar/freeze_source.py` |
...
whole and renamed. `docs/canon/THE_DOCUMENT_LAW.md` §1.8 records that this repository's live
...
carries `docs/canon/THE_DOCUMENT_LAW.md :: observations/ :: §1.8's defect row states the live
