...
const OUT: &str = ".local/artifacts/m0_mathematical_source_circulation";
const DEFAULT_OUT: &str =
    ".local/artifacts/m0_mathematical_source_circulation/m0-mathematical-source-circulation.json";
const FACE_ROOT: &str = ".local/artifacts/m0_mathematical_source_circulation/faces";
const NATURAL_SOURCE: &str = ".local/scratch/previous/pdfs/2608.13553-heat-kernel-geometry.pdf";
...
fn main() -> Result<(), String> {
    ...
    let equations = atlas_layout(&root, &run, "archive/equation-atlas/equations.jsonl")?;
    let relations = atlas_layout(&root, &run, "archive/equation-atlas/relations.jsonl")?;
    ...
    let identity_paths = [
        ...
        "research/fixtures/m0_mathematical_source_circulation/harmonic-conjugation.svg",
        ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-calibration.pdf",
        ".local/artifacts/m0_mathematical_source_circulation/faces/natural/heat-fisher-page-5-bbox.html",
        ".local/artifacts/m0_mathematical_source_circulation/faces/natural/heat-fisher-page-5.svg",
        ".local/artifacts/m0_mathematical_source_circulation/faces/natural/heat-fisher-page-5.png",
        ".local/artifacts/m0_mathematical_source_circulation/faces/natural/heat-fisher-page-10-bbox.html",
        ".local/artifacts/m0_mathematical_source_circulation/faces/natural/heat-fisher-page-10.svg",
