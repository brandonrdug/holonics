...
const DEFAULT_OUT: &str = ".local/artifacts/the_recurrent_realizations_condense_into_a_phoenix_ecology";
...
fn code_closure() -> String {
    let members: &[&[u8]] = &[
        ...
        include_bytes!(
            "../../holonic-engine/src/native_ecology/recurrent_condensation.rs"
        ),
