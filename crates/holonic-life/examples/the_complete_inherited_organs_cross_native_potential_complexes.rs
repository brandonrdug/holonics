...
const AUDIO_ROOT: &str = ".local/artifacts/the_acoustic_section_crosses_the_inherited_projection_and_three_ports_share_one_native_ecology/source-occurrences";
const IMPLEMENTED_ROOT: &str = ".local/artifacts/native_mathematical_consequence_precedes_every_codec";
const CULTIVATED_ROOT: &str = ".local/artifacts/recurring_laboratory_transport_condenses_into_native_hexis";
const E1_OPTICAL_REST: &str =
    ".local/artifacts/the_optical_holons_grow_across_scales/native-rest/standing.json";
const DEFAULT_OUT: &str = ".local/artifacts/the_complete_inherited_organs_cross_native_potential_complexes";
