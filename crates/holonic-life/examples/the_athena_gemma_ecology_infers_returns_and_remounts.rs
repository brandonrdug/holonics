...
const DEFAULT_I3_REST: &str =
    ".local/artifacts/the_recurrent_realizations_condense_into_a_phoenix_ecology/native-rest";
const DEFAULT_I4_REST: &str =
    ".local/artifacts/the_heterogeneous_ports_found_one_shared_phoenix_ecology/native-rest";
const DEFAULT_OUT: &str = ".local/artifacts/the_athena_gemma_ecology_infers_returns_and_remounts";
