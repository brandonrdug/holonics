...
const MATERIAL: &str = ".local/data/athena-sensory-world-tube/sens6-bounded";
const OUTPUT: &str = ".local/artifacts/the_holonics_hna_returns_the_internal_product_receiver_alp5";
...
fn main() -> Result<(), String> {
    ...
    let repository_bytes =
        fs::read(root.join("crates/holonic-life/src/native_intelligence/product_receiver.rs"))
            .map_err(display)?;
