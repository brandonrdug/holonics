...
const N3_REST: &str =
    ".local/artifacts/the_returned_native_mathematical_world_cultivates_the_laboratory_hexis/native-rest";
const N1_REST: &str =
    ".local/artifacts/n1_raw_optical_mathematical_recovery_complete/native-rest/standing.json";
const N2_REST: &str = ".local/artifacts/the_acoustic_section_crosses_the_inherited_projection_and_three_ports_share_one_native_ecology/native-rest";
const N0_GRADE: &str =
    ".local/artifacts/native_mathematical_consequence_precedes_every_codec/00-N0-grade.json";
...
pub fn construct(root: &Path, output: &Path) -> Result<(), String> {
    ...
    let dissection = json!({
        ...
        "ancestry": {
            ...
            "n1": artifact::digest(artifact::read(root.join(".local/artifacts/n1_raw_optical_mathematical_recovery_complete/05-grade-and-boundary.json"))?),
            "n2": artifact::digest(artifact::read(root.join(".local/artifacts/the_acoustic_section_crosses_the_inherited_projection_and_three_ports_share_one_native_ecology/02-grade.json"))?),
            "n3": artifact::digest(artifact::read(root.join(".local/artifacts/the_returned_native_mathematical_world_cultivates_the_laboratory_hexis/09-grade.json"))?),
        },
