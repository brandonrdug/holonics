...
const CORPUS_FAMILY: &[&str] = &[
    ...
    "research/papers/source/holonics/algorithms.typ",
    "research/papers/source/holonics/computation-information.typ",
    "research/papers/source/holonics/manifold-knot-geometry.typ",
    "research/papers/source/mathematics/definitions/contextual-tangle-compression.typ",
];

const PYTHON_FAMILY: &[&str] = &[
    "archive/tooling/claim_index.py",
    "soma/tools/three-arm-analysis.py",
    "soma/tools/prime-seasons.py",
    "soma/tools/genesis-chain.py",
    "crates/holonic-life/examples/audio_ctc_path_fiber/wav2vec2_source.py",
    "crates/holonic-life/examples/morphological_language/freeze_source.py",
    "crates/holonic-life/examples/audio_contextual_ecology/whisper_source.py",
];
