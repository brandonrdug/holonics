...
const L2_REST: &str = ".local/artifacts/the_causal_adjoint_cultivates_one_source_detached_athena_rest_l2/athena-situated-cultivated.rest";
const DEFAULT_OUT: &str = ".local/artifacts/the_material_faces_rebase_into_one_situated_athena_aperture_l3";
