...
pub const DEFAULT_OUT: &str = ".local/artifacts/the_optical_holons_grow_across_scales";
const N1_REST: &str =
...
fn invocation(
    ...
    json!({
        ...
        "code_closure": [
            ...
            "crates/holonic-life/src/mathematical_source/optical_holons.rs",
            "crates/holonic-life/src/mathematical_source/optical_holons/growth.rs",
            "crates/holonic-life/examples/the_optical_holons_grow_across_scales.rs"
        ],
