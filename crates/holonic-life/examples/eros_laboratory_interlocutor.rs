...
//! `ba8716b5:src/crates/holonic-life/examples/eros_laboratory_interlocutor.rs` (124 lines). Deleted at
...
//! occurs nowhere under `crates/holonic-life/src/` — it is not renamed, it is gone — and
