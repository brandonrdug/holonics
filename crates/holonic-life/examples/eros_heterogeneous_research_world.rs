...
//! ## What this closes
//!
//! `crates/holonic-life/src/research_intelligence.rs` (784 lines) and `crates/holonic-life/src/dialogue_lineage.rs`
//! (499 lines) had **in-degree zero from everything**. `docs/plans/THE_ROADMAP.md` recorded
