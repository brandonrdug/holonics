...
//! ## What this closes
//!
//! `crates/holonic-life/src/text_material.rs` declares the source-neutral intake faces on
...
//! ## What is measured
//!
//! The receiver question, from `archive/plans/ARBITRARY_LEARNING_MACHINE.md`'s first production grade:
