...
const H4_REST: &str = concat!(
    ".local/artifacts/the_ordinary_material_crosses_one_native_relational_potential_and_brandon_returns_h4/",
...
const OUTPUT: &str = ".local/artifacts/the_complete_native_reverse_word_recovers_the_k3_predecessor_h5";
