...
pub const DEFAULT_OUT: &str = ".local/artifacts/n1_raw_optical_mathematical_recovery_complete";
...
fn control_campaign(
    ...
    let controls = [
        ("born-digital-pdf-render", ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-baseline-pdf.png"),
        ("vector-clean-render", ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-baseline-source.png"),
        ("clean-raster", ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-baseline-pdf.png"),
        ("perturbed-raster", ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-perturbed-source.png"),
        ("same-glyph-reflow", ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-reflow-source.png"),
        ("diagram", ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-conjugation-diagram.png"),
    ];
