...
const DEFAULT_OUT: &str =
    ".local/artifacts/the_acoustic_section_crosses_the_inherited_projection_and_three_ports_share_one_native_ecology";
const DEFAULT_MODEL: &str = "/home/b/models/gemma-4-E4B-it";
const I4_SOURCE: &str =
    ".local/artifacts/the_heterogeneous_ports_found_one_shared_phoenix_ecology/00-source-conduct.json";
const I4_MANIFEST: &str =
    ".local/artifacts/the_heterogeneous_ports_found_one_shared_phoenix_ecology/MANIFEST.json";
