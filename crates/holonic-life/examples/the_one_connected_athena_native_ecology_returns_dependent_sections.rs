...
const BUNDLE: &str = concat!(
    ".local/artifacts/the_complete_visible_exchange_founds_native_spool_r0q5/",
    "native-transport-scaffold.rest"
);
const OUTPUT: &str = ".local/artifacts/the_one_connected_athena_native_ecology_returns_dependent_sections_k3";
