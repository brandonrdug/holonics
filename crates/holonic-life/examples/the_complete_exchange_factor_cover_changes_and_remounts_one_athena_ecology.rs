...
const H2N_COVER: &str = concat!(
    ".local/artifacts/the_returned_exchange_boundary_founds_one_compact_native_factor_cover_h2n/",
    "01-complete-exchange-cultivation-cover.json"
);
const OUTPUT: &str =
    ".local/artifacts/the_complete_exchange_factor_cover_changes_and_remounts_one_athena_ecology_h3n";
