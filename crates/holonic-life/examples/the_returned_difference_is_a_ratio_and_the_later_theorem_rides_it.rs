...
//! `formal/kernel-witness`, whose corpus is a three-line toy carrier Lean core alone can check.
...
//! `formal/rh-source-transport/SomaRHSourceTransport/FiniteTransport.lean`, read from disk, and
...
fn main() {
    ...
    let project_root = root.join("formal/rh-source-transport");
    let scratch_root = root.join(".local/artifacts/the-returned-difference-is-a-ratio");
