...
const ACOUSTIC: &str =
    ".local/artifacts/the_laboratory_mathematics_athena_unifies_native_inference_ocr_and_three_port_transport/projections/07-exact-notation.wav";
const OUTPUT: &str = ".local/artifacts/the_one_athena_membrane_receives_arbitrary_exterior_occurrences_mem1";
