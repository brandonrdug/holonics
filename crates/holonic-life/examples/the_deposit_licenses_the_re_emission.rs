...
//!   --corpus-form .local/artifacts/the_material_mouth_seals_the_declared_body/declared-corpus-native-rest-<address>.form
//! ```
//!
//! **What this driver is for.**  `docs/canon/TABLET_THE_RESONANCE.md` §6: *"enumerating every reachable
...
/// `crates/holonic-life/driver-sources/eros-morphological-language-generation-bounded-01/SOURCE.json`.
///
...
const DECLARED_FAMILY: &[&str] = &[
    ...
    "crates/holonic-life/src/synchronized_occurrence.rs",
    "crates/holonic-life/src/morphological_language.rs",
];
