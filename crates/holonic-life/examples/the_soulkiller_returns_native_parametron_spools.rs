...
const SECTION: &str = concat!(
    ".local/artifacts/the_soulkiller_admits_the_reachable_section_k2/",
    "admitted-reachable-section.rest"
);
const ANATOMY: &str = concat!(
    ".local/artifacts/the_foreign_receiver_descends_into_athena_native_anatomy_k1/",
    "native-anatomy.rest"
);
...
const OUTPUT: &str = ".local/artifacts/the_soulkiller_returns_mutually_coupled_native_parametron_spools_k2";
