...
const SENS3: &str = ".local/artifacts/the_open_athena_world_tube_recurs_and_returns_lawful_silence_sens3";
const OUTPUT: &str =
    ".local/artifacts/the_athena_radiation_becomes_voice_and_its_room_return_cultivates_the_body_sens4";
