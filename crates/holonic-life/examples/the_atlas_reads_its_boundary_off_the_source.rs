...
//!
//! `crates/holonic-life/src/laboratory_language/repository.rs` carried three numeric bounds that decided what
...
const DECLARED_THEORY: &[&str] = &[
    "docs/canon/THE_AUTHORED_LEVEL.md",
    "docs/canon/THE_CONTAMINANT_PROTOCOL.md",
...
fn repository_root() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR"))
        ...
        .expect("the repository root sits two above crates/holonic-life")
        .to_path_buf()
}
