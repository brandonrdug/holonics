...
//!
//! Second movement of `archive/plans/THE_TYPED_TRANSPORT_ATLAS.md`. `H.0362` names `v` as a formulation
...
const LIBRARY: &str = "formal/elementary-holonics/.lake/packages/mathlib/Mathlib";
...
fn main() {
    ...
    let scratch = root.join(".local/artifacts/the-conclusion-carries-its-relation");
