...
//! [`archive/plans/THE_MAP_IS_MATERIAL_THE_HEAD_IS_A_CONTACT_AND_THE_INSTANCE_RESUMES.md`](../../../archive/plans/THE_MAP_IS_MATERIAL_THE_HEAD_IS_A_CONTACT_AND_THE_INSTANCE_RESUMES.md)
...
//! > `crates/holonic-life/src/causal_language.rs`'s greatest-horizon `retain` keeps, at every step, exactly
...
fn main() {
    ...
    let corpora = [
        DeclaredCorpus {
            name: "mathematics — the registered objects under research/papers/source/mathematics",
            roots: vec![
                PathBuf::from("research/papers/source/mathematics/theorems"),
                PathBuf::from("research/papers/source/mathematics/definitions"),
                PathBuf::from("research/papers/source/mathematics/lemmas"),
            ],
            extension: "typ",
            passages: 12,
        },
