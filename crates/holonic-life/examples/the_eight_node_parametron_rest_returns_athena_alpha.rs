...
const POTENTIAL: &str = concat!(
    ".local/artifacts/the_successor_receiver_and_support_faces_glue_the_eight_node_parametron/",
...
const OUTPUT: &str = ".local/artifacts/the_eight_node_parametron_rest_returns_holonics_hna";
...
fn main() -> Result<(), String> {
    ...
    write_json(
        ...
        &json!({
            ...
            "command":"target/release/examples/the_eight_node_parametron_rest_returns_holonics_hna",
