...
const DEFAULT_OUT: &str = ".local/artifacts/the_heterogeneous_ports_found_one_shared_phoenix_ecology";
const DEFAULT_MODEL: &str = "/home/b/models/gemma-4-E4B-it";
const SOURCE_RECEIPT: &str = ".local/artifacts/the_source_is_admitted_whole/receipt.form";
...
const DEVELOPMENT_BASELINE: &str =
    ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-baseline-source.png";
const DEVELOPMENT_PERTURBED: &str =
    ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-perturbed-source.png";
const HELD_OUT_BASELINE: &str =
    ".local/artifacts/m0_mathematical_source_circulation/faces/synthetic/harmonic-baseline-pdf.png";
...
fn code_closure() -> String {
    let members: &[&[u8]] = &[
        ...
        include_bytes!("../../holonic-engine/src/native_ecology/heterogeneous_fusion.rs"),
        include_bytes!("../../holonic-engine/src/cuda_refine.rs"),
        include_bytes!("../../holonic-engine/kernels/refine_shell.cu"),
        include_bytes!("../../holonic-engine/src/embedding_fiber.rs"),
        include_bytes!("../../holonic-engine/kernels/exact_embedding_fiber.cu"),
        include_bytes!("../../holonic-engine/src/foreign_map.rs"),
        include_bytes!("../../holonic-engine/src/cuda_aperture.rs"),
    ];
