...
//!
//! Fourth movement of `archive/plans/THE_TYPED_TRANSPORT_ATLAS.md`, and the plan's experiment. Two arms
...
fn main() {
    ...
    let scratch = root.join(".local/artifacts/the-recognition-precedes-the-run");
