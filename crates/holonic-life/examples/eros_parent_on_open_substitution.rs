...
/// This driver's name at the plate mouth: `.local/artifacts/eros_parent_on_open_substitution/<name>-<sha256>.form`.
...
fn machine_read(machine: &LiveCurrentMachine) -> Result<Value, String> {
    ...
    // plate reader was retired in R2. This helper reads several machines; each rest receives its
    // own content address,
