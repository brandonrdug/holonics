...
const REST: &str = ".local/artifacts/recurring_laboratory_transport_condenses_into_native_hexis/native-rest";
...
fn infer(
    ...
    let audit = json!({
        ...
        "lean_source_absent": !Path::new("/formal").exists() && !Path::new("/source/formal").exists(),
