...
//! 2026-08-13. `docs/canon/THE_INFORMATION_ENGINE.md` §0 measures the body as a descent with no return
//! edge, and `docs/canon/THE_HOLOBROCHOS_SPINE.md` §1's own audit is that *"the engine has no
