...
//!
//! The laboratory's `.local/runs/eros-two-theorem-deed/` is an empty directory and its
...
//! # Why this corpus
//!
//! `formal/kernel-witness` is the one formal project in this tree that
...
//! minutes, downloading nothing. `formal/elementary-holonics` now carries
...
fn main() {
    ...
    let scratch_root = root.join(".local/artifacts/the-two-theorem-deed");
