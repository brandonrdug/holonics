...
its untracked `.local/runs/`, so it is gone at every commit in either repository -- the same loss
...
Only `SOURCES` moved, because the paths moved:
  ...
  * 15 of the laboratory's 17 named files exist VERBATIM in this repository and are named here
    ...
    `src/soma/RESEARCH/`), `crates/holonic-life/src/synchronized_occurrence.rs`,
    `crates/holonic-engine/src/algebraic.rs`, four `research/papers/source/mathematics/definitions/*.typ`
  ...
  * 2 of the 17 were laboratory `.local/runs/` artifacts and are UNRECOVERABLE. They carried the
...
SOURCES = (
    ...
    ("crates/holonic-life/src/synchronized_occurrence.rs", RECEIVER_CODE, "recovered"),
    ...
    (
        "research/papers/source/mathematics/definitions/holonic-process-double-category.typ",
        RECEIVER_MATHEMATICS,
        "recovered",
    ),
    (
    ...
    # `.local/runs/synchronized-grid-factorized-structural-fiber-information-flow/RESULTS.md`, which was
    # never tracked and does not exist at any commit in either repository.
    (
        "CONSTRUCTION_STATE.md",
        RECEIVER_OBSERVATION,
        "SUBSTITUTED:.local/runs/synchronized-grid-factorized-structural-fiber-information-flow/RESULTS.md",
    ),
    # SUBSTITUTED. The laboratory named
    # `.local/runs/resonant-corpus-current-information-flow/REPORT.json`, likewise untracked and gone.
    (
        "standing/README.md",
        RECEIVER_OBSERVATION,
        "SUBSTITUTED:.local/runs/resonant-corpus-current-information-flow/REPORT.json",
    ),
)
...
def freeze(
    ...
    return {
        "provenance": {
            "kind": "CONSTRUCTED",
            "constructed_by": "crates/holonic-life/examples/morphological_language/freeze_source.py",
            ...
            "laboratory_source_json": (
                "UNRECOVERABLE -- written under the laboratory's untracked `.local/runs/`; zero files "
            ...
            "substitution_reason": (
                "Two of the laboratory's seventeen named files were `.local/runs/` artifacts that were "
