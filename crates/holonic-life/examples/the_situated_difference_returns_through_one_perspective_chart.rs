...
const K3_SECTIONS: &str =
    ".local/artifacts/the_one_connected_athena_native_ecology_returns_dependent_sections_k3/01-conducted-sections.json";
const OUTPUT: &str = ".local/artifacts/the_situated_difference_returns_through_perspective_charts_l0";
