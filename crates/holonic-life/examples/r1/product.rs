...
pub const DEFAULT_OUT: &str =
    ".local/artifacts/the_rich_intake_returns_one_codec_neutral_operation_world_tube";
const R0_CLOSURE: &str = ".local/artifacts/the_rich_mathematical_inquiry_returns_the_i5_baseline_boundary/00-source-input-rest-closure.json";
