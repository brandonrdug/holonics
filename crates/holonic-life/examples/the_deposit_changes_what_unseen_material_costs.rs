...
//!
//! The standing plan is `docs/plans/THE_ROADMAP.md` §"THE EROS CYCLE".
//!
...
const CIRCULATION_BODY: [&str; 2] = [
    ...
    "docs/canon/TABLET_THE_REASONING_CYCLE.md",
];
const GEOMETRY_BODY: [&str; 2] = ["docs/canon/TABLET_THE_MANIFOLD.md", "docs/canon/TABLET_THE_TURN.md"];

/// Later, nonidentical, held out. One near each conditioning body.
const LATER_NEAR_CIRCULATION: &str = "docs/canon/TABLET_THE_COMPRESSION.md";
const LATER_NEAR_GEOMETRY: &str = "docs/canon/TABLET_THE_CHART.md";
