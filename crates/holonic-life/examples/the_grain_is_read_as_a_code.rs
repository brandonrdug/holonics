...
//!
//! The standing plan is `docs/plans/THE_ROADMAP.md` §"THE EROS CYCLE". This driver
...
const HELD_OUT: &str = "docs/canon/TABLET_THE_COMPRESSION.md";
...
const HELD_OUT_DISJOINT: &str = "docs/canon/TABLET_THE_MANIFOLD.md";
