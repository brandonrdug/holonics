...
/// author — `docs/canon/THE_AUTHORED_LEVEL.md` and `docs/canon/TABLET_THE_RESONANCE.md` §11 forbid a
...
impl MorphologicalConductPlurality {
    ...
    /// source pairs"* — and `crates/holonic-life/src/agentic_language`'s `CODEC_MINIMUM_RECURRENCE = 2` says
...
///
/// `docs/canon/TABLET_THE_RESONANCE.md` §11: *"Where nothing conducts, the return is the obstruction
