...
//! docs/canon/THE_INFORMATION_ENGINE.md`, that instruction appeared in no governing document.
//!
...
//!
//! Plan: [`archive/plans/THE_CODEC_IS_RECOVERED_AT_EVERY_SCALE_AND_THE_FACES_ARE_A_RETURN.md`], station
//! eight, under `docs/plans/THE_ROADMAP.md`.
...
fn stations() {
    ...
    println!();
    println!(
        "  Plan: archive/plans/THE_CODEC_IS_RECOVERED_AT_EVERY_SCALE_AND_THE_FACES_ARE_A_RETURN.md"
    );
}
