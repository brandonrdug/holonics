...
//! its cut was in the wrong place, and moves the cut. `archive/plans/THE_ASSEMBLY.md` loop (a) is that
...
/// test. Worse, it was the *flag* shape `archive/plans/THE_ASSEMBLY.md` refuses — the crossing is
...
mod tests {
    ...
    /// **A finding about `archive/plans/THE_ASSEMBLY.md` loop (a), exhibited rather than argued.**
    ///
