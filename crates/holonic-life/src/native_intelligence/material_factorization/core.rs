...
use crate::native_intelligence::{LaboratoryCultivatedRest, SituatedCultivatedEcologyRest};
...
impl MaterialFactorizationStanding for SituatedCultivatedEcologyRest {
    fn validate_material_standing(&self) -> Result<(), String> {
...
impl MaterialFactorizationStanding for LaboratoryCultivatedRest {
    fn validate_material_standing(&self) -> Result<(), String> {
        self.validate().map_err(|error| error.to_string())
    }
