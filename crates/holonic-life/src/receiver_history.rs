...
pub use types::{
    CausalSectionAddress, ProposalRelationKind, ProposalRoleIncidence, ReceiverGrain,
    ReceiverHistoryCongruence, RelationTargetFace, ResidentQuotientReceipt,
    SurfaceOnlyCounterexample, TransportGeneratorAddress, TransportSpecies,
};

use system::LaboratorySections;

impl ReceiverHistoryCongruence {
    pub fn found_on_device(
        ...
        let resident = ResidentQuotientReceipt {
            schema: "soma-life.receiver-history-resident-quotient.v1".to_owned(),
        ...
        let product = Self {
            schema: "soma-life.receiver-history-congruence.v1".to_owned(),
    ...
    pub fn validate(&self) -> Result<(), String> {
        if self.schema != "soma-life.receiver-history-congruence.v1"
