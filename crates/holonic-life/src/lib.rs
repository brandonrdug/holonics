//! Production library surface for the continuing Soma bodies.
//!
//! The crate root contains no autonomous world, historical mode dispatcher, corpus launcher, or
...
// `docs/canon/TABLET_THE_REASONING_CYCLE.md` §8.
...
// `holonics_portable::incidence` for `∂∂ = 0`, hands, ports and cells, and `holonic-engine`'s
