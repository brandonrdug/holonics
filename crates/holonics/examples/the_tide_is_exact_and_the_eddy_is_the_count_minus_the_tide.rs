...
//! of sixteen, Machin's `pi`, Euler's arctangent series; `holonics::geometry::riemann_siegel_theta`),
...
use holonics::geometry::{EtaRatioAtlas, RatInterval, pi_interval, riemann_siegel_theta};
