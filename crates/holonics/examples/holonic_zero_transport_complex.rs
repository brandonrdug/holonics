...
mod tests {
    ...
    fn exact_midpoint_differences_telescope() {
        let a = holonics::geometry::rat(113, 8);
        let b = holonics::geometry::rat(1345, 64);
        let c = holonics::geometry::rat(25, 1);
    ...
    fn box_subtraction_loses_shared_dependency() {
        let a = RatInterval::new(
            holonics::geometry::rat(0, 1),
            holonics::geometry::rat(1, 1),
        );
        let b = RatInterval::new(
            holonics::geometry::rat(2, 1),
            holonics::geometry::rat(3, 1),
        );
        let c = RatInterval::new(
            holonics::geometry::rat(4, 1),
            holonics::geometry::rat(5, 1),
        );
    ...
    fn turn_is_the_exact_oriented_area_determinant() {
        let east = ComplexInterval::point(holonics::geometry::RatComplex::new(
            holonics::geometry::rat(1, 1),
            holonics::geometry::rat(0, 1),
        ));
        let north = ComplexInterval::point(holonics::geometry::RatComplex::new(
            holonics::geometry::rat(0, 1),
            holonics::geometry::rat(1, 1),
        ));
