...
fn section_the_horizon() {
    ...
    println!(
        "    (1 - u^3)^8                 = {}",
        format_window(&holonics::geometry::ihara_euler_product_window(
...
fn square_construction() -> (Construction, Receiver) {
    ...
    construction
        .add_entity(
            "closed square",
            frame,
            holonics::geometry::Geometry::Thread {
                vertices: vec![
    ...
    let receiver = Receiver::new(
        ...
        "square receiver",
        frame,
        holonics::geometry::ProjectionLaw::Orthographic,
    );
        ...
        let members = TETRAHEDRON_EDGES
            ...
            .filter_map(|(edge_index, (left, right, _))| {
                if *left == abstract_vertex {
                    Some(holonics::geometry::SourceEndpoint {
...
fn section_two_frames() {
    ...
    let frame = holonics::geometry::FrameId(1);
