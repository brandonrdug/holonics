...
use crate::geometry::exact::{Rat, RatVec2, RatVec3, sign};
use crate::geometry::model::{ConstraintKind, Construction, EntityId, FrameId, Geometry};
use crate::geometry::projection::{ProjectionError, ProjectionLaw, Receiver, ReceiverId, project_point};
...
mod tests {
    use super::*;
    use crate::geometry::exact::RatVec3;
    use crate::geometry::model::Construction;
    use crate::geometry::projection::ProjectionLaw;
