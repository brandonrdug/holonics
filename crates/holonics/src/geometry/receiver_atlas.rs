...
use crate::geometry::exact::{Rat, RatVec2, RatVec3, integer};
use crate::geometry::model::{Construction, FrameId};
...
///   `crates/holonics-portable/src/soul.rs:159` is already a third cross-ratio, and its own
