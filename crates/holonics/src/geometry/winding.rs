...
//! used by the holonomy), and [`ScrewPair`]/[`crate::geometry::SituatedScrew`]/[`crate::geometry::ScrewGenerator`] for
//! the pair lock, whose velocities come from `ScrewGenerator::velocity` at the retained initial
//! configuration. `crate::geometry::polygon_winding` is a different receiver (a ray-crossing count on a
...
use crate::geometry::{AffineMap3, Rat, RatMat3, RatVec3, ScrewPair};
