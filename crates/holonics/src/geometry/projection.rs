...
use crate::geometry::exact::{ExactExpr, ExactVec2, Rat, RatMat3, RatVec2, RatVec3, integer, rat, sign};
    ...
    pub fn fiber_statement(&self) -> String {
        match self {
            ...
            Self::PerspectiveRay { focal_distance } => format!(
                ...
                crate::geometry::exact::format_rat(focal_distance)
            ),
...
fn receiver_transport(
    ...
    source_frame: FrameId,
    receiver: &Receiver,
) -> Result<crate::geometry::exact::AffineMap3, TransportError> {
        ...
        Geometry::Conic(conic) => conic
            ...
            .map(|points| {
                Ok(ProjectedPolyline {
                    ...
                    closed: matches!(
                        conic.species,
                        crate::geometry::model::ConicSpecies::Circle | crate::geometry::model::ConicSpecies::Ellipse
                    ),
                    crossing_bearing: false,
                })
            })
...
mod tests {
    use super::*;
    use crate::geometry::exact::{RatVec3, rat};
    use crate::geometry::model::{Construction, Geometry};
    ...
    fn a_hinged_frame_carries_its_grid_through_the_declared_relation() {
        ...
        let hinge = construction
            .found_hinge(
                ...
                frame,
                RatVec3::zero(),
                crate::geometry::model::HingeAxis::X,
                Rat::zero(),
            )
            .unwrap();
