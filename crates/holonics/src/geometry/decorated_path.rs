...
use crate::geometry::exact::{Rat, RatVec2, RatVec3};
use crate::geometry::model::{Construction, EntityId, FrameId, Geometry};
use crate::geometry::projection::{ProjectionError, Receiver, ReceiverId, project_point, receiver_metric};
use crate::geometry::receiver_topology::{
...
impl fmt::Display for ExactTurn {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            formatter,
            "({},{})",
            crate::geometry::exact::format_rat(&self.parallel),
            crate::geometry::exact::format_rat(&self.transverse)
        )
    }
}
...
mod tests {
    use super::*;
    use crate::geometry::exact::{integer, rat};
    use crate::geometry::model::ConstraintKind;
    use crate::geometry::projection::{ProjectionLaw, ReceiverOrientation};
    use crate::geometry::receiver_topology::SourceEndpoint;
