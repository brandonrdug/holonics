...
//! `reopen(π x, x − σ π x) = x` exactly (`Foundation/ContinuingTower.lean::Transition.reopen_apply`).
...
use crate::scalar::{add, sub, zeros};
...
/// `Foundation/ContinuingTower.lean::Tower.restrictTransition` at the linear tower: the proper
