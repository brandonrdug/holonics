...
impl AccumulationLaw {
    ...
    fn admit(self) -> Sectioned<AccumulationLaw> {
        match self {
            AccumulationLaw::IntegerAdd => Ok(self),
            AccumulationLaw::ModularAdd { modulus } if modulus >= 2 => Ok(self),
...
impl SectionLayout {
    ...
    pub fn generate(
        ...
        let receipt = match request {
            ...
            ScatterRequest::Accumulated(law) => ScatterReceipt::Accumulated(law.admit()?),
        };
