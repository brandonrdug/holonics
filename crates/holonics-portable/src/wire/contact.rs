...
use crate::manifold::{FACE_WORDS, NODE_WORDS};
use crate::num::COG_WORDS;
...
pub const RECEIPT: usize = OUTPUT + crate::register::REGISTER as usize * OUTPUT_WORDS;
pub const SURFACE_WORDS: usize = RECEIPT + crate::register::REGISTER as usize;
