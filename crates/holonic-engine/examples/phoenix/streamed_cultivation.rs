...
use holonic_engine::resident_law::FactorizedContract;
...
pub(crate) fn prepare(
    ...
    passage: &FrontPassage<'static>,
    request: &CultivationRequest<'_>,
    token_count: usize,
    grain: holonic_engine::resident_section::ResidentGrain,
) -> Result<(ResidentMaterial<'static>, CultivationPreAdmission), String> {
    ...
    let factor_prediction = passage.predict_aligned_material(
        &holonic_engine::front_passage::AlignedMaterialPlan::maps(vec![
            (
...
pub(crate) fn execution_identity(
    passage: &cultivation_overlay::OverlayPassage<'static>,
...
pub(crate) fn predict_overlay(
    surface: &ResidentSurface<'static>,
    request: &CultivationRequest<'_>,
