//! Exterior return and local cultivation of one retained Phoenix recurrence.
//!
...
mod tests {
    ...
    use crate::phoenix::recurrent::{BoundaryFace, ClosureDerivation, RetainedContinuationRest};
