...
//!
//! The resident law is carried as path-free testimony on every binding; foreign implementation
//! readers remain confined to example adapters:
//!
...
pub const FULL_ROTATED_PAIRS: usize = FULL_HEAD / 8;
...
pub fn found_layer(
    ...
    realization.bind(
        token,
        Enter {
            population: super::site::PLE_ENTERING.to_owned(),
    ...
    let chronology_law_testimony = |site: &str| -> Vec<crate::ported_operation::SourceTestimony> {
        match sibling {
