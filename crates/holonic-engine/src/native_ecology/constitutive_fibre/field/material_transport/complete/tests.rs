...
#[test]
#[ignore = "requires CUDA; complete source coefficients, birth moments and old-source expression continue after ordinary remount"]
fn complete_material_state_and_delayed_source_survive_remount() {
    fn prefix(
