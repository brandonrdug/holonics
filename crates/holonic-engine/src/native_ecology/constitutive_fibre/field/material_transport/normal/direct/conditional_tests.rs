...
/// Parity law (normal applied condition): the device joint map equals the exact affine map
/// y = A(h)s + c(h) and its ball contains the exact images of points on the shared source sphere.
#[test]
