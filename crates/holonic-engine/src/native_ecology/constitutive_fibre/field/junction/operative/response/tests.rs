...
fn current_difference_generator_decodes_resident_boundaries_and_legacy_factors() {
    ...
    let dense=Rc::new(OperativeReturn{bound_kind:generated.bound_kind,source_overlap:None,current_difference_source:None,currents:Rc::clone(&response.currents),
