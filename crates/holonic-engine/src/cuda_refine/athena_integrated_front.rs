...
pub struct ResidentAthenaIntegratedFront {
...
pub struct ResidentAthenaIntegratedReturn {
...
impl ResidentAthenaIntegratedFront {
    ...
    pub fn conduct(
        ...
        deed: u32,
    ) -> Result<ResidentAthenaIntegratedReturn, CudaRefineError> {
        ...
        let resident_invariant_octets = coupled
            ...
            .ok_or(CudaRefineError::AffineBarycentricTransportShape)?;
        Ok(ResidentAthenaIntegratedReturn {
            coupled,
            participant,
            affine,
