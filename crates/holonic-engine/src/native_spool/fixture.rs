...
pub fn detached_returned() -> SoulkillerDismantlingReturn<NativeTransportScaffold, (), ReceiverInsufficiency> {
...
pub fn returned() -> SoulkillerDismantlingReturn<NativeTransportScaffold, (), ReceiverInsufficiency> {
    let native = scaffold();
