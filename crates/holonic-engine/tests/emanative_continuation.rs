...
use holonic_engine::phoenix::emanative::{
    EmanativeCandidate, EmanativeContinuationRest, EmanativeFront, EmanativeOccurrence,
    EmanativePotential, EmanativeStatus, ExactBoundarySelection, EMANATIVE_REST_SCHEMA,
};
