...
extern "C" __global__ __launch_bounds__(512) void section_normal_applied_enclosed_features(
    ...
    uint32_t rows,uint32_t source_complex,uint32_t targets,uint32_t grain,
