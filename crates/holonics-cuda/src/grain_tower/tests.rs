//! Laws of the grain tower.
//!
//! The tests state the laws the Lean owner
//! `formal/elementary-holonics/ElementaryHolonics/Foundation/GrainRestriction.lean` proves, on
//! synthetic intakes that need no fixture. `reopen_apply` on a complete atom-grain population, and
//! the pair-table identity `fine_inside - coarse_inside = fine_only_inside` with
//! `coarse_only_inside = 0`, are checked through `enact_family`.
...
// ---------------------------------------------------------------------------------------------
// The scaled atom-grain intake.
// ---------------------------------------------------------------------------------------------
/// The declared decimal grain of the scaled wire.
