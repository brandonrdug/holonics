...
//!   [`pole_atlas`](holonics::receiver::causal_chord::pole_atlas) as a **squared** rational or as a named
...
use holonics::receiver::causal_chord::{ChordRefusal, PoleAtlas, PoleReading, pole_atlas};
...
///
/// Composes [`pole_atlas`](holonics::receiver::causal_chord::pole_atlas): the atlas' squarefree factors are
