...
//! The surface adopts the [`ResidentReadout`]'s context as a [`crate::BorrowedContext`], checks the
...
impl From<crate::CudaError> for ResidentRefusal {
    fn from(error: crate::CudaError) -> Self {
        Self::Driver {
...
pub struct ResidentSurface<'chart> {
    ...
    /// ([`crate::BorrowedContext::allocation_grain_bytes`]). An apparatus coordinate: every
