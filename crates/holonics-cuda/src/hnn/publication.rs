...
//! copy of the published words. [definition] **Only the moved words cross the bus.** A successor's
//! words are laid out as its predecessor's (the same loci, shapes and lattices), so the successor is
