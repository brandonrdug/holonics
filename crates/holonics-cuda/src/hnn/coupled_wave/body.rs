...
impl<'c> NativeCoupledBody<'c> {
    ...
    pub(super) fn describe_prospective(
        future: &crate::native_ecology::constitutive_fibre::NormalWaveFamilyReceiver<
            '_,
            'c,
        >,
        epoch: u64,
    ...
    pub(super) fn with_prospective<R>(
        ...
        word: &[(usize, WaveSourceReceiver)],
        read: impl FnOnce(
            &crate::native_ecology::constitutive_fibre::NormalWaveFamilyReceiver<'_, 'c>,
    ...
    pub fn compare(
        ...
        let epoch = self.epoch();
        let describe=|comparison:&crate::native_ecology::constitutive_fibre::NormalCoupledComparison<'c>,conditional:bool|->Result<Value,NativeSessionError>{
