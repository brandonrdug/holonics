...
use crate::resident_section::{ResidentGrain, ResidentSectionRest};
...
impl<'c> FieldModel<'c> {
    ...
    fn observe_comparison(
        ...
        self.field.apply_reflection_target(&returned,
            crate::native_ecology::constitutive_fibre::NativeContactRealization::DyadicDeposit)?;
...
impl<'c> NativeCoupledBody<'c> {
    ...
    pub fn field_condition_image(
        ...
        crate::native_ecology::constitutive_fibre::ResidentConditionImage<'c>,
        NativeSessionError,
    > {
        match self.state()? {
    ...
    pub fn field_last_evidence(
        &self,
    ) -> Option<&crate::native_ecology::constitutive_fibre::NeighborhoodEvidence<'c>> {
