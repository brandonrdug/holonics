...
mod machine_tests;
use super::*;
use crate::hnn::field_geometry::GeometricFieldSpec;
use crate::{
...
impl IncidentFieldSolver {
    ...
    fn action<'a, 'c>(
        ...
        crate::native_ecology::constitutive_fibre::NativeFieldMatrixFreeAction<'a, 'c>,
        NativeSessionError,
    > {
        match self {
...
pub struct ReactionDepositRecord {
    ...
    pub last:
        Option<Vec<crate::native_ecology::constitutive_fibre::NormalReactionProjection>>,
...
impl ReactionDepositRecord {
    ...
    fn record(
        &mut self,
        projections: Vec<
            crate::native_ecology::constitutive_fibre::NormalReactionProjection,
        >,
...
struct IncidentLayout {
    machine: Option<Rc<crate::hnn::field_geometry::machine::CompiledGeneratorMachine>>,
...
struct CayleyStage<'c> {
    certificate: crate::native_ecology::constitutive_fibre::PowerNeutralCertificate<'c>,
...
pub(crate) struct IncidentWord<'c> {
    ...
    enclosure_propagation:
        crate::native_ecology::constitutive_fibre::NativeEnclosurePropagation,
}
...
pub struct NativeIncidentMaterialReturn<'c> {
    ...
    reaction_certificates: Vec<
        Option<crate::native_ecology::constitutive_fibre::PowerNeutralCertificate<'c>>,
    >,
    contact_amplitude: Option<
        crate::native_ecology::constitutive_fibre::NativeDeclaredAmplitudeCommit<'c>,
    >,
    ...
    contact: Option<
        crate::native_ecology::constitutive_fibre::NativeFieldGlobalMaterialCommit<'c>,
    >,
}
...
impl<'c> NativeCoupledBody<'c> {
    ...
    fn prepare_incident_material_return_at(
        ...
        use crate::native_ecology::constitutive_fibre::NativeContactRealization;
        let BodyState::Incident(model) = self.state_mut()? else {
            return Err(invalid("incident return requires its model chart"));
        };
        if step_bits > 120 {
