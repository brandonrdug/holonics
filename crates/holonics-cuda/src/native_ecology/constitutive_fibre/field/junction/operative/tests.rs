...
/// Operative-contact parity: after a staged rank-two return the device contacts, internal
/// currents, covariance `D D*` and aggregate `Dᵀb` contain the exact host update
/// `D + p r*`, `b + δb`; a late refusal publishes nothing.
#[test]
