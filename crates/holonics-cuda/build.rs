...
//! exactly as `crates/holonics-cuda`'s `Device::attribute` does at run time. When no device answers, the
...
fn main() {
    ...
    println!("cargo:rerun-if-changed=kernels/enclosure_cayley.cuh");
    ...
    println!("cargo:rerun-if-changed=kernels/normal_wave_basis_face.cuh");
    println!("cargo:rerun-if-changed=kernels/passive_current_ball.cuh");
    println!("cargo:rerun-if-changed=kernels/normal_source_actuation.cuh");
    ...
    println!("cargo:rerun-if-changed=kernels/field_source_reflection.cuh");
    ...
    println!("cargo:rerun-if-changed=kernels/field_operative_map_source.cuh");
    ...
    println!("cargo:rerun-if-changed=kernels/field_operative_adjoint.cuh");
