...
namespace Soma.Holonics.Transport.GeneratorMachineCharts

open Soma.Holonics.Geometry.ScrewGeometry
open Soma.Holonics.Transport.SerialScrewChain
...
end Soma.Holonics.Transport.GeneratorMachineCharts
