...
namespace Soma.Holonics.Transport.JunctionLaw
...
def CompatiblePairs (P : Soma.Holonics.AddressedPassage X Y)
    (Q : Soma.Holonics.AddressedPassage Y Z) : Type _ :=
...
same type. -/
def join_is_exactly_the_compatible_pairs (P : Soma.Holonics.AddressedPassage X Y)
    (Q : Soma.Holonics.AddressedPassage Y Z) :
    Soma.Holonics.AddressedPassage.Join P Q ≃ CompatiblePairs P Q where
...
theorem noSharedBoundary_isEmpty_join (P : Soma.Holonics.AddressedPassage X Y)
    (Q : Soma.Holonics.AddressedPassage Y Z)
    (gap : ∀ predecessor successor, P.target predecessor ≠ Q.source successor) :
    IsEmpty (Soma.Holonics.AddressedPassage.Join P Q) := by
  constructor
  intro joined
...
end Soma.Holonics.Transport.JunctionLaw
