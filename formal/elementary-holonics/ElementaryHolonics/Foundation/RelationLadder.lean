...
Rung 5 **is** `Soma.Holonics.Foundation.CausalRelevance.NonLinear.futureAgreement`:
...
namespace Soma.Holonics.Foundation.RelationLadder
...
open Soma.Holonics.Transport.ChangingReceiver in
...
end Soma.Holonics.Foundation.RelationLadder
