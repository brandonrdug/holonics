...
[definition] `ElementaryHolonics/Millennium/Crossings.lean` already owns the *combinatorial* arm:
...
namespace Soma.Holonics.Foundation.TopologicalReceiver
...
end Soma.Holonics.Foundation.TopologicalReceiver
