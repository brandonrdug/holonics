...
Current spine: `H.0015` in [`foundations.typ`](../papers/source/holonics/foundations.typ) and
`H.0287–H.0288` in
[`manifold-knot-geometry.typ`](../papers/source/holonics/manifold-knot-geometry.typ). The legacy
[`causal-soul.typ`](../papers/source/mathematics/definitions/causal-soul.typ),
[`soul-sameness-hierarchy.typ`](../papers/source/mathematics/theorems/soul-sameness-hierarchy.typ),
...
[`geometry-calculus.typ`](../papers/source/holonics/geometry-calculus.typ). The legacy
[`four-member-projective-swing.typ`](../papers/source/mathematics/theorems/four-member-projective-swing.typ)
...
`papers/source/`; hypergeometric equations and transformations through
