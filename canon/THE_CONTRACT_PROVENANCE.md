...
here**, which is the same division `canon/THE_TIMELINE.md` already makes for behaviour.
...
- **It is false on its own terms.** What recruitment *returns* is already scale-independent — **40
  ...
  `n log n`, are in [`canon/THE_CONTRACT_PROVENANCE.md`](canon/THE_CONTRACT_PROVENANCE.md) §5.
...
[`canon/THE_CONTRACT_PROVENANCE.md`](canon/THE_CONTRACT_PROVENANCE.md) §5. The two were welded into
