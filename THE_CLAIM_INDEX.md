...
| `blueprint/THE_ROADMAP.md` | **The roadmap** — **This is the sole construction authority.** Historical campaigns and status prose remain evidence; they do not schedule work. |
| `CONSTRUCTION_STATE.md` | **Construction state** — **The position record. One file, no siblings.** Git is the log; `blueprint/THE_ROADMAP.md` is the sole construction authority. |
...
| `blueprint/THE_ATHENA_ALPHA_IS_REFOUNDED_AS_A_RECEIVER_HISTORY_QUOTIENT_AND_RETURNED_DEFECTS_CULTIVATE_ONE_GLUED_CAUSAL_MORPHOLOGY.md` | **Athena alpha is refounded as a receiver-history quotient, and returned defects cultivate one glued causal morphology** — **Authority:** this blueprint supersedes… |
...
## 4 · The 2026-08 record line (355 deposits of 647)
...
|---|---|---|
| `tools/authored_levels.py` | Every numeric level authored **inside** an organ, and whether it is dispositioned. | `CLAUDE.md`, `canon/TABLET_THE_MANIFOLD.md`, `canon/THE_AUTHORED_LEVEL.md`, and 10 more |
...
| `tools/claim_index.py` | Generate `THE_CLAIM_INDEX.md` from the tree, so the table of contents cannot drift. | `CLAUDE.md`, `blueprint/THE_MAP_IS_MATERIAL_THE_HEAD_IS_A_CONTACT_AND_THE_INSTANCE_RESUMES.md`, `research/records/2026-08-13_THE_DOCUMENTS_DESCRIBED_A_BODY_THEY_HAD_NOT_OPENED_AND_THE_OPERAND_HAD_NO_RESIDENCY.md`, and 2 more |
...
| `tools/document_law.py` | Two laws the corpus states about its own governing documents, made executable. | `canon/THE_CONTAMINANT_PROTOCOL.md`, `research/records/2026-08-24_DIVISION_RETURNED_AS_A_TRANSPORT_FIBRE_PARTITIONS_RETAINED_THEIR_BOUNDARIES_AND_DIVISORS_BECAME_SIGNED_CHART_LEDGERS.md` |
...
| `tools/gates.sh` | The gate sequence. | `AGENTS.md`, `CLAUDE.md`, `CONSTRUCTION_STATE.md`, and 73 more |
| `tools/lean_check.sh` | Give the formal sources a verdict. | `canon/THE_EXPLORATIVE_FAILURE.md`, `research/records/2026-08-09_THE_COMMITTED_BOUNDARY_ARTIFACT_IS_STALE_AND_CANNOT_BE_REBUILT.md`, `research/records/2026-08-14_THE_LIBRARY_WAS_ALREADY_ON_THE_DISK_AND_THE_ABSENCE_WAS_MEASURED_BY_COUNTING_ARTIFACTS.md` |
| `tools/output_manifest.py` | Bind every returned artifact under `output/` to its content hash, in a TRACKED file. | `meta/OUTPUT_MANIFEST.tsv`, `research/records/2026-08-10_THE_INSTRUMENT_DECLARES_THE_APERTURE_AND_THE_REFUSAL_IS_THE_RETURN.md`, `research/records/2026-08-22_THE_EXCHANGE_WORLD_TUBE_RETAINED_ITS_BRANCHES_THE_CONTACT_FIBRE_FACTORED_AND_A1_PASSED.md`, and 1 more |
...
| `tools/resolve_named_paths.py` | Every path a governing document names must resolve in the body that document describes. | `CLAUDE.md`, `canon/THE_CONTAMINANT_PROTOCOL.md`, `canon/THE_DOCUMENT_LAW.md`, and 10 more |
