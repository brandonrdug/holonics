...
| Gemma 4 cold multimodal transport chart | SCF2 exterior-chart boundary under `NativeTransportScaffold.lean` | `holonic_intelligence/foreign_multimodal.rs`; standing `foreign_json.rs` and `foreign_map.rs` | none; model execution remains exterior | **exact manifestation:** all 2,130 BF16 declarations reconcile into complete language/vision/audio/projection families with shared-carrier and processor checks; actual excitation and native section founding remain SCF2-open |
