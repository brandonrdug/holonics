...
std::size_t r26_verification_failures(bool sources_loaded,
  ...
  failures += handoff.integrity != event::intrinsic_hypergeometry_rest_integrity(handoff) ||
      handoff.body.regions[0].morphology != 535 || handoff.mathematical_morphology != 164 ||
      handoff.codec_morphology != 84 || handoff.causal_linear_morphology != 29 ||
      handoff.intrinsic_hypergeometry_morphology != 31 ||
