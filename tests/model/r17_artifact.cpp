...
void write_r17_artifact(std::ostream& output,
  ...
  output << "truth_status=established-bounded\n"
         ...
         << value.theory_commit.morphology_before << ':'
         << value.theory_commit.morphology_after << '\n'
         ...
         << handoff.geometry_morphology << ",body:"
         ...
         << ",body_morphology:" << handoff.body.regions[0].morphology
         << ",mathematical:" << handoff.mathematical_morphology
         << ",codec:" << handoff.codec_morphology
         << ",geometry:" << handoff.geometry_morphology
