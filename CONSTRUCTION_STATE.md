...
| **Integer homology** | **re-establish** | `smith_normal\|hermite_normal\|invariant_factor\|betti\|torsion` returns **1 hit**, a doc comment at `crates/holonic-engine/src/basin.rs:363` |
