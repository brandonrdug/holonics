...
**Current study return:** The [causal-entanglement/interface study](research/records/2026-09-11_CAUSAL_ENTANGLEMENT_NEEDS_FUTURE_INTERFACES_AND_FOUNDED_GENERATORS.md) connects active-joint reduction to the existing future-receiver laws. New Lean controls prove finite-prefix ambiguity, exact multiplier identification under its constitutive hypothesis, and exposure of a hidden generator difference by any nonzero excitation. Causal admission and statistical warrant are kept distinct from a guarantee of error-free extrapolation. No native model expansion occurred.
