...
**Position:** Packets 1 and 2 and the coupled owner are committed through `7d346431`. The [prepared-source return](research/records/2026-09-11_UNIT_SOURCE_CHARTS_RETAIN_THE_WAVES_COMMON_OFFSET.md) adds resident workspaces and an explicit offset-preserving source receiver; 50 wave and two cold-rest controls pass. The 40-passage source candidate has an exact separating plane and a receiver arithmetic refusal; broader 32-frame/9,254-passage exposure returns native `OutsideAnchorBall`. Both preserve epoch ten. Next is ordinary coupled source actuation and its actual return, then coupled emission/session integration, producing-family observations, lawful formation/reuse and product evaluation. Packet-2 output `tht44444` remains the last conversation return. The goal is active; AC0–AC5 is incomplete.
