...
add_library(r23_toric_cycle_store STATIC
  apparatus/host/toric_cycle_card_adapter.cpp
  apparatus/host/toric_cycle_store_adapter.cpp)
...
add_library(r23_toric_cycle_executor STATIC
  ...
  cuda/executor/r23_toric_cycle_executor.cu
  cuda/executor/r23_toric_cycle_kernels.cu
  cuda/executor/r23_toric_cycle_probe.cu)
...
add_executable(r23_toric_cycle_device_deed
  apparatus/host/r23_toric_cycle_deed.cpp
...
set(R23_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/cuda/executor/r23_toric_cycle_kernels.cu")
...
set(R23_DECLARED_COMMANDS
  "device_ptx=<CUDA_COMPILER> ${R23_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/cuda/executor/r23_toric_cycle_kernels.cu -o <BUILD>/generated/r23_toric_cycle_kernels.ptx\n"
  "device_cubin=<CUDA_COMPILER> ${R23_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/cuda/executor/r23_toric_cycle_kernels.cu -o <BUILD>/generated/r23_toric_cycle_kernels.cubin\n"
