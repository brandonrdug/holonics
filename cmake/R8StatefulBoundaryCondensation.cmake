...
add_library(
  ...
  cuda/executor/r8_condensation_executor.cu
  cuda/executor/r8_condensation_kernels.cu)
...
add_executable(
  ...
  apparatus/host/r8_stateful_boundary_condensation_deed.cpp
...
set(R8_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/cuda/executor/r8_condensation_kernels.cu")
...
set(R8_DECLARED_COMMANDS
    "device_ptx=<CUDA_COMPILER> ${R8_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/cuda/executor/r8_condensation_kernels.cu -o <BUILD>/generated/r8_condensation_kernels.ptx\n"
