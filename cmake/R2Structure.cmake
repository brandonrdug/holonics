...
add_library(r2_structure_executor STATIC src/cuda/executor/r2_structure_executor.cu)
...
add_executable(
  ...
  src/apparatus/host/r2_structure_deed.cpp
...
set(R2_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/src/cuda/executor/r2_structure_executor.cu")
file(
...
set(R2_DECLARED_COMMANDS
    "device_ptx=<CUDA_COMPILER> ${R2_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r2_structure_executor.cu -o <BUILD>/generated/r2_structure_executor.ptx\n"
    "device_cubin=<CUDA_COMPILER> ${R2_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r2_structure_executor.cu -o <BUILD>/generated/r2_structure_executor.cubin\n")
