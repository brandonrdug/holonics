...
add_library(
  ...
  src/cuda/executor/r3_admission_kernels.cu
  src/cuda/executor/r3_source_executor.cu
  src/cuda/executor/r3_source_kernels.cu
  src/cuda/executor/r3_navigation_kernels.cu)
...
add_executable(
  ...
  src/apparatus/host/r3_source_topology_deed.cpp
  src/apparatus/host/source_store_adapter.cpp
...
set(R3_FOUNDATION_SOURCE "${PROJECT_SOURCE_DIR}/src/cuda/executor/r3_source_kernels.cu")
set(R3_NAVIGATION_SOURCE "${PROJECT_SOURCE_DIR}/src/cuda/executor/r3_navigation_kernels.cu")
set(R3_ADMISSION_SOURCE "${PROJECT_SOURCE_DIR}/src/cuda/executor/r3_admission_kernels.cu")
...
set(R3_DECLARED_COMMANDS
    "device_ptx=<CUDA_COMPILER> ${R3_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r3_source_kernels.cu -o <BUILD>/generated/r3_source_kernels.ptx\n"
    "device_cubin=<CUDA_COMPILER> ${R3_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r3_source_kernels.cu -o <BUILD>/generated/r3_source_kernels.cubin\n"
    "device_ptx=<CUDA_COMPILER> ${R3_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r3_navigation_kernels.cu -o <BUILD>/generated/r3_navigation_kernels.ptx\n"
    "device_cubin=<CUDA_COMPILER> ${R3_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r3_navigation_kernels.cu -o <BUILD>/generated/r3_navigation_kernels.cubin\n"
    "device_ptx=<CUDA_COMPILER> ${R3_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r3_admission_kernels.cu -o <BUILD>/generated/r3_admission_kernels.ptx\n"
    "device_cubin=<CUDA_COMPILER> ${R3_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r3_admission_kernels.cu -o <BUILD>/generated/r3_admission_kernels.cubin\n")
