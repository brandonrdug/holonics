...
add_library(text_material_mount STATIC cuda/executor/text_material_mount.cu)
target_link_libraries(
  text_material_mount
  PRIVATE holonics::apparatus holonics_contract_options CUDA::cudart)

add_executable(text_mount_deed apparatus/host/text_mount_deed.cpp)
target_link_libraries(
  text_mount_deed
  PRIVATE holonics::apparatus holonics_contract_options text_material_mount
          CUDA::cudart)

set(TEXT_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/cuda/executor/text_material_mount.cu")
file(
  GLOB TEXT_DEVICE_HEADERS CONFIGURE_DEPENDS
  "${PROJECT_SOURCE_DIR}/include/holonics/apparatus/*.hpp"
  "${PROJECT_SOURCE_DIR}/include/holonics/codec/text*.hpp"
  "${PROJECT_SOURCE_DIR}/include/holonics/event/text*.hpp"
  "${PROJECT_SOURCE_DIR}/include/holonics/organ/*.hpp"
  "${PROJECT_SOURCE_DIR}/cuda/executor/text_mount*.cuh")
...
set(TEXT_DEVICE_COMMON_FLAGS
    ...
    -I${PROJECT_SOURCE_DIR}/cuda/executor
...
set(TEXT_DECLARED_COMMANDS
    "device_ptx=<CUDA_COMPILER> ${TEXT_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/cuda/executor/text_material_mount.cu -o <BUILD>/generated/text_material_mount.ptx\n"
    "device_cubin=<CUDA_COMPILER> ${TEXT_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/cuda/executor/text_material_mount.cu -o <BUILD>/generated/text_material_mount.cubin\n")
