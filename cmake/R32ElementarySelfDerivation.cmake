...
add_library(r32_elementary_store STATIC
  apparatus/host/elementary_card_adapter.cpp apparatus/host/elementary_rest_adapter.cpp)
target_link_libraries(r32_elementary_store PRIVATE holonics::apparatus holonics_contract_options)

add_library(r32_elementary_executor STATIC apparatus/host/lean_checker_process.cpp
  apparatus/host/returned_theorem_checker_process.cpp
  cuda/executor/r32_elementary_currents.cu cuda/executor/r32_elementary_kernels.cu
  cuda/executor/r32_discovery_executor.cu cuda/executor/r32_application_executor.cu)
target_link_libraries(r32_elementary_executor
  PRIVATE holonics::apparatus holonics_contract_options CUDA::cudart)

add_executable(r32_elementary_discovery_device_deed apparatus/host/r32_elementary_discovery_deed.cpp)
...
add_executable(r32_heldout_holonomy_device_deed apparatus/host/r32_heldout_holonomy_deed.cpp)
...
file(GLOB_RECURSE R32_DEVICE_HEADERS CONFIGURE_DEPENDS "${PROJECT_SOURCE_DIR}/include/holonics/*.hpp")
set(R32_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/cuda/executor/r32_elementary_kernels.cu")
...
set(R32_DECLARED_COMMANDS
  "device_ptx=<CUDA_COMPILER> ${R32_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/cuda/executor/r32_elementary_kernels.cu -o <BUILD>/generated/r32_elementary_kernels.ptx\n"
  "device_cubin=<CUDA_COMPILER> ${R32_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/cuda/executor/r32_elementary_kernels.cu -o <BUILD>/generated/r32_elementary_kernels.cubin\n"
