...
add_library(r35_trace_rebase_store STATIC
  apparatus/host/trace_rebase_card_adapter.cpp
  apparatus/host/trace_rebase_rest_adapter.cpp)
...
add_library(r35_trace_rebase_executor STATIC
  ...
  cuda/executor/r35_trace_rebase_currents.cu
  cuda/executor/r35_trace_rebase_kernels.cu
  cuda/executor/r35_heldout_trace_rebase_kernels.cu
  cuda/executor/r35_trace_rebase_discovery_executor.cu
  cuda/executor/r35_trace_rebase_application_executor.cu)
...
add_executable(r35_trace_rebase_discovery_device_deed
  apparatus/host/r35_trace_rebase_discovery_deed.cpp)
...
add_executable(r35_trace_rebase_application_device_deed
  apparatus/host/r35_trace_rebase_application_deed.cpp)
...
set(R35_DEVICE_SOURCE
  "${PROJECT_SOURCE_DIR}/cuda/executor/r35_trace_rebase_kernels.cu")
set(R35_HELDOUT_DEVICE_SOURCE
  "${PROJECT_SOURCE_DIR}/cuda/executor/r35_heldout_trace_rebase_kernels.cu")
...
set(R35_DEVICE_COMMON_FLAGS --std=c++20 -O3 --gpu-architecture=sm_89
  --fmad=false --Werror=all-warnings -I${PROJECT_SOURCE_DIR}/include
...
set(R35_DECLARED_COMMANDS
  "device_ptx=<CUDA_COMPILER> ${R35_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/cuda/executor/r35_trace_rebase_kernels.cu -o <BUILD>/generated/r35_trace_rebase_kernels.ptx\n"
  "device_cubin=<CUDA_COMPILER> ${R35_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/cuda/executor/r35_trace_rebase_kernels.cu -o <BUILD>/generated/r35_trace_rebase_kernels.cubin\n"
  "heldout_device_ptx=<CUDA_COMPILER> ${R35_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/cuda/executor/r35_heldout_trace_rebase_kernels.cu -o <BUILD>/generated/r35_heldout_trace_rebase_kernels.ptx\n"
  "heldout_device_cubin=<CUDA_COMPILER> ${R35_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/cuda/executor/r35_heldout_trace_rebase_kernels.cu -o <BUILD>/generated/r35_heldout_trace_rebase_kernels.cubin\n"
