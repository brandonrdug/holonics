...
add_library(
  ...
  src/cuda/executor/r9_codec_executor.cu
  src/cuda/executor/r9_codec_kernels.cu)
...
add_executable(
  ...
  src/apparatus/host/r9_agnostic_codecs_reflection_deed.cpp
  src/apparatus/host/codec_store_adapter.cpp
...
set(R9_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/src/cuda/executor/r9_codec_kernels.cu")
...
set(R9_DECLARED_COMMANDS
    "device_ptx=<CUDA_COMPILER> ${R9_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r9_codec_kernels.cu -o <BUILD>/generated/r9_codec_kernels.ptx\n"
    "device_cubin=<CUDA_COMPILER> ${R9_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r9_codec_kernels.cu -o <BUILD>/generated/r9_codec_kernels.cubin\n")
