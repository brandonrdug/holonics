...
if(NOT DEFINED OUTPUT)
  message(FATAL_ERROR "R35 seal requires OUTPUT")
endif()
foreach(required IN ITEMS SOURCE_AUDIT DISC_DEED APP_DEED INTERMEDIATE FINAL_REST
    DISC_SOURCE DISC_OLEAN STATE_ATLAS EDGE_ATLAS TANGENT_ATLAS LAW_ATLAS APP_SOURCE APP_OLEAN
    DOSSIER APP_ATLAS HOST_CONFORMANCE DETERMINISM)
  if(NOT DEFINED ${required} OR NOT EXISTS "${${required}}")
    message(FATAL_ERROR "R35 seal requires ${required}")
  endif()
endforeach()
set(paths "${SOURCE_AUDIT}" "${DISC_DEED}" "${APP_DEED}" "${INTERMEDIATE}" "${FINAL_REST}"
  "${DISC_SOURCE}" "${DISC_OLEAN}" "${STATE_ATLAS}" "${EDGE_ATLAS}" "${TANGENT_ATLAS}"
  "${LAW_ATLAS}" "${APP_SOURCE}" "${APP_OLEAN}" "${DOSSIER}" "${APP_ATLAS}"
