...
add_library(r27_expression_geometry_store STATIC
  src/apparatus/host/expression_geometry_card_adapter.cpp
  src/apparatus/host/expression_geometry_store_adapter.cpp)
...
add_library(r27_expression_geometry_executor STATIC
  ...
  src/cuda/executor/r27_expression_geometry_executor.cu
  src/cuda/executor/r27_expression_geometry_kernels.cu)
...
add_executable(r27_expression_geometry_device_deed
  src/apparatus/host/r27_expression_geometry_deed.cpp
...
set(R27_DEVICE_SOURCE "${PROJECT_SOURCE_DIR}/src/cuda/executor/r27_expression_geometry_kernels.cu")
...
set(R27_DECLARED_COMMANDS
  "device_ptx=<CUDA_COMPILER> ${R27_DEVICE_FLAGS_RECEIPT} --ptx <SOURCE>/src/cuda/executor/r27_expression_geometry_kernels.cu -o <BUILD>/generated/r27_expression_geometry_kernels.ptx\n"
  "device_cubin=<CUDA_COMPILER> ${R27_DEVICE_FLAGS_RECEIPT} --cubin <SOURCE>/src/cuda/executor/r27_expression_geometry_kernels.cu -o <BUILD>/generated/r27_expression_geometry_kernels.cubin\n"
...
holonic_found(NAME r27.expression_geometry_device_deed
  ...
  COMMAND
    ...
    "${PROJECT_SOURCE_DIR}/src/apparatus/cards/R27_EXPRESSION_GEOMETRY.card" "${R27_SOURCE}"
