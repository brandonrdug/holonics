...
| **Helical pair interaction: pair contact, phase-carried material, reflected return, menu closure** | [`Transport/HelicalPairInteraction`](../formal/elementary-holonics/ElementaryHolonics/Transport/HelicalPairInteraction.lean), joining `Geometry/ScrewGeometry` to `Transport/HolonicInteraction`; imported by `Framework.Dynamics` | `relational_geometry::screw::{ScrewPair,PairQuadranceJet}` with `holonic_interaction::{ContactFace,Medium,HolonicInteraction}` and `holonic_chain`. **No Rust file joins them yet**; `holonics-hna/src/` imports none of them | The [unit](HOLON.md#the-helical-pair-interaction-unit) is the HNN site. Native pair-derived face #28/#48, serial `SituatedScrew` chain #27, generator-machine geometry #17, remaining formal counterparts #62. |
