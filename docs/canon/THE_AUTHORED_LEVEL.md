...
**Genre:** canon (`docs/canon/THE_DOCUMENT_LAW.md` §1.1). It states the law, enumerates the population in
this tree, and gives the excision per instance. It is species **2.5** and **2.6** of
`docs/canon/THE_CONTAMINANT_PROTOCOL.md`, which holds the reading procedure.
...
`docs/canon/THE_CONTAMINANT_PROTOCOL.md` §2.6 carries the full statement.
...
**`crates/holonic-life/src/lean_mathematics/ecology.rs` has zero `const` declarations, zero registry rows, and
...
readings are `docs/canon/THE_CONTAMINANT_PROTOCOL.md` §4. In one line: **a wave of excisions that reports
...
`crates/holonic-life/src/material_shadow_cuda.rs:144` stages every passage as
