...
done in a neighbouring material. `docs/canon/THE_TIMELINE.md` now serves the same purpose from the other
...
computation. `docs/canon/TABLET_THE_CHART.md:227-289`:
