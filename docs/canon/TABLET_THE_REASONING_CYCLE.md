...
**Governing documents:** `docs/canon/THE_HOLOBROCHOS_SPINE.md`,
`docs/canon/TABLET_THE_OPERATIONS.md`, `docs/canon/TABLET_THE_RESONANCE.md`, and
`docs/canon/01_CAUSAL_CALCULUS.md`, with the circulation discipline in
