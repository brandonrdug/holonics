...
**Read this before `docs/canon/THE_QUOTE_NETWORK.md`.** That file is *what he said*. This one is *how to
...
- **`PreimageFibre`** — the complete lineage-bearing preimage of one stable
  ...
  retain their names. Definition and owner: `docs/canon/TABLET_THE_OPERATIONS.md` §5.4 and the live
