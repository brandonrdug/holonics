...
`examples/the_two_instruments_disagree.rs`. `docs/plans/THE_ROADMAP.md` already recorded the
...
The live canon states warp/weft (`docs/canon/04_GEOMETRY_NAVIGATION_AND_WEAVE.md:67-73`) and **drops the
