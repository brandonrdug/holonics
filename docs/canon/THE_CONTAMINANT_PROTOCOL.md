...
**Genre:** canon (`docs/canon/THE_DOCUMENT_LAW.md` §1.2). It names a family of contaminant species, gives
...
(`crates/holonic-life/src/relational_language/ecology.rs:626`, `:639`), then `LEADER_WITNESS_DEPTH: usize = 1`
...
**Two verified instances, one day.** `archive/reference/holobrochos-a07ff376/src/soma/FORMULA.md` §XVIII was
...
reached a commit: `docs/plans/THE_ROADMAP.md` carried *"Ratified by Brandon"* for a **reading**, when
...
The full statement and the enumerated population are `docs/canon/THE_AUTHORED_LEVEL.md`.

**Verified instances. Ten were excised 2026-08-09 and nine of the ten moved a return**; the orbits
are `docs/canon/THE_AUTHORED_LEVEL.md` §5.0. They are kept here as the worked examples of the condition,
...
`docs/canon/THE_TRAFFIC_SYSTEM.md` is the worked form.
...
- The record exists, the canon points at it, the owners point back (`docs/canon/THE_DOCUMENT_LAW.md` §4.5).
...
- **Mathematical error.** A false theorem, correctly graded and correctly consumed, trips no species
  here. Grading truth is `docs/canon/EPISTEMIC_GRADES.md`.
...
- **Priority and scheduling.** It says what may be deposited, never what to build.
  `docs/plans/THE_ROADMAP.md` holds the order of work; `docs/canon/THE_HOLOBROCHOS_SPINE.md` decides whether
  an organ is on the spine at all.
- **Figures whose source is unrecoverable.** `docs/canon/THE_MEASURED_CAPABILITIES.md` §4 holds those.
