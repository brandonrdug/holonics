...
Verification was not run in this commit. Run the core winding unit suite, engine receiver/lattice
integration tests, HolonicInteraction and matroid winding consumers, then the existing Lean citation
gate after this branch is stacked on the causal-chord work.
