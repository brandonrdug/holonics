...
| `ConservingReceiverSpace` | struct | `holonic-engine/src/causal_chord.rs` | receiver face (codec) | a receiver chart/aperture geometry (where a face is read), not a port object (name-inferred) |
...
| `ReceiverCoupling` | struct | `holonic-engine/src/live_presentation.rs` | different object | retention/compression algebra or relation over receiver functionals (retained standing, not a port object) (name-inferred) |
| `ReceiverCouplingSet` | struct | `holonic-engine/src/live_presentation.rs` | different object | retention/compression algebra or relation over receiver functionals (retained standing, not a port object) (name-inferred) |
