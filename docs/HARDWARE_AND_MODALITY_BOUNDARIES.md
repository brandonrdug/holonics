...
The [Apple extension](../research/records/2026-09-07_APPLE_RETURNS_THE_SHARED_CONDITION_PREIMAGE_FIBRE.md)
now realizes `section_constitutive_condition_preimage`, over the same exact
...
The public example agrees in every semantic field; 22 engine controls pass on Apple. The public
text-codec control retains its unported paired-field refusal. Generic relation
...
[established-bounded; implemented-exact] The [Apple contact return](../research/records/2026-09-07_APPLE_RETAINS_CONDITION_CURRENT_THROUGH_RECORDED_CONTACT.md)
now realizes these two kernels with twelve and seventeen arguments respectively. Contact
