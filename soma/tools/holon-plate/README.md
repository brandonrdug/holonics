...
superseded — `soma/membrane/src/live_current.rs:1241` and `soma/life/src/holonic_training.rs:443`
...
Every `soma/life/examples/*` driver that reaches a rest **hashes** its form into a JSON receipt and
