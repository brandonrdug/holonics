...
//!   ─────────────          ────────                        ────────────────────
//!   encode_native_bytes ─▶ output/<driver>/<name>-<sha>.form ─▶ deposit ─▶ .holon ─▶ resume ─▶ a body
//!          │                                                                                   │
...
/// `holon-plate deposit --from ERST:output/<driver>/<name>-<sha256>.form` stops resolving and
...
fn the_production_entry_point_writes_under_output_and_the_form_resumes() {
    ...
    assert_eq!(
        ...
        PathBuf::from(format!(
            "output/{driver}/machine-rest-{}.form",
    ...
    assert_eq!(
        ...
        PathBuf::from(format!(
            "output/{htec_driver}/training-ecology-rest-{}.form",
