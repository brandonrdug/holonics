...
//! than a copy.
//!
//! `blueprint/THE_ASSEMBLY.md`: *"the resumer must compute a census field the depositor could
...
//!
//! That count is a **declaration**, not a hand-off. `blueprint/THE_ASSEMBLY.md`: *"no adapter may
...
//! bijection's name, and `blueprint/THE_ASSEMBLY.md` step 6 asks for the bijection.
//!
