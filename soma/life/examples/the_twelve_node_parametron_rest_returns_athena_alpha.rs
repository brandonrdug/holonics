...
const GLUE: &str =
    "output/the_second_successor_receiver_and_support_faces_glue_the_twelve_node_parametron";
...
const OUTPUT: &str = "output/the_twelve_node_parametron_rest_returns_athena_alpha";
...
fn main() -> Result<(), String> {
    ...
    write_json(
        ...
        &json!({
            ...
            "command":"target/release/examples/the_twelve_node_parametron_rest_returns_athena_alpha",
