...
const OUT: &str = "output/the_native_codec_is_cultivated_and_returns_complete_mathematics";
...
pub fn write(
    ...
    let lean_path = root
        .join("soma/formal/elementary-holonics/ElementaryHolonics/Millennium/SpherePacking.lean");
...
fn run_lean(root: &Path, source: &[u8]) -> Result<LeanTestimony, String> {
    let cwd = root.join("soma/formal/elementary-holonics");
