...
//!
//! Third movement of `blueprint/THE_TYPED_TRANSPORT_ATLAS.md`, and its gate. `H.0362` names `D` as a
...
const MATHLIB: &str = "soma/formal/elementary-holonics/.lake/packages/mathlib";
...
fn main() {
    ...
    let scratch = root.join("output/the-declaration-is-a-formulation-node");
