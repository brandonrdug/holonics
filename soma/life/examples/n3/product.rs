...
pub const DEFAULT_OUT: &str =
    "output/the_returned_native_mathematical_world_cultivates_the_laboratory_hexis";
const PREDECESSOR_REST: &str =
    "output/recurring_laboratory_transport_condenses_into_native_hexis/native-rest";
const CHRONOLOGY: &str = "output/the_laboratory_chronology_cultivates_the_athena_mathematics_ecology/00-frozen-laboratory-chronology.json";
const N2_MANIFEST: &str = "output/the_acoustic_section_crosses_the_inherited_projection_and_three_ports_share_one_native_ecology/MANIFEST.json";
