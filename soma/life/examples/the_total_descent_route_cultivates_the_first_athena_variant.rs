...
fn complete_exterior(
    ...
    let teacher_git_path =
        "soma/formal/elementary-holonics/ElementaryHolonics/Millennium/FaceHomomorphism.lean";
    ...
    let extractor =
        workspace.join("soma/formal/elementary-holonics/.lake/build/bin/m6_lean_causal_return");
