...
pub const DEFAULT_OUT: &str = "output/the_mathematical_and_physical_faces_share_native_transport";
const I4: &str = "output/the_heterogeneous_ports_found_one_shared_phoenix_ecology/native-rest";
const R4: &str = "output/the_retained_causal_boundary_carries_the_long_horizon_inquiry/native-rest";
