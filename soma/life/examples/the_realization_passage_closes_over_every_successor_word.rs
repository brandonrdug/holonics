...
const DEFAULT_OUT: &str =
    "output/the_physical_realization_passage_closes_over_every_successor_word";
...
fn code_closure() -> String {
    ...
    for bytes in [
        ...
        include_bytes!("../../../crates/holonic-engine/src/realization/passage.rs").as_slice(),
        include_bytes!("../../../crates/holonic-engine/src/receiver_history_compression.rs")
            .as_slice(),
        include_bytes!("../../../crates/holonic-engine/src/cross_chart.rs").as_slice(),
        include_bytes!("../../../crates/holonic-engine/src/generator_native_rest.rs").as_slice(),
        include_bytes!(
            "../../formal/elementary-holonics/ElementaryHolonics/Millennium/PhysicalRealization.lean"
        )
        .as_slice(),
