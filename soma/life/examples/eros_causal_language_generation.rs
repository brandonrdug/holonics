...
//! `ba8716b5:src/soma/life/examples/eros_causal_language_generation.rs` (478 lines). Deleted at
...
//!     soma/life/driver-sources/eros-causal-language-generation-01/SOURCE.json REPORT.json
//! ```
