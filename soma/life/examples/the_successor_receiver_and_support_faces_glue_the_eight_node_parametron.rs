...
use holonic_engine::{
    ...
    phoenix::{
        ...
        foreign_potential_rest::{
            ForeignPotentialComplexRest, PotentialReceiverCertificate,
        },
...
fn main() -> Result<(), String> {
    ...
    {
        return Err("the predecessor, emitted lineage and expanded incidence do not glue".to_owned());
    }

    let foreign_quotient = expanded
