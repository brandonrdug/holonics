...
pub struct CandidateRequest {
    ...
    pub history_faces: Vec<CandidateHistoryFace>,
}
...
#[derive(Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct ReturnedSiblingDefect {
    pub schema: String,
    pub proposal: String,
...
pub fn conduct_history_only_candidate(
    session: &ProductSession,
    request: &CandidateRequest,
) -> Result<SealedCandidate, String> {
...
fn seal(
    ...
    let alternatives = returned
        ...
        .plural
        .iter()
        .map(|candidate| CandidateAlternative {
    ...
    .map_err(|error| error.to_string())?;
    Ok(SealedCandidate {
        schema: "soma-life.athena-sealed-history-candidate.v1".to_owned(),
...
pub fn return_sibling_defect(
    ...
    sibling: &SiblingTestimony,
) -> Result<ReturnedSiblingDefect, String> {
    ...
    Ok(ReturnedSiblingDefect {
        schema: "soma-life.athena-returned-sibling-defect.v1".to_owned(),
        ...
        resident: ResidentDefectReceipt {
            schema: "holonic-engine.athena-resident-graded-defect.v1".to_owned(),
...
fn digest_intervals(intervals: &[(i64, i64)]) -> String {
    ...
    digest.update(b"athena/sealed-terminal-potential/v1");
