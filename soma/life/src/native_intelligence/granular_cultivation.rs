...
use super::{
    AffineLaboratoryCellWithdrawal, AffineLaboratoryCultivatedRest, GranularFactorAction,
    GranularFactorGenerator, GranularFactorReceiver, GranularMembraneStanding,
    ...
    RecurrentReturnedAffinePredecessor, ReturnedAffineLaboratoryRest, SituatedCultivationBranch,
    SituatedDifferenceSection,
};

pub const GRANULAR_ECOLOGY_REST_SCHEMA: &str = "soma-life.granular-ecology-rest.v9";
...
#[serde(deny_unknown_fields)]
pub struct GranularEcologyRest<Body> {
    schema: String,
...
pub type GranularAffineEcologyRest = GranularEcologyRest<AffineLaboratoryCultivatedRest>;
pub type GranularReturnedAffineEcologyRest = GranularEcologyRest<ReturnedAffineLaboratoryRest>;
pub type RecurrentGranularReturnedAffineEcologyRest =
    GranularEcologyRest<RecurrentReturnedAffineLaboratoryRest>;

#[derive(Debug, PartialEq, Eq)]
pub enum RecurrentGranularReturnedAffinePredecessor {
    First(GranularReturnedAffineEcologyRest),
    Recurrent(RecurrentGranularReturnedAffineEcologyRest),
}
...
impl GranularAffineEcologyRest {
    pub fn cultivate(
        body: AffineLaboratoryCultivatedRest,
...
impl GranularReturnedAffineEcologyRest {
    pub fn cultivate_returned(
        body: ReturnedAffineLaboratoryRest,
        aperture: &ContinuationAperture,
        world: &VisibleMessageProjection,
        lineage: &GranularFactorLineageProjection,
    ) -> Result<(Self, GranularCultivationReceipt), GranularCultivationError> {
    ...
    ) -> Result<RecurrentGranularReturnedAffineEcologyRest, GranularCultivationError> {
        self.validate()?;
    ...
    pub(super) fn deposit_additional_returned_difference_admitted(
        ...
        let mut rest = GranularEcologyRest {
            schema,
...
impl RecurrentGranularReturnedAffineEcologyRest {
    pub fn deposit_additional_returned_difference(
        self,
        difference: SituatedDifferenceSection,
    ...
    pub fn restore_latest_returned_difference_from_admitted(
        ...
        let body = RecurrentReturnedAffineLaboratoryRest::
...
impl<Body> GranularEcologyRest<Body>
where
    Body: MembraneStanding + Serialize + DeserializeOwned,
{
    pub fn read(bytes: &[u8]) -> Result<Self, GranularCultivationError> {
    ...
    pub fn validate(&self) -> Result<(), GranularCultivationError> {
        ...
        if self.schema != GRANULAR_ECOLOGY_REST_SCHEMA
    ...
    pub fn restore(
        ...
        let mut rest = Self {
            schema: GRANULAR_ECOLOGY_REST_SCHEMA.to_owned(),
            predecessor_rest_identity_sha256,
            cultivation_lineage_sha256,
            body,
            granular,
...
impl<Body> MembraneDifferenceStanding for GranularEcologyRest<Body>
where
    Body: MembraneDifferenceStanding + Serialize + DeserializeOwned,
    Body::Successor: MembraneStanding + Serialize + DeserializeOwned,
{
    type Successor = GranularEcologyRest<Body::Successor>;
...
impl<Body> MembraneStanding for GranularEcologyRest<Body>
where
    Body: MembraneStanding + Serialize + DeserializeOwned,
{
...
impl<Body> GranularMembraneStanding for GranularEcologyRest<Body>
where
    Body: MembraneStanding + Serialize + DeserializeOwned,
{
...
fn cultivate_granular<Body>(
    ...
    world: &VisibleMessageProjection,
    lineage: &GranularFactorLineageProjection,
) -> Result<(GranularEcologyRest<Body>, GranularCultivationReceipt), GranularCultivationError>
where
    Body: MembraneStanding + Serialize + DeserializeOwned,
{
    body.validate_membrane_standing()
