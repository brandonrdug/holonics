...
use super::super::{
    AffineLaboratoryCultivatedRest, MembraneCrossingReceipt, ReturnedAffineLaboratoryRest,
};
use super::*;
...
impl NativeRadiationAperture {
    ...
    pub fn found(rest: &ReturnedAffineLaboratoryRest) -> Result<Self, NativeRadiationError> {
        rest.validate()
...
impl NativeRadiationSection {
    pub fn found(
        rest: &impl super::super::MembraneStanding,
