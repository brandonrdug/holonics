...
use holonic_engine::{
    ...
    native_spool::{
        ...
        NativeSituatedRadicalWithdrawal, NativeSituatedThreadWithdrawal, NativeThread,
...
use crate::native_intelligence::exchange_situated_product::{
    ExchangeSituatedProduct, K3PullbackBranch, MixedConstitutiveInteractionFamily,
    NativeStateExchangeCover,
};
use crate::native_intelligence::returned_difference_deposit::{
    derive_returned_difference_deposit_from_history, ReturnedDifferenceStaging,
};
use crate::native_intelligence::situated_difference::SituatedDifferenceSection;
use crate::native_intelligence::types::{NativeEcologyRest, ReceiverHistoryRealizationPassage};

pub const SITUATED_CULTIVATED_ECOLOGY_REST_SCHEMA: &str =
    "soma-life.situated-cultivated-ecology-rest.v1";
pub const LABORATORY_CULTIVATED_ECOLOGY_REST_SCHEMA: &str =
    "soma-life.laboratory-cultivated-rest.v1";
...
#[derive(Debug, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct LaboratoryCultivatedRest {
    schema: String,
...
pub const RECURRENT_LABORATORY_CULTIVATED_ECOLOGY_REST_SCHEMA: &str =
    "soma-life.recurrent-laboratory-cultivated-rest.v1";
...
#[derive(Debug, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct RecurrentLaboratoryCultivatedRest {
    schema: String,
...
pub enum RecurrentLaboratoryPredecessor {
    First(LaboratoryCultivatedRest),
    Recurrent(RecurrentLaboratoryCultivatedRest),
}
...
pub struct ResidentLaboratoryCultivatedEcology {
    rest: LaboratoryCultivatedRest,
...
pub struct ResidentSituatedCultivatedEcology {
