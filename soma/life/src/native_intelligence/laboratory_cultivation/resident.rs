impl ResidentAffineLaboratoryEcology {
    ...
    pub fn into_rest(
        self,
    ) -> Result<AffineLaboratoryCultivatedRest, LaboratoryCultivationError> {
        let rest = AffineLaboratoryCultivatedRest {
            schema: self.schema,
...
impl ResidentRecurrentAffineLaboratoryEcology {
    ...
    pub fn into_rest(self) -> RecurrentReturnedAffineLaboratoryRest {
        self.rest
    }
}
