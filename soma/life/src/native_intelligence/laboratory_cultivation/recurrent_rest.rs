impl RecurrentReturnedAffineLaboratoryRest {
    ...
    pub fn body(&self) -> &RecurrentLaboratoryCultivatedRest {
        &self.body
    }
    ...
    pub fn mount_recurrent_integrated(
        self,
    ) -> Result<ResidentRecurrentAffineLaboratoryEcology, LaboratoryCultivationError> {
        self.validate()?;
        ...
        .map_err(|error| LaboratoryCultivationError::Relational(error.to_string()))?;
        Ok(ResidentRecurrentAffineLaboratoryEcology {
            rest: self,
            factors,
            expected,
            resident,
    ...
    > {
        ...
        let predecessor = match body {
            RecurrentLaboratoryPredecessor::First(body) => {
                let rest = ReturnedAffineLaboratoryRest {
    ...
    pub(super) fn restore_latest_returned_difference_from_admitted(
        ...
        let (
            ...
            RecurrentReturnedAffinePredecessor::First(rest) => {
                let ReturnedAffineLaboratoryRest {
                    schema: _,
        ...
        let body = RecurrentLaboratoryCultivatedRest::
