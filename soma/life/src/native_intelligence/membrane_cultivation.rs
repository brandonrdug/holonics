...
use super::{
    AdmittedMembraneStanding, AffineLaboratoryCultivatedRest, CausalAdjointStepInput,
    MembraneReturn, MembraneStanding, NativeCausalMembrane, RecurrentReturnedAffineLaboratoryRest,
    ReturnedAffineLaboratoryRest, SituatedDifferenceInput, SituatedDifferenceSection,
};

pub const MEMBRANE_CULTIVATION_SCHEMA: &str = "soma-life.membrane-cultivation.v1";
pub const DETACHED_MEMBRANE_CULTIVATION_SCHEMA: &str = "soma-life.detached-membrane-cultivation.v1";
...
pub struct StagedMembraneCultivation<Standing = AffineLaboratoryCultivatedRest> {
    membrane: NativeCausalMembrane<Standing>,
    world_return: MembraneReturn,
...
impl<Standing: MembraneStanding> StagedMembraneCultivation<Standing> {
    pub fn found(
        membrane: NativeCausalMembrane<Standing>,
        world_return: MembraneReturn,
        resident_return: ResidentMembraneInteriorReturn,
        ...
        let difference = SituatedDifferenceSection::found(SituatedDifferenceInput {
            ...
            open_deposition_boundary: format!("membrane-deposition/{}", returned_event.0),
            open_exterior,
        })
        .map_err(|error| MembraneCultivationError::Difference(error.to_string()))?;
        if trace {
...
pub trait MembraneDifferenceStanding: MembraneStanding + Sized {
    type Successor: MembraneStanding;
...
impl MembraneDifferenceStanding for AffineLaboratoryCultivatedRest {
    type Successor = ReturnedAffineLaboratoryRest;
...
impl<Standing: MembraneDifferenceStanding> MembraneDifferenceStanding
    for AdmittedMembraneStanding<Standing>
{
...
impl MembraneDifferenceStanding for ReturnedAffineLaboratoryRest {
    type Successor = RecurrentReturnedAffineLaboratoryRest;
...
impl MembraneDifferenceStanding for RecurrentReturnedAffineLaboratoryRest {
    type Successor = Self;
