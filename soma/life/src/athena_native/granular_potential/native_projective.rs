impl NativeGranularPotential {
    ...
    pub(super) fn read_developmental_predecessor(
        ...
        if !schema.starts_with("soma-life.athena-native-causal-boundary-potential.")
    ...
    /// to the exterior apparatus; [`SourceNeutralAthenaRest`](super::SourceNeutralAthenaRest)
