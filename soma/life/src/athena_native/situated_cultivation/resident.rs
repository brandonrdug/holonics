...
impl ResidentLaboratoryCultivatedAthena {
    ...
    pub fn into_rest(self) -> LaboratoryCultivatedAthenaRest {
        self.rest
    }
}

impl ResidentSituatedCultivatedAthena {
    ...
    pub fn into_rest(self) -> SituatedCultivatedAthenaRest {
        self.rest
    }
}
...
pub(crate) fn derive_recurrent_resident_coupling(
    rest: &RecurrentLaboratoryCultivatedAthenaRest,
) -> Result<ResidentCoupling, SituatedCultivationError> {
    rest.validate()?;
...
pub(super) fn derive_returned_difference_deposit(
    ...
    .map_err(|error| match error {
        crate::athena_native::returned_difference_deposit::ReturnedDifferenceError::Descent(
            message,
        ) => SituatedCultivationError::Descent(message),
        crate::athena_native::returned_difference_deposit::ReturnedDifferenceError::Ecology(
            message,
