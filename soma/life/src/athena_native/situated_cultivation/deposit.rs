...
impl LaboratoryCultivatedAthenaRest {
    ...
    pub fn validate(&self) -> Result<(), SituatedCultivationError> {
        ...
        if self.schema != LABORATORY_CULTIVATED_ATHENA_REST_SCHEMA
    ...
    pub fn mount(self) -> Result<ResidentLaboratoryCultivatedAthena, SituatedCultivationError> {
        self.validate()?;
        ...
        .map_err(|error| SituatedCultivationError::Apparatus(error.to_string()))?;
        Ok(ResidentLaboratoryCultivatedAthena {
            rest: self,
            factors,
            expected,
            resident,
    ...
    > {
        self.validate()?;
        let LaboratoryCultivatedAthenaRest {
            schema: _,
        ...
        let realization = ReceiverHistoryRealizationPassage::found(ecology.native())
            .map_err(|error| SituatedCultivationError::Ecology(error.to_string()))?;
        let predecessor = SituatedCultivatedAthenaRest {
            schema: SITUATED_CULTIVATED_ATHENA_REST_SCHEMA.to_owned(),
            predecessor_wire_sha256,
            ecology,
            realization,
            branches,
    ...
    pub fn restore_returned_difference(
        predecessor: SituatedCultivatedAthenaRest,
        ...
        let SituatedCultivatedAthenaRest {
            schema: _,
            predecessor_wire_sha256,
            ecology,
            realization: _,
        ...
        let realization = ReceiverHistoryRealizationPassage::found(ecology.native())
            .map_err(|error| SituatedCultivationError::Ecology(error.to_string()))?;
        let mut rest = Self {
            schema: LABORATORY_CULTIVATED_ATHENA_REST_SCHEMA.to_owned(),
            predecessor_rest_identity_sha256,
            predecessor_wire_sha256,
            ecology,
            realization,
    ...
    pub(crate) fn rederived_identity(&self) -> Result<String, SituatedCultivationError> {
        super::resident::digest_json(&(
            LABORATORY_CULTIVATED_ATHENA_REST_SCHEMA,
            &self.predecessor_rest_identity_sha256,
...
impl LaboratoryCultivatedAthenaRest {
    ...
    ) -> Result<RecurrentLaboratoryCultivatedAthenaRest, SituatedCultivationError> {
        self.validate()?;
    ...
    pub(crate) fn deposit_additional_returned_difference_admitted(
        ...
        let realization = ReceiverHistoryRealizationPassage::found(ecology.native())
            .map_err(|error| SituatedCultivationError::Ecology(error.to_string()))?;
        let mut rest = RecurrentLaboratoryCultivatedAthenaRest {
            schema: RECURRENT_LABORATORY_CULTIVATED_ATHENA_REST_SCHEMA.to_owned(),
...
impl RecurrentLaboratoryCultivatedAthenaRest {
    ...
    pub fn validate(&self) -> Result<(), SituatedCultivationError> {
        ...
        if self.schema != RECURRENT_LABORATORY_CULTIVATED_ATHENA_REST_SCHEMA
    ...
    > {
        ...
        let predecessor = if returned_deposits.len() == 1 {
            let rest = LaboratoryCultivatedAthenaRest {
                schema: LABORATORY_CULTIVATED_ATHENA_REST_SCHEMA.to_owned(),
                predecessor_rest_identity_sha256: origin_predecessor_rest_identity_sha256,
                predecessor_wire_sha256,
                ecology,
            ...
            let rest = RecurrentLaboratoryCultivatedAthenaRest {
                schema,
                rest_identity_history,
                origin_predecessor_rest_identity_sha256,
                predecessor_wire_sha256,
    ...
    fn rederived_identity_with_ecology_identity(
        ...
        super::resident::digest_json(&(
            RECURRENT_LABORATORY_CULTIVATED_ATHENA_REST_SCHEMA,
            &self.rest_identity_history,
            &self.origin_predecessor_rest_identity_sha256,
            &self.predecessor_wire_sha256,
            ecology_identity,
