...
use holonic_engine::{ExactComplexWaveCurrent, ExactRatMatrix, is_sha256_digest as is_sha256};
use serde::Serialize;
use thiserror::Error;
...
use super::{
    ...
    SituatedCultivatedAthenaRest, SituatedCultivatedConductReturn,
};
...
pub struct SituatedEmanationPassage<Standing = SituatedCultivatedAthenaRest> {
    rest: Standing,
