...
pub const NATIVE_RADIATION_SCHEMA: &str = "soma-life.athena-native-radiation.v1";
...
pub const OPEN_WORLD_TUBE_RADIATION_SCHEMA: &str = "soma-life.athena-open-world-tube-radiation.v1";
