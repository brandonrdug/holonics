impl super::AthenaMembraneStanding for AffineLaboratoryCultivatedAthenaRest {
...
impl super::AthenaMembraneStanding for ReturnedAffineLaboratoryAthenaRest {
    fn validate_membrane_standing(&self) -> Result<(), String> {
        self.validate().map_err(|error| error.to_string())
    }
...
impl super::AthenaMembraneStanding for RecurrentReturnedAffineLaboratoryAthenaRest {
    fn validate_membrane_standing(&self) -> Result<(), String> {
        self.validate().map_err(|error| error.to_string())
    }
...
impl MaterialFactorizationStanding for AffineLaboratoryCultivatedAthenaRest {
...
impl MaterialFactorizationStanding for ReturnedAffineLaboratoryAthenaRest {
    fn validate_material_standing(&self) -> Result<(), String> {
        self.validate().map_err(|error| error.to_string())
    }
...
impl MaterialFactorizationStanding for RecurrentReturnedAffineLaboratoryAthenaRest {
    fn validate_material_standing(&self) -> Result<(), String> {
        self.validate().map_err(|error| error.to_string())
    }
