impl ReturnedAffineLaboratoryAthenaRest {
    ...
    pub fn read_admitted_membrane(
        bytes: &[u8],
        witness: &AdmittedReturnedAffineLaboratoryRestWitness,
    ) -> Result<super::AdmittedAthenaMembraneStanding<Self>, LaboratoryCultivationError> {
        let rest = Self::read_admitted(bytes, witness)?;
        super::AdmittedAthenaMembraneStanding::from_validated_wire(
            rest,
    ...
    pub fn body(&self) -> &LaboratoryCultivatedAthenaRest {
        &self.body
    }
    ...
    pub fn withdraw_returned_difference(
        ...
        (
            AffineLaboratoryCultivatedAthenaRest,
    ...
    > {
        ...
        let (body, situated) = body
            ...
            .map_err(|error| LaboratoryCultivationError::Situated(error.to_string()))?;
        let mut predecessor = AffineLaboratoryCultivatedAthenaRest {
    ...
    pub fn restore_returned_difference(
        predecessor: AffineLaboratoryCultivatedAthenaRest,
        ...
        let AffineLaboratoryCultivatedAthenaRest {
            schema: _,
        ...
        let body =
            LaboratoryCultivatedAthenaRest::restore_returned_difference(body, withdrawal.situated)
                .map_err(|error| LaboratoryCultivationError::Situated(error.to_string()))?;
    ...
    ) -> Result<RecurrentReturnedAffineLaboratoryAthenaRest, LaboratoryCultivationError> {
        self.validate()?;
    ...
    pub(super) fn deposit_additional_returned_difference_admitted(
        ...
        let body = body
            ...
            .map_err(|error| LaboratoryCultivationError::Situated(error.to_string()))?;
        let mut rest = RecurrentReturnedAffineLaboratoryAthenaRest {
