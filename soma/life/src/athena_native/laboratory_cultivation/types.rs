const REST_SCHEMA: &str = "soma-life.affine-laboratory-cultivated-athena-rest.v1";
const ADMITTED_REST_WITNESS_SCHEMA: &str = "soma-life.affine-laboratory-admitted-rest-witness.v1";
const RETURNED_REST_SCHEMA: &str = "soma-life.returned-affine-laboratory-cultivated-athena-rest.v1";
const RECURRENT_RETURNED_REST_SCHEMA: &str =
    "soma-life.recurrent-returned-affine-laboratory-cultivated-athena-rest.v1";
...
#[serde(deny_unknown_fields)]
pub struct AffineLaboratoryCultivatedAthenaRest {
    schema: String,
...
#[derive(Debug, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ReturnedAffineLaboratoryAthenaRest {
    schema: String,
    predecessor_rest_identity_sha256: String,
    predecessor_body_identity_sha256: String,
    body: LaboratoryCultivatedAthenaRest,
    potential: NativeRelationalPotentialComplex,
    codec: NativeRelationalCodec,
    correspondences: Vec<LaboratoryFactorCycleCorrespondence>,
    affine_cells: Vec<LaboratoryCellAffineSection>,
...
#[derive(Debug, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct RecurrentReturnedAffineLaboratoryAthenaRest {
    schema: String,
    ...
    body: RecurrentLaboratoryCultivatedAthenaRest,
    potential: NativeRelationalPotentialComplex,
    codec: NativeRelationalCodec,
    correspondences: Vec<LaboratoryFactorCycleCorrespondence>,
    affine_cells: Vec<LaboratoryCellAffineSection>,
...
pub enum RecurrentReturnedAffinePredecessor {
    First(ReturnedAffineLaboratoryAthenaRest),
    Recurrent(RecurrentReturnedAffineLaboratoryAthenaRest),
}
...
pub struct ResidentAffineLaboratoryAthena {
    schema: String,
    predecessor_rest_identity_sha256: String,
    body: SituatedCultivatedAthenaRest,
    ...
    resident: ResidentAthenaIntegratedFront,
}
...
pub struct ResidentRecurrentAffineLaboratoryAthena {
    rest: RecurrentReturnedAffineLaboratoryAthenaRest,
    factors: Vec<(String, Vec<String>)>,
    expected: Vec<holonic_engine::ExactComplexWaveCurrent>,
    resident: ResidentAthenaIntegratedFront,
}
