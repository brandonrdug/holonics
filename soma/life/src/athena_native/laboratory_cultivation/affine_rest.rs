impl AffineLaboratoryCultivatedAthenaRest {
    ...
    pub fn body(&self) -> &SituatedCultivatedAthenaRest {
        &self.body
    }
    ...
    pub fn deposit_returned_difference(
    ...
    ) -> Result<ReturnedAffineLaboratoryAthenaRest, LaboratoryCultivationError> {
        self.validate()?;
        let Self {
            schema: _,
        ...
        let body = body
            ...
            .map_err(|error| LaboratoryCultivationError::Situated(error.to_string()))?;
        let mut rest = ReturnedAffineLaboratoryAthenaRest {
    ...
    pub fn mount(self) -> Result<ResidentAffineLaboratoryAthena, LaboratoryCultivationError> {
        self.validate()?;
        ...
        .map_err(|error| LaboratoryCultivationError::Relational(error.to_string()))?;
        Ok(ResidentAffineLaboratoryAthena {
            schema,
            predecessor_rest_identity_sha256,
            body,
            factors,
