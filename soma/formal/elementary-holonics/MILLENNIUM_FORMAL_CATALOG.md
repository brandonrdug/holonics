...
|---|---:|
| Lean modules below `ElementaryHolonics/` | 455 |
| theorem or lemma declarations | 5,823 |
| theorem, lemma, definition, abbreviation, structure, class, or inductive declarations | 8,271 |
| modules below `ElementaryHolonics/Millennium/` | 409 |
| theorem or lemma declarations below `Millennium/` | 5,431 |
| broad declarations below `Millennium/` | 7,616 |
| explicit `#print axioms` audit commands below `Millennium/` | 1,495 |

[established-bounded; measured] The principal module bands are 16 Foundation modules, 2 Algorithm
modules, 8 Geometry modules, 20 dedicated RH modules, and 409 Millennium modules.  Search prefixes
inside the Millennium band include 196 `NavierStokes*`, 30 `Family*`, 15 `General*`, 10 `Five*`, 6
