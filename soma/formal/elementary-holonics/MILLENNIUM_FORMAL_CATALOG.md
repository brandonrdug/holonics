...
[established-bounded; measured] On the 2026-08-25 translation-to-dissipation closure after
identifying the actual vorticity Stokes population with the physical gradient-square receiver, the
station contains:

| Receiver | Returned count |
|---|---:|
| Lean modules below `ElementaryHolonics/` | 467 |
| theorem or lemma declarations | 5,961 |
| theorem, lemma, definition, abbreviation, structure, class, or inductive declarations | 8,444 |
| modules below `ElementaryHolonics/Millennium/` | 420 |
| theorem or lemma declarations below `Millennium/` | 5,563 |
| broad declarations below `Millennium/` | 7,782 |
| explicit `#print axioms` audit commands below `Millennium/` | 1,613 |

[established-bounded; measured] The principal module bands are 17 Foundation modules, 2 Algorithm
modules, 8 Geometry modules, 20 dedicated RH modules, and 420 Millennium modules.  Search prefixes
inside the Millennium band include 207 `NavierStokes*`, 30 `Family*`, 15 `General*`, 10 `Five*`, 6
