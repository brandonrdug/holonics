...
#include <holonics/codec/causal_linear_explanation_renderer.hpp>
#include <holonics/codec/causal_linear_renderer.hpp>
#include <holonics/event/causal_linear_return.hpp>
#include <holonics/event/causal_linear_surface_law.hpp>
...
class resident_causal_linear final {
 public:
  ...
  resident_causal_linear(const resident_causal_linear&) = delete;
  resident_causal_linear& operator=(const resident_causal_linear&) = delete;
  resident_causal_linear(resident_causal_linear&&) = delete;
  resident_causal_linear& operator=(resident_causal_linear&&) = delete;

  HOLONICS_CALLABLE resident_causal_linear(const organ::causal_linear_foundation& foundation,
      const algebraic_variation_rest_record& record,
      algebraic_variation_remount_receipt& receipt) noexcept;
  HOLONICS_CALLABLE resident_causal_linear(const causal_linear_rest_record& record,
  ...
  [[nodiscard]] HOLONICS_CALLABLE bool form(causal_linear_observation& observation) noexcept;
  [[nodiscard]] HOLONICS_CALLABLE bool resume(const checker_raw_return& raw,
      causal_linear_observation& observation) noexcept;
  [[nodiscard]] HOLONICS_CALLABLE causal_linear_rest_receipt rest(
 ...
 private:
  ...
  organ::causal_linear_foundation foundation_{};
...
static_assert(std::is_trivially_destructible_v<resident_causal_linear>);
