...
HOLONICS_CALLABLE inline bool resident_expression_geometry::resume(
  ...
  mathematical_morphology_ += accepted ? 20U : 1U; codec_morphology_ += accepted ? 9U : 2U;
  expression_geometry_morphology_ += accepted ? 37U : 1U; const std::uint64_t delta = accepted ? 38U : 4U;
