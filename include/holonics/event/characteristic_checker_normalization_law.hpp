...
#include <holonics/event/characteristic_return.hpp>

namespace holonics::event::characteristic_checker_detail {
...
HOLONICS_CALLABLE constexpr void normalize(const checker_raw_return& raw,
    const codec::characteristic_face& face, checker_typed_return& typed) noexcept {
  constexpr char declaration[] =
      "Soma.Holonics.R19.generated_diagonal_characteristic_degree";
  constexpr char source[] = "theorem generated_diagonal_characteristic_degree";
