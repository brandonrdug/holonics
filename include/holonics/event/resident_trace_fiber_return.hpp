...
HOLONICS_CALLABLE inline bool resident_trace_fiber::resume_discovery(
  ...
  m.mathematical_before =
      standing_.standing.standing.standing.mathematical_morphology;
  m.codec_before = standing_.standing.standing.standing.codec_morphology;
  standing_.standing.standing.standing.mathematical_morphology +=
      accepted ? 36U : 1U;
  standing_.standing.standing.standing.codec_morphology += accepted ? 16U : 1U;
  trace_fiber_morphology_ += accepted ? 64U : 1U;
  lift_organ_morphology_ += accepted ? 48U : 0U;
  ...
  m.mathematical_after =
      standing_.standing.standing.standing.mathematical_morphology;
  m.codec_after = standing_.standing.standing.standing.codec_morphology;
...
HOLONICS_CALLABLE inline bool resident_trace_fiber::resume_heldout(
  ...
  standing_.standing.standing.standing.mathematical_morphology +=
      accepted ? 12U : 1U;
  standing_.standing.standing.standing.codec_morphology += accepted ? 8U : 1U;
  triple_transport_morphology_ += accepted ? 24U : 1U;
