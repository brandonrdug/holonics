...
HOLONICS_CALLABLE inline bool resident_trace_fiber::resume_discovery(
  ...
  m.mathematical_before =
      standing_.standing.standing.standing.mathematical_admitted_tally;
  m.codec_before = standing_.standing.standing.standing.codec_admitted_tally;
  standing_.standing.standing.standing.mathematical_admitted_tally +=
      accepted ? 36U : 1U;
  standing_.standing.standing.standing.codec_admitted_tally += accepted ? 16U : 1U;
  trace_fiber_admitted_tally_ += accepted ? 64U : 1U;
  lift_organ_admitted_tally_ += accepted ? 48U : 0U;
  ...
  m.mathematical_after =
      standing_.standing.standing.standing.mathematical_admitted_tally;
  m.codec_after = standing_.standing.standing.standing.codec_admitted_tally;
...
HOLONICS_CALLABLE inline bool resident_trace_fiber::resume_heldout(
  ...
  standing_.standing.standing.standing.mathematical_admitted_tally +=
      accepted ? 12U : 1U;
  standing_.standing.standing.standing.codec_admitted_tally += accepted ? 8U : 1U;
  triple_transport_admitted_tally_ += accepted ? 24U : 1U;
