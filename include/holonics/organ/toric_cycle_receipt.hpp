...
struct toric_quotient_receipt final {
  exact::word identity{};
  exact::small_rational divisor_classes[toric_ray_capacity][toric_rank_capacity]{};
...
struct toric_intersection_receipt final {
  exact::word identity{};
  exact::small_rational fan_divisor_form[toric_ray_capacity][toric_ray_capacity]{};
  exact::small_rational chow_divisor_form[toric_ray_capacity][toric_ray_capacity]{};
  exact::small_rational quotient_form[toric_rank_capacity][toric_rank_capacity]{};
  exact::small_rational congruence_basis[toric_rank_capacity][toric_rank_capacity]{};
  exact::small_rational congruence_form[toric_rank_capacity][toric_rank_capacity]{};
  exact::small_rational determinant{};
  exact::small_rational basis_determinant{};
  std::uint64_t lineage{};
  std::uint8_t rank{};
...
struct toric_representative final {
  exact::small_rational coefficients[toric_ray_capacity]{};
  exact::word identity{};
  std::uint64_t lineage{};
...
struct toric_realization_receipt final {
  exact::word identity{};
  toric_target target{};
  exact::small_rational class_coordinates[toric_rank_capacity]{};
...
struct toric_polarization_receipt final {
  exact::word identity{};
  exact::small_rational anticanonical[toric_rank_capacity]{};
  exact::small_rational primitive[toric_rank_capacity]{};
  exact::small_rational response[toric_ray_capacity]{};
  exact::small_rational primitive_negative[toric_rank_capacity]{};
  exact::small_rational primitive_square{};
  std::uint64_t lineage{};
...
struct toric_transform_receipt final {
  exact::word identity{};
  exact::small_rational strict[toric_rank_capacity]{};
  exact::small_rational total[toric_rank_capacity]{};
  std::uint64_t lineage{};
  std::uint8_t old_ray{};
  std::uint8_t new_ray{};
  bool exact{};
...
struct toric_blowup_receipt final {
  ...
  exact::small_rational exceptional[toric_rank_capacity]{};
  exact::small_rational exceptional_square{};
  exact::small_rational pullback[toric_rank_capacity]{};
  exact::small_rational pushforward[toric_rank_capacity]{};
  toric_transform_receipt transforms[toric_ray_capacity]{};
  exact::small_rational pullback_matrix[toric_rank_capacity][toric_rank_capacity]{};
  exact::small_rational pushforward_matrix[toric_rank_capacity][toric_rank_capacity]{};
...
struct toric_foil_receipt final {
  ...
  exact::small_rational retained_incompatible_residual[toric_ray_capacity]{};
