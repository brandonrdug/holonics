...
2. **Combinatorial Rigidity & Phase Seam Percolation**:
   ...
   * Track phase seams where temperature or pH transitions (governed by the exact sigmoid charts in [`archive/equation-atlas/equations.jsonl`](https://github.com/brandonrdug/holonics/blob/6bcf6599abeaf601f7e31f3ddbd46292abbdb145/archive/equation-atlas/equations.jsonl#L207-L208)) alter the active constraint population $C_\eta$.
