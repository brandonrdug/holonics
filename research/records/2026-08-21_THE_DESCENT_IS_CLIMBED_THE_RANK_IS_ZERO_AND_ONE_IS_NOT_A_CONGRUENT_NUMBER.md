...
| owed | falsifier |
|---|---|
| the same discharge for the rank-one curve's torsion classification (`RankOne.TheTorsionIsTheKleinGroup`) — the descent machinery now exists; the reduction argument or a height argument is the missing piece | a torsion point off the Klein group |
