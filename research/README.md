...
plan. [`../THE_CLAIM_INDEX.md`](../THE_CLAIM_INDEX.md), generated by `tools/claim_index.py`, is the
complete current document/date census; do not infer a current record count from this thematic
snapshot. Later records may correct earlier ones; the normalized canon in `../canon/` governs the
rebuild.
