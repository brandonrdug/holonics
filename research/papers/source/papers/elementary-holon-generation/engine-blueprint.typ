...
#v(2mm)#chemistry-note([Proved-derived · formal-checked at the explicit local/source hypotheses: `Zeta/TransverseCurrentBound`, `Zeta/FiniteZeroCurrent`, `Zeta/CriticalChart`. These analytic constructions and the HNN engine develop in parallel; no Millennium endpoint is an admission condition for training.])
