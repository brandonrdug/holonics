...
`lean/HolonicsResearch/Zeta/DivisorSourceTransport.lean` (the finite proportional-transport
implication and its subset-overload converse) and `Zeta/DivisorQuotientFamily.lean` (the exact
