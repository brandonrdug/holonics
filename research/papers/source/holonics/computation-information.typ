...
#let computation-information = (
  ...
  entry(
    ...
    source: [Standard linear algebra and semigroup theory; the three-way split of parity, chronology, and reversibility is Brandon's, 2026-08-11, `docs/canon/TABLET_THE_OPERATIONS.md`.],
  ),
  entry(
    id: "H.0481",
    kind: "Definition",
