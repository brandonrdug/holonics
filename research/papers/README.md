...
- [HNN / Information Chemistry — receiver edition](rendered/hnn-information-chemistry.pdf): twenty-eight
  ...
  black phase frames. Knots, woven field ecologies, supported Möbius passages and abstract
  conformation machinery extend the current edition. Sequence-conditioned folds, biochemical
  kinetics and causal thought-chain diagrams now continue that construction.
  [Editable source](source/papers/hnn-information-chemistry/main.typ).
