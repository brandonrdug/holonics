...
`Zeta.ExplicitFormulaReceiver` leaves the archimedean term of the explicit formula as a parameter of
...
namespace Holonics.Zeta.ArchimedeanReceiver
...
end Holonics.Zeta.ArchimedeanReceiver
