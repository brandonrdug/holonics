...
open Holonics.Zeta.PairDescent
open Holonics.Zeta.ForwardPreservation
open Holonics.Zeta.HurwitzPolynomial
open Holonics.Zeta.HeatSemigroup

namespace Holonics.Zeta.DeBruijnNewmanPolynomial
...
end Holonics.Zeta.DeBruijnNewmanPolynomial
