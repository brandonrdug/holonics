...
open Holonics.Zeta.XiEdgeDecomposition
open Holonics.Zeta.PrimeSideVertical
open Holonics.Zeta.ExplicitFormulaFiniteHeight
open Holonics.Zeta.FactorizationMultiplicity
open Holonics.Zeta.EdgeIntegralVanishes

namespace Holonics.Zeta.ExplicitFormulaLimit
...
end Holonics.Zeta.ExplicitFormulaLimit
