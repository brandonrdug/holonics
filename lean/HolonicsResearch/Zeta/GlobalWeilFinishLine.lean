...
**[definition]** The fixed-disc receiver in `Zeta.WeilPositivity` and the global Weil finish line are
...
**[proved-derived; formal-checked]** The last theorem has codomain literally `Zeta.Statement`.  No
field of the finish-line certificate stores `Zeta.Statement` or an implication to it.
-/

noncomputable section

namespace Holonics.Zeta

open Filter Metric Topology
open Holonics.Zeta.ExplicitFormulaReceiver
open Holonics.Zeta.ArchimedeanReceiver
open Holonics.Zeta.WeilPositivity
...
certificate: `Zeta.WeightedArgumentPrinciple.hasWeightedArgumentPrinciple` proves it on every
...
theorem statement_of_globalWeilFinishLine (finish : GlobalWeilFinishLine) : Zeta.Statement := by
