...
**[proved-derived; formal-checked]** `Zeta.ExplicitFormulaReceiver` left the first explicit-formula
...
`Zeta.GlobalWeilFinishLine`.
-/

noncomputable section

namespace Holonics.Zeta.WeightedArgumentPrinciple
...
end Holonics.Zeta.WeightedArgumentPrinciple
