...
namespace Holonics.Zeta.RiemannXiZeroCounting
...
theorem logTwo_mul_innerRiemannXiZeroCount_le_weightedOuterCount
  ...
  have hpoint : ∀ u : ℂ,
    ...
    · have huc : u ≠ c := by
        ...
        exact hDu hzero
      rw [if_pos huinner]
      have hw := Holonics.Zeta.ZeroCounting.log_two_le_outerWeight huinner huc
      nlinarith
...
end Holonics.Zeta.RiemannXiZeroCounting
