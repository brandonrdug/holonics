...
`Zeta/FosterTanks` inductance of `ρ′ = ρ − ½` is a positive real. The lock of the helical pair and
...
namespace Holonics.Zeta.ZeroPairLock
...
theorem locked_iff_foster_inductance_positive (σ γ : ℚ) (hγ : γ ≠ 0) :
  ...
  rw [reflected_pair_locked_iff_on_seam, Holonics.Zeta.FosterTanks.inductance_pos_real_iff]
...
end Holonics.Zeta.ZeroPairLock
