...
namespace Holonics.Fluid.NavierStokesAxialPressureMode
...
theorem openPressureGradientMode_component_two_eq_neg_openActualAdvectionMode_component_two
  ...
  rw [pressureFreeMomentumMode,
    Holonics.Fluid.NavierStokesOpenAdvectionCarrierIntegration.openAdvectionMode_eq_openActualAdvectionMode]
    at hpf
...
end Holonics.Fluid.NavierStokesAxialPressureMode
