...
namespace Holonics.Fluid.NavierStokesCofinalWorkEnstrophyJoin

open Holonics.Foundation.HolonicTerminalCurrent
open Holonics.Fluid.NavierStokes
open Holonics.Fluid.NavierStokesAdaptiveMatchedCofinalDiagonal
open Holonics.Fluid.NavierStokesCofinalOutputReceiverClosure
open Holonics.Fluid.NavierStokesCofinalOutputReceiverParsevalJoin
open Holonics.Fluid.NavierStokesCompleteLinearWorkCofinalLimit
open Holonics.Fluid.NavierStokesCompleteLinearWorkCompactL1
...
open Holonics.Fluid.NavierStokesEnstrophyTerminalCurrent
...
open Holonics.Fluid.NavierStokesTranslationDissipation
...
open Holonics.Fluid.NavierStokesVorticityThreeStrands
open Holonics.Fluid.NavierStokesWeightedProductReconstruction
...
end Holonics.Fluid.NavierStokesCofinalWorkEnstrophyJoin
