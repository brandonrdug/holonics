...
import HolonicsResearch.Fluid.NavierStokesWeightedMildSpacetimeMomentum
...
namespace Holonics.Fluid.NavierStokesWeightedSmoothPathTower
...
theorem CoherentWeightedSmoothPathTower.reconstructedVelocity_eq_base
    ...
    tower.reconstructedVelocity t =
      Holonics.Fluid.NavierStokesWeightedFourierReconstruction.reconstructedVelocity
        (base t) :=
  rfl
...
end Holonics.Fluid.NavierStokesWeightedSmoothPathTower
