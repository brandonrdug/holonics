...
import HolonicsResearch.Fluid.NavierStokesWeightedSmoothClassicalMomentum
import HolonicsResearch.Fluid.NavierStokesUniformRestart
...
namespace Holonics.Fluid.NavierStokesWeightedClassicalRestartCarrier

open Holonics.Fluid.NavierStokes
open Holonics.Fluid.NavierStokesCoordinateNativeMildRestart
open Holonics.Fluid.NavierStokesFiniteTimeVorticity
...
open Holonics.Fluid.NavierStokesWeightedFourierDivergenceReconstruction
open Holonics.Fluid.NavierStokesWeightedFourierReconstruction
open Holonics.Fluid.NavierStokesWeightedMildPhysicalSource
...
open Holonics.Fluid.NavierStokesWeightedReconstructionContinuity
open Holonics.Fluid.NavierStokesWeightedRestartAperture
open Holonics.Fluid.NavierStokesWeightedSmoothClassicalMomentum
...
theorem CoherentWeightedSmoothPathTower.fixedPoint_hasDerivAt_realClassicalMomentum_component
  ...
  have hcomplex :=
    Holonics.Fluid.NavierStokesWeightedSmoothClassicalMomentum.CoherentWeightedSmoothPathTower.fixedPoint_hasDerivAt_classicalMomentum_advection
...
structure JointSpacetimeSmoothnessUpgrade
  ...
  velocitySmooth :
    ContDiffOn ℝ ((↑(⊤ : ℕ∞)) : WithTop ℕ∞) (Function.uncurry velocity)
      (Holonics.Fluid.NavierStokesOpenLifespan.openSpaceTimeSlab T)
  pressureSmooth :
...
end Holonics.Fluid.NavierStokesWeightedClassicalRestartCarrier
