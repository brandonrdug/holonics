...
namespace Holonics.Fluid.NavierStokesWeightedDivergenceFree
...
theorem weightedLerayDivergenceConvolution_divergenceFree_native
  ...
  let mode : Fin 3 → ℂ := fun component ↦
    (Holonics.Fluid.NavierStokesH3DivergenceBilinear.h3DivergenceConvolution
...
end Holonics.Fluid.NavierStokesWeightedDivergenceFree
