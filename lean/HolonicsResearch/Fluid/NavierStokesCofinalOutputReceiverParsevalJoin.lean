...
namespace Holonics.Fluid.NavierStokesCofinalOutputReceiverParsevalJoin
...
open Holonics.Fluid.NavierStokesFiniteLinearRadiusTailPassage
open Holonics.Fluid.NavierStokesFiniteLinearWorkDecomposition
open Holonics.Fluid.NavierStokesFiniteLinearWorkPhysicalJoin
...
open Holonics.Fluid.NavierStokesSmoothDyadicLinearPhaseBand
  ...
  have hvolume :
      @volume SpatialTorus
          (@MeasureSpace.pi (Fin 3) (Fin.fintype 3) (fun _ ↦ UnitAddCircle)
            (fun _ ↦
              Holonics.Fluid.NavierStokesCofinalOutputReceiverParsevalJoin.instMeasureSpaceUnitAddCircle_holonicsResearch)) =
        @volume SpatialTorus
          (@MeasureSpace.pi (Fin 3) (Fin.fintype 3) (fun _ ↦ UnitAddCircle)
...
end Holonics.Fluid.NavierStokesCofinalOutputReceiverParsevalJoin
