...
namespace Holonics.Fluid.NavierStokesWeightedJointSmoothnessBootstrap
...
theorem CoherentWeightedSmoothPathTower.weightedSobolevCoefficients_nativeProjectedTimeDerivative
  ...
  have hsymbol :
    ...
    have h :=
      Holonics.Fluid.NavierStokesWeightedSmoothClassicalMomentum.sum_orderedDerivativeMultiplier_diagonalSecondWord k
    change
      (∑ coordinate : Fin 3,
        orderedDerivativeMultiplier 2 (fun _ : Fin 2 ↦ coordinate) k) =
...
end Holonics.Fluid.NavierStokesWeightedJointSmoothnessBootstrap
