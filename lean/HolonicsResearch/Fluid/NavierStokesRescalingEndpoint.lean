...
namespace Holonics.Fluid.NavierStokesRescalingEndpoint
...
open Holonics.Fluid.NavierStokesRescalingSpace
...
theorem OpenPeriodicSolutionOn.isMaximal_of_rescaled_value
  ...
  have hcontinuous : ContinuousAt (Function.uncurry extension.extendedVelocity) (xstar, T) :=
    (Holonics.Fluid.NavierStokesDynamicRescaling.OpenSmoothSolutionOn.joint_contDiffAt
...
theorem OpenPeriodicSolutionOn.isMaximal_of_rescaled_spatialDerivative
  ...
  have hlower' : ∀ᶠ s in atTop,
    ...
    have hjoint :=
      Holonics.Fluid.NavierStokesDynamicRescaling.OpenSmoothSolutionOn.joint_differentiableAt
...
end Holonics.Fluid.NavierStokesRescalingEndpoint
