...
namespace Holonics.Fluid.NavierStokesAnisotropicDynamics
...
open Holonics.Fluid.NavierStokesAnisotropicFrame
open Holonics.Fluid.NavierStokesLinearFrameSpace
open Holonics.Fluid.NavierStokesLinearFrameDynamics
open Holonics.Fluid.NavierStokesLinearFrameEnergy
...
theorem OpenSmoothSolutionOn.anisotropic_momentum
  ...
  dsimp only
  have h := Holonics.Fluid.NavierStokesLinearFrameDynamics.OpenSmoothSolutionOn.linearFrame_momentum
...
theorem OpenPeriodicSolutionOn.anisotropic_energy_hasDerivAt
  ...
  apply Holonics.Fluid.NavierStokesLinearFrameEnergy.OpenPeriodicSolutionOn.frame_energy_hasDerivAt
...
end Holonics.Fluid.NavierStokesAnisotropicDynamics
