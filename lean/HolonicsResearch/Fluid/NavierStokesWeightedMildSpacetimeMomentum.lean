...
import HolonicsResearch.Fluid.NavierStokesWeightedPressureReconstruction
import HolonicsResearch.Fluid.NavierStokesWeightedSpacetimeReconstruction
...
namespace Holonics.Fluid.NavierStokesWeightedMildSpacetimeMomentum
...
open Holonics.Fluid.NavierStokesH3LerayBilinearNorm
...
open Holonics.Fluid.NavierStokesWeightedMildInvariantRestart
...
open Holonics.Fluid.NavierStokesWeightedSpacetimeReconstruction
...
theorem continuous_joint_weightedReconstructedVelocity
  ...
  have hjoint :=
    Holonics.Fluid.NavierStokesWeightedSpacetimeReconstruction.continuous_joint_reconstructedVelocity
      path
...
end Holonics.Fluid.NavierStokesWeightedMildSpacetimeMomentum
