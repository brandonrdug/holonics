...
namespace Holonics.Fluid.NavierStokesMovingLoop
...
open Holonics.Fluid.NavierStokesMaterialDerivative
...
theorem movingCirculation_eq_curveIntegral {velocity : VelocityField}
    ...
    movingCirculation velocity loop t =
      ∫ᶜ x in loop.pathAt t ht,
        Holonics.Fluid.NavierStokesKelvin.velocityOneForm velocity t x := by
...
end Holonics.Fluid.NavierStokesMovingLoop
