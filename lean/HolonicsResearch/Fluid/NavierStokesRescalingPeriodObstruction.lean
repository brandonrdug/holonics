...
namespace Holonics.Fluid.NavierStokesRescalingPeriodObstruction
...
theorem OpenPeriodicSolutionOn.stationaryProfile_constant_of_period_range
  ...
  have h :=
    Holonics.Fluid.NavierStokesDynamicRescaling.OpenPeriodicSolutionOn.rescaled_velocity_period
...
end Holonics.Fluid.NavierStokesRescalingPeriodObstruction
