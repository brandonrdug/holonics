...
namespace Holonics.Fluid.NavierStokesSmoothSliceWeightedH3
      ...
      have hvolume :
          @volume SpatialTorus
              (@MeasureSpace.pi (Fin 3) (Fin.fintype 3) (fun _ ↦ UnitAddCircle)
                (fun _ ↦ instMeasureSpaceUnitAddCircle_holonicsResearch)) =
            @volume SpatialTorus
              (@MeasureSpace.pi (Fin 3) (Fin.fintype 3) (fun _ ↦ UnitAddCircle)
...
end Holonics.Fluid.NavierStokesSmoothSliceWeightedH3
