...
namespace Holonics.Fluid.NavierStokesCoordinateH3MiddleRedistribution
...
open Holonics.Fluid.NavierStokesPeriodicCubeInterpolation
...
theorem openPeriodicSolutionOn_coordinateJetSlice_contDiff
  ...
  intro x
  have hdomain :
      Holonics.Fluid.NavierStokesFiniteTimeVorticity.openSpaceTimeSlab T ∈
        nhds (x, t) :=
...
end Holonics.Fluid.NavierStokesCoordinateH3MiddleRedistribution
