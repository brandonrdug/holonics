...
namespace Holonics.Fluid.NavierStokesAdaptiveNonlinearTriangleService

open Holonics.Fluid.NavierStokes
open Holonics.Fluid.NavierStokesAdaptiveClockMatchedPacking
open Holonics.Fluid.NavierStokesAdaptiveOffDiagonalMildHeatTransport
...
end Holonics.Fluid.NavierStokesAdaptiveNonlinearTriangleService
