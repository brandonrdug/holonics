...
namespace Holonics.Fluid.NavierStokesFirstRadialLift
...
theorem linearProfile_jets (f g : ℝ → ℝ) (p : ℝ × ℝ) (f' g' : ℝ)
  ...
  have ja := Holonics.Fluid.NavierStokesAxialLift.axialOnly_jet f p f' hf
...
end Holonics.Fluid.NavierStokesFirstRadialLift
