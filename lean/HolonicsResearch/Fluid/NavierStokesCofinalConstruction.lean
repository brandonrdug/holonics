import HolonicsResearch.Fluid.NavierStokesPressureNormalization
...
namespace Holonics.Fluid.NavierStokesCofinalConstruction
...
open Holonics.Fluid.NavierStokesPressureNormalization
...
def normalizedPeriodicStateOfSolution
  ...
  solution :=
    Holonics.Fluid.NavierStokesPressureNormalization.OpenPeriodicSolutionOn.normalizePressure
      solution
  pressureNormalized :=
    Holonics.Fluid.NavierStokesPressureNormalization.OpenPeriodicSolutionOn.normalizePressure_pressureNormalized
      solution
...
theorem normalizedPeriodicState_pressure_eq
  ...
  have hagree := uniqueness.unique hnu leftOn rightOn
  have hleftSmooth :=
    Holonics.Fluid.NavierStokesOverlapUniqueness.OpenPeriodicSolutionOn.pressureSpatialSmooth
...
end Holonics.Fluid.NavierStokesCofinalConstruction
