...
namespace Holonics.Fluid.NavierStokesInitialSpatialContinuity
...
def initialActualAdvectionMode
    ...
    (hperiodic : ∀ t ∈ openTimeSlab T, IsOnePeriodic (fun x ↦ velocity x t))
    (t : openTimeSlab T)
    (k : Holonics.Fluid.NavierStokesTorusFourier.SpatialFrequency) :
      Holonics.Fluid.NavierStokesTorusFourier.ComplexVector :=
...
end Holonics.Fluid.NavierStokesInitialSpatialContinuity
