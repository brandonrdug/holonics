...
namespace Holonics.Fluid.NavierStokesParabolicRebase
...
theorem SmoothSolution.parabolicVelocity_momentum_nonnegativeTime
  ...
  have hsmooth : ContDiff ℝ 2 (fun y ↦ velocity y (scale ^ 2 * t)) :=
    (Holonics.Fluid.NavierStokesParabolicRebase.SmoothSolution.velocitySlice_contDiff_nonnegativeTime
...
def SmoothSolution.parabolic
  ...
  momentum :=
    Holonics.Fluid.NavierStokesParabolicRebase.SmoothSolution.parabolicVelocity_momentum_nonnegativeTime
      solution scale hscale
  incompressible :=
    Holonics.Fluid.NavierStokesParabolicRebase.SmoothSolution.parabolicVelocity_incompressible
      solution scale
  initial := by
    intro x
    simp [parabolicVelocity, parabolicInitialVelocity, solution.initial]
  velocitySmooth :=
    Holonics.Fluid.NavierStokesParabolicRebase.SmoothSolution.parabolicVelocity_smooth
      solution scale
  pressureSmooth :=
    Holonics.Fluid.NavierStokesParabolicRebase.SmoothSolution.parabolicPressure_smooth
      solution scale
...
def PeriodicSolution.parabolicNat
  ...
  toSmoothSolution :=
    Holonics.Fluid.NavierStokesParabolicRebase.SmoothSolution.parabolic
...
end Holonics.Fluid.NavierStokesParabolicRebase
