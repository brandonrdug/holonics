...
namespace Holonics.Fluid.NavierStokesPhysicalH2VelocityCubeExhaustion
...
theorem tendsto_half_re_finiteOpenPhysicalH2VelocityExchangedTriadCurrent_to_physicalH2Current
    ...
    Tendsto
      ...
      atTop
      (nhds
        (Holonics.Fluid.NavierStokesPhysicalH2CurrentTriadJoin.completePhysicalH2Current
          solution t)) := by
...
end Holonics.Fluid.NavierStokesPhysicalH2VelocityCubeExhaustion
