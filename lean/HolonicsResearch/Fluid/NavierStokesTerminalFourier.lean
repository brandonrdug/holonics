import HolonicsResearch.Fluid.NavierStokesTerminalTrace
...
namespace Holonics.Fluid.NavierStokesTerminalFourier

open Holonics.Fluid.NavierStokes
open Holonics.Fluid.NavierStokesOpenLifespan
open Holonics.Fluid.NavierStokesTerminalTrace
...
theorem TerminalTorusVelocityTrace.complexDot_terminalFourierCoeff_eq_zero
  ...
  have hmode :=
    Holonics.Fluid.NavierStokesTerminalFourier.TerminalTorusVelocityTrace.tendsto_continuousTorusVectorFourierCoeff
      terminal k
  change Tendsto
    (fun s : ClosedTailPreterminalTimes a T =>
      continuousTorusVectorFourierCoeff
...
end Holonics.Fluid.NavierStokesTerminalFourier
