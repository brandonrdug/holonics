import HolonicsResearch.Fluid.NavierStokesMovingSwirlCirculation
import HolonicsResearch.Fluid.NavierStokesSwirlDiffusion
...
namespace Holonics.Fluid.NavierStokesViscousSwirlBalance
...
open Holonics.Fluid.NavierStokesMovingSwirlCirculation
open Holonics.Fluid.NavierStokesSwirlDiffusion
open Holonics.Fluid.NavierStokesOpenLifespan
open Holonics.Fluid.NavierStokesDynamicRescaling
...
theorem centredMomentumResidual_of_physical_solution
  ...
  have h := Holonics.Fluid.NavierStokesDynamicRescaling.OpenSmoothSolutionOn.rescaled_momentum
...
theorem rescaled_angularMomentum_reconstruct (length normalizer clock : ℝ → ℝ)
    ...
    cartesianAngularMomentum (length t • y) (velocity (length t • y) (clock t)) =
      (length t / normalizer t) * cartesianAngularMomentum y
        (Holonics.Fluid.NavierStokesDynamicRescaling.rescaledVelocity
...
end Holonics.Fluid.NavierStokesViscousSwirlBalance
