...
namespace Holonics.Fluid.NavierStokesClockWeightedSpatialBandPacking

open Holonics.Fluid.NavierStokes
open Holonics.Fluid.NavierStokesSmoothDyadicBandEnergyEvolution
...
open Holonics.Fluid.NavierStokesSmoothDyadicScaleTimeLedger
open Holonics.Fluid.NavierStokesTerminalSmoothDyadicVorticityPacking
open Holonics.Fluid.NavierStokesVorticityBandBernsteinAlternative
open Holonics.Fluid.NavierStokesOpenLifespan
open Holonics.Fluid.NavierStokesProjectedDyadicShellEvolution
open Holonics.Fluid.NavierStokesPhaseLocalDyadicTerminalBridge
open Holonics.Fluid.NavierStokesSmoothDyadicBandIntegratedBalance
open Holonics.Fluid.NavierStokesOpenFourierMildIdentity
open Holonics.Fluid.NavierStokesSmoothDyadicLinearScaleBoundary
...
theorem criticalVorticityRate_le_clockWeightedPrefix_add_reconstructionFiber
    ...
    (solution : OpenPeriodicSolutionOn T nu initial (0 : VelocityField) velocity pressure)
    (t : Set.Ioo 0 T) (depth : ℕ) :
    Holonics.Fluid.NavierStokesCriticalVorticityRate.criticalVorticityRate
        solution t.1 ≤
      Real.sqrt 3 *
...
end Holonics.Fluid.NavierStokesClockWeightedSpatialBandPacking
