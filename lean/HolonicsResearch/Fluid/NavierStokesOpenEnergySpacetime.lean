...
import HolonicsResearch.Fluid.NavierStokesTerminalShellControl
...
namespace Holonics.Fluid.NavierStokesOpenEnergySpacetime
...
open Holonics.Fluid.NavierStokesTerminalShellControl
...
theorem openPeriodicSolutionOn_periodicKineticEnergy_continuousOn_initial
  ...
  have hswapMem : ∀ z, swap z ∈
      Holonics.Fluid.NavierStokesOpenLifespan.openSpaceTimeSlab T := by
    rintro ⟨t, x⟩
...
end Holonics.Fluid.NavierStokesOpenEnergySpacetime
