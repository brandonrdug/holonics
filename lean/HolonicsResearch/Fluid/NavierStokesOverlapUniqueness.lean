...
namespace Holonics.Fluid.NavierStokesOverlapUniqueness

open Holonics.Fluid.NavierStokes
open Holonics.Fluid.NavierStokesFiniteTime
...
theorem periodicSolutionOn_integral_differenceTimeWork_eq
  ...
  have hdiffSmooth : ContDiffOn ℝ ∞
      ...
      (Holonics.Fluid.NavierStokesFiniteTimeVorticity.openSpaceTimeSlab T) := by
...
end Holonics.Fluid.NavierStokesOverlapUniqueness
