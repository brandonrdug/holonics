...
namespace Holonics.Fluid.NavierStokesVorticityStrainDifference

open Holonics.Fluid.NavierStokes
open Holonics.Fluid.NavierStokesHodge
...
end Holonics.Fluid.NavierStokesVorticityStrainDifference
