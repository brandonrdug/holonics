...
namespace Holonics.Fluid.NavierStokesHodge
...
theorem smoothSolution_pressureExactOneForm_closed
  ...
  apply Holonics.Fluid.NavierStokesHodge.pressureExactOneForm_closed
...
theorem smoothSolution_pressureExactOneForm_eq_loweredGradient
  ...
  apply Holonics.Fluid.NavierStokesHodge.pressureExactOneForm_eq_loweredGradient
  exact (spatialSlice_contDiffAt_of_contDiffOn_nonnegativeTime pressure x t
...
end Holonics.Fluid.NavierStokesHodge
