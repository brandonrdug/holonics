...
namespace Holonics.Fluid.NavierStokesAnisotropicViscousClock
...
open Holonics.Fluid.NavierStokesAnisotropicDynamics
...
theorem OpenSmoothSolutionOn.radial_clock_momentum
  ...
  have h := Holonics.Fluid.NavierStokesAnisotropicDynamics.OpenSmoothSolutionOn.anisotropic_momentum
  ...
  have hp : DifferentiableAt ℝ (fun x ↦ pressure x (clock t))
    ...
    (Holonics.Fluid.NavierStokesLinearFrameDynamics.OpenSmoothSolutionOn.pressureSlice_contDiff
...
end Holonics.Fluid.NavierStokesAnisotropicViscousClock
