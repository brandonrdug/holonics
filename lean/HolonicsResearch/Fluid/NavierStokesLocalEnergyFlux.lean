...
namespace Holonics.Fluid.NavierStokesLocalEnergyFlux
...
theorem OpenSmoothSolutionOn.rescaled_localEnergyBalance
  ...
  have hjet := Holonics.Fluid.NavierStokesDynamicRescaling.hasDerivAt_rescaledVelocity
...
end Holonics.Fluid.NavierStokesLocalEnergyFlux
