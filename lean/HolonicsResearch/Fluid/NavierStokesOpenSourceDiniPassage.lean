...
namespace Holonics.Fluid.NavierStokesOpenSourceDiniPassage

open Holonics.Fluid.NavierStokes
open Holonics.Fluid.NavierStokesCriticalSourceTimeJet
open Holonics.Fluid.NavierStokesCriticalTimeReflection
...
end Holonics.Fluid.NavierStokesOpenSourceDiniPassage
