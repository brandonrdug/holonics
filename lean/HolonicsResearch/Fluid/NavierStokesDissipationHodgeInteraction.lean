import HolonicsResearch.Fluid.NavierStokesPhysicalTranslationDissipation
import HolonicsResearch.Fluid.NavierStokesVorticityDirectionEnstrophyClosure
...
namespace Holonics.Fluid.NavierStokesDissipationHodgeInteraction
...
theorem periodicVorticityDissipation_nonneg_of_openPeriodicSolution
  ...
  have hsum : 0 ≤ ∑ component : Fin 3,
    ...
    exact Finset.sum_nonneg fun component _ ↦ tsum_nonneg fun k ↦
      mul_nonneg
        (Holonics.Fluid.NavierStokesFiniteFourierHeat.torusStokesEigenvalue_nonneg k)
        (sq_nonneg _)
...
end Holonics.Fluid.NavierStokesDissipationHodgeInteraction
