import HolonicsResearch.Fluid.NavierStokesCofinalConstruction
import HolonicsResearch.Fluid.NavierStokesDyadicHodgeCompletedKernelPassage
import HolonicsResearch.Fluid.NavierStokesOfficialAnalyticDischarges
...
namespace Holonics.Fluid.NavierStokesCriticalOfficialPassage

open Holonics.Fluid.NavierStokes
open Holonics.Fluid.NavierStokesCofinalConstruction
open Holonics.Fluid.NavierStokesCriticalVorticityRate
open Holonics.Fluid.NavierStokesDyadicHodgeCompletedKernelPassage
open Holonics.Fluid.NavierStokesOfficialAnalyticDischarges
open Holonics.Fluid.NavierStokesOfficialBridge
...
theorem initialVelocityConditionPeriodic_of_openPeriodicSolution
  ...
  · rw [← hsection]
    exact
      Holonics.Fluid.NavierStokesOverlapUniqueness.OpenPeriodicSolutionOn.velocitySpatialSmooth
        solution hzero
  · rw [← hsection]
...
end Holonics.Fluid.NavierStokesCriticalOfficialPassage
