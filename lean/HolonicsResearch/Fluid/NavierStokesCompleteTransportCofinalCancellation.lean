...
namespace Holonics.Fluid.NavierStokesCompleteTransportCofinalCancellation
...
def openVorticityH3State
    ...
    (solution :
      OpenPeriodicSolutionOn T nu initial (0 : VelocityField) velocity pressure)
    (t : Set.Ioo 0 T) :
      Holonics.Fluid.NavierStokesInfiniteFourierHeatRestart.PeriodicVectorSobolevThree :=
...
end Holonics.Fluid.NavierStokesCompleteTransportCofinalCancellation
