...
namespace Holonics.Fluid.NavierStokesTerminalDyadicShellPacking
...
theorem continuous_openPeriodicVorticityDyadicShellSpatialSup
  ...
  exact continuous_norm.comp
    (continuous_openPeriodicVorticityBandProjector solution
      (Holonics.Fluid.NavierStokesDyadicShellProjectors.dyadicFrequencyShell level))
...
theorem criticalVorticityTerminalControl_of_terminalDyadicShellPacking
    ...
    Holonics.Fluid.NavierStokesCriticalOfficialPassage.CriticalVorticityTerminalControl := by
...
end Holonics.Fluid.NavierStokesTerminalDyadicShellPacking
