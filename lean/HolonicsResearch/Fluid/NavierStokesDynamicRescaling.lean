...
namespace Holonics.Fluid.NavierStokesDynamicRescaling
...
theorem OpenSmoothSolutionOn.hasDerivAt_rescaledVelocity
  ...
  have h := Holonics.Fluid.NavierStokesDynamicRescaling.hasDerivAt_rescaledVelocity
...
end Holonics.Fluid.NavierStokesDynamicRescaling
