...
namespace Holonics.Fluid.NavierStokesParabolicCriticalCurrent
...
open Holonics.Fluid.NavierStokesParabolicRebase
open Holonics.Fluid.NavierStokesParabolicVorticityCurrent
...
def sourceOpenAtParabolicCover
  ...
  Holonics.Fluid.NavierStokesOpenLifespan.PeriodicSolution.toOpenPeriodicSolutionOn
...
def returnedOpenAtParabolicCover
  ...
  Holonics.Fluid.NavierStokesOpenLifespan.PeriodicSolution.toOpenPeriodicSolutionOn
    (Holonics.Fluid.NavierStokesParabolicRebase.PeriodicSolution.parabolicNat
...
end Holonics.Fluid.NavierStokesParabolicCriticalCurrent
