...
namespace Holonics.Millennium.NavierStokesDirectionBalancedScale
...
open Holonics.Millennium.NavierStokesVorticityDirectionKernelMoment
open Holonics.Millennium.NavierStokesVorticityDirectionKernelMomentDecay
open Holonics.Millennium.NavierStokesHighVorticityDirection
open Holonics.Millennium.NavierStokesDirectionThresholdBalance
...
private theorem kernel_threshold_circle_volume_eq :
    @volume UnitAddCircle
        Holonics.Millennium.NavierStokesVorticityDirectionKernelMoment.instMeasureSpaceUnitAddCircle_holonics =
      @volume UnitAddCircle
        Holonics.Millennium.NavierStokesDirectionThresholdBalance.instMeasureSpaceUnitAddCircle_holonicsResearch := by
  rfl
...
end Holonics.Millennium.NavierStokesDirectionBalancedScale
