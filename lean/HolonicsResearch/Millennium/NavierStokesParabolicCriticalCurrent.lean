...
namespace Holonics.Millennium.NavierStokesParabolicCriticalCurrent
...
open Holonics.Millennium.NavierStokesParabolicRebase
open Holonics.Millennium.NavierStokesParabolicVorticityCurrent
...
def sourceOpenAtParabolicCover
  ...
  Holonics.Millennium.NavierStokesOpenLifespan.PeriodicSolution.toOpenPeriodicSolutionOn
...
def returnedOpenAtParabolicCover
  ...
  Holonics.Millennium.NavierStokesOpenLifespan.PeriodicSolution.toOpenPeriodicSolutionOn
    (Holonics.Millennium.NavierStokesParabolicRebase.PeriodicSolution.parabolicNat
...
end Holonics.Millennium.NavierStokesParabolicCriticalCurrent
