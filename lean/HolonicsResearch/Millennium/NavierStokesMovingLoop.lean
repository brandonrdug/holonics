...
namespace Holonics.Millennium.NavierStokesMovingLoop
...
open Holonics.Millennium.NavierStokesMaterialDerivative
...
theorem movingCirculation_eq_curveIntegral {velocity : VelocityField}
    ...
    movingCirculation velocity loop t =
      ∫ᶜ x in loop.pathAt t ht,
        Holonics.Millennium.NavierStokesKelvin.velocityOneForm velocity t x := by
...
end Holonics.Millennium.NavierStokesMovingLoop
