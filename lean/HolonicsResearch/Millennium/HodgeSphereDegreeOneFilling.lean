...
namespace Holonics.Millennium.HodgeSphereDegreeOneFilling

set_option backward.isDefEq.respectTransparency.types false

open CategoryTheory
open Holonics.Millennium.HodgeProjectiveLineSingularReduction
open Holonics.Millennium.HodgeTwoSphereFundamentalCycle
open Holonics.Millennium.HodgeBarycentricEdgeSubdivision
open Holonics.Millennium.HodgeBarycentricSubdivisionHomotopy
open Holonics.Millennium.HodgeRefinementWords
open Holonics.Millennium.HodgeBarycentricChainSupport
open Holonics.Millennium.HodgeFiniteClosedStarLabeling
open Holonics.Millennium.HodgePointCarry
open Holonics.Millennium.HodgeTetrahedralChainComplex
open Holonics.Millennium.HodgeTetrahedralSphereComplex
open Holonics.Millennium.HodgeTetrahedralRealizationChainMap
open Holonics.Millennium.HodgeRadialCurrent
open Holonics.Millennium.HodgeTriangleHomotopyPrism
open Holonics.Millennium.HodgeCommonStarAffineCarrier
open Holonics.Millennium.HodgeRefinedEdgeClosedStar
open Holonics.Millennium.HodgeRefinedEdgeAffineCarrier
...
theorem sum_refinedEdgeCoefficient_simplexGenerator
  ...
  calc
    ...
    _ = iteratedBarycentricEdgeSubdivision scale
      ...
      | empty =>
          exact Holonics.Millennium.HodgeIteratedBarycentricHomology.iteratedBarycentricEdgeSubdivision_zero scale
...
end Holonics.Millennium.HodgeSphereDegreeOneFilling
