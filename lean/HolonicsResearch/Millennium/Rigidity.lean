...
namespace Holonics.Millennium.Rigidity
...
/-! ## Shared-junction receiver law

The generic joint-kernel identity and separating continuation now belong to
`Foundation/Receiver`; this owner retains the concrete stress and flex witnesses. -/

end Holonics.Millennium.Rigidity
