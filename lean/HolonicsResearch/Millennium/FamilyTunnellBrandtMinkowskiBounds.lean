...
namespace Holonics.Millennium.FamilyTunnellBrandtMinkowskiBounds
...
theorem brandtFirst_minkowski_level_one_classification
    ...
    brandtFirstQuadratic m = 1 ↔
      m = (0, 1, 0) ∨ m = (0, -1, 0) := by
  exact Holonics.Millennium.FamilyTunnellNormOneReturn.brandtFirstQuadratic_eq_one_iff m
...
end Holonics.Millennium.FamilyTunnellBrandtMinkowskiBounds
