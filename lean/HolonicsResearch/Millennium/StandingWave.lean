...
namespace Holonics.Millennium.StandingWave
...
theorem theEscapingSideHasNoNodes {k t : ℝ} (hk : 0 < k) (ht : 0 < t) :
    Real.sinh (k * t) ≠ 0 :=
  ne_of_gt (Holonics.Millennium.Deviation.theNegativeCaseHasNoFocus hk ht)
...
theorem theNodeExistsOnlyOnTheClosingSide {k : ℝ} (hk : 0 < k) :
  ...
  ⟨Holonics.Millennium.Deviation.thePositiveCaseHasAFocus (ne_of_gt hk),
...
end Holonics.Millennium.StandingWave
