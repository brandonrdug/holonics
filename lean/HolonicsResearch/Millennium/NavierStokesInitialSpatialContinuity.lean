...
namespace Holonics.Millennium.NavierStokesInitialSpatialContinuity
...
def initialActualAdvectionMode
    ...
    (hperiodic : ∀ t ∈ openTimeSlab T, IsOnePeriodic (fun x ↦ velocity x t))
    (t : openTimeSlab T)
    (k : Holonics.Millennium.NavierStokesTorusFourier.SpatialFrequency) :
      Holonics.Millennium.NavierStokesTorusFourier.ComplexVector :=
...
end Holonics.Millennium.NavierStokesInitialSpatialContinuity
