...
namespace Holonics.Millennium.FamilyTunnellJacobiFiniteEulerConnection
...
theorem hasEulerConnection_finiteEulerFactor {d : ℕ} (hd : d ≠ 0) :
    Holonics.Millennium.FamilyTunnellJacobiFourSquareEulerReturn.HasEulerConnection
      (finiteEulerFactorConnection d)
      (finiteEulerFactor d) := by
  rw [Holonics.Millennium.FamilyTunnellJacobiFourSquareEulerReturn.HasEulerConnection,
...
end Holonics.Millennium.FamilyTunnellJacobiFiniteEulerConnection
