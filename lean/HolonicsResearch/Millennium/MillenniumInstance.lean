...
namespace Holonics.Millennium.MillenniumInstance
...
theorem theCompleteMillenniumStatementAtOneReducesToTheLedger :
  ...
  exact ⟨theMillenniumRankClauseIsProvedAtOne, hrank,
    Holonics.Millennium.UniversalBSDLedger.theRankZeroForcesAllTorsion _ hrank.2,
    HeckeWitness.theLFunctionDoesNotVanishAtOne⟩

end Holonics.Millennium.MillenniumInstance
