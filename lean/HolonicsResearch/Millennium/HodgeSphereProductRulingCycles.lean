...
namespace Holonics.Millennium.HodgeSphereProductRulingCycles
...
abbrev Sphere :=
  Holonics.Millennium.HodgeTwoSphereFundamentalCycle.TwoSphere
...
end Holonics.Millennium.HodgeSphereProductRulingCycles
