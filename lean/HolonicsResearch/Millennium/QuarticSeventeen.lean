...
namespace Holonics.Millennium.QuarticSeventeen
...
theorem theBranchCrossesIntoTheTerminatingRing :
  ...
  ⟨(Holonics.Millennium.EuclideanSqrtTwo.theSignDecidesTheOrbitSize).1,
...
end Holonics.Millennium.QuarticSeventeen
