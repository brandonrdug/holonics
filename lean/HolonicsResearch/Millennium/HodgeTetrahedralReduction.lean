...
namespace Holonics.Millennium.HodgeTetrahedralReduction

open CategoryTheory
open Holonics.Millennium.HodgeTwoSphereFundamentalCycle
open Holonics.Millennium.HodgeSphereFundamentalDetector
...
end Holonics.Millennium.HodgeTetrahedralReduction
