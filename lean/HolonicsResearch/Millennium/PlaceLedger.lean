...
that scope only:
`grep -rlin "arakelov" formal/ crates/ research/papers/ blueprint/ docs/canon/`, excluding this file → 0
files;
...
namespace Holonics.Millennium.PlaceLedger
...
end Holonics.Millennium.PlaceLedger
