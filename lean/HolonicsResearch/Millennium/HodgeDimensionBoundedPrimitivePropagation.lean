...
namespace Holonics.Millennium.HodgeDimensionBoundedPrimitivePropagation

open Holonics.Millennium.HodgeConjecture
open Holonics.Millennium.HodgeConstructivePassage
open Holonics.Millennium.HodgeSmoothProjectiveReceiver
open Holonics.Millennium.HodgeHolonicPrimitiveCut
open Holonics.Millennium.HodgeMonodromyPrimitivePropagation
open Holonics.Millennium.HodgeDimensionBoundedLefschetz
open Holonics.Millennium.HodgeDimensionBoundedLefschetz.DimensionBoundedLefschetzSystem
...
end Holonics.Millennium.HodgeDimensionBoundedPrimitivePropagation
