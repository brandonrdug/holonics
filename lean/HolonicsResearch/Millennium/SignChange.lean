...
joined to the rational charts of `HolonicsResearch.Millennium.Sturm` through their real
...
`Holonics.Millennium.Sturm.TheReadingEqualsThePopulation`, which remains named open in the file
...
namespace Holonics.Millennium.SignChange
...
end Holonics.Millennium.SignChange
