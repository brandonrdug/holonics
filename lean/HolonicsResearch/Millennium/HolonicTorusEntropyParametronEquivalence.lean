...
namespace Holonics.Millennium.HolonicTorusEntropyParametronEquivalence
...
theorem entropyAxisCrossCurrent_realizedWindingCurrent
    ...
    (plane :
      Holonics.Millennium.HolonicRankFourInteractionPlanes.InteractionPlane) :
...
end Holonics.Millennium.HolonicTorusEntropyParametronEquivalence
