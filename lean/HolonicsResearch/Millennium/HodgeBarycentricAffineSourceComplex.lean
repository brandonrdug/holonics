...
namespace Holonics.Millennium.HodgeBarycentricAffineSourceComplex
...
open Holonics.Millennium.HodgeStellarSubdivisionHomotopy
...
open Holonics.Millennium.HodgeBarycentricDegreeTwoFilling
...
theorem barycentricDegreeTwoHomotopyMorphism_comp_boundary :
  ...
  change (barycentricDegreeTwoHomotopyMorphism ≫ SphereSingularChainComplex.d 3 2)
    ...
    barycentricTriangleHomotopyDefectMorphism
      ((Limits.Sigma.ι
        (fun _ : SphereSingularSimplex 2 => rationalCoefficient) simplex) coefficient)
  rw [Holonics.Millennium.HodgeTetrahedralCarrierAssembly.sigmaInjection_eq_smul_simplexGenerator]
...
end Holonics.Millennium.HodgeBarycentricAffineSourceComplex
