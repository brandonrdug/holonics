...
namespace Holonics.Millennium.HodgeProductMixedFilling

open Simplicial
open Holonics.DiagonalChainTransport
open Holonics.Millennium.HodgeProjectiveLineProduct
open Holonics.Millennium.HodgeProjectiveLineSingularReduction
open Holonics.Millennium.HodgeSphereChainCurrent
open Holonics.Millennium.HodgeSphereProductRulingCycles
open Holonics.Millennium.HodgeSphereLowDegreeHomology
...
theorem spherePairDiagonalH0_boundary
    ...
    diagonalBoundaryOne SphereSSet SphereSSet
        (Holonics.DiagonalChainTransport.productH0Diagonal
          sphereLowDegreeCurrentDatum sphereLowDegreeCurrentDatum current) =
      current -
        Holonics.DiagonalChainTransport.productAugmentation
            sphereLowDegreeCurrentDatum sphereLowDegreeCurrentDatum current •
          generator
            (sphereLowDegreeCurrentDatum.basepoint,
              sphereLowDegreeCurrentDatum.basepoint) := by
  exact Holonics.DiagonalChainTransport.diagonalBoundaryOne_productH0Diagonal
    sphereLowDegreeCurrentDatum sphereLowDegreeCurrentDatum current
...
theorem spherePairDiagonalH1_boundary
    ...
    diagonalBoundaryTwo SphereSSet SphereSSet
        (Holonics.DiagonalChainTransport.productH1Diagonal
          sphereLowDegreeCurrentDatum sphereLowDegreeCurrentDatum current) = current := by
  exact
    Holonics.DiagonalChainTransport.diagonalBoundaryTwo_productH1Diagonal_of_closed
...
theorem exists_firstOuterFundamentalReduction
  ...
  obtain ⟨lebesgue⟩ :=
    Holonics.Millennium.HodgeFiniteClosedStarLabeling.exists_starLebesgueLabel
  obtain ⟨sphereFilling, coefficient, sphereBoundary⟩ :=
    Holonics.Millennium.HodgeCommonStarNormalization.exists_commonStarReduction_to_fundamental
...
end Holonics.Millennium.HodgeProductMixedFilling
