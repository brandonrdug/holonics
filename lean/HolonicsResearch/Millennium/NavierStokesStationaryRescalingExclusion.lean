...
import HolonicsResearch.Millennium.NavierStokesPeriodicPressureRigidity
...
namespace Holonics.Millennium.NavierStokesStationaryRescalingExclusion

open Holonics.Millennium.NavierStokes
open Holonics.Millennium.NavierStokesOpenLifespan
open Holonics.Millennium.NavierStokesDynamicRescaling
open Holonics.Millennium.NavierStokesRescalingPeriodObstruction
open Holonics.Millennium.NavierStokesPeriodicPressureRigidity
...
theorem OpenPeriodicSolutionOn.stationaryProfile_eq_zero
  ...
  have hconstant :=
    Holonics.Millennium.NavierStokesRescalingPeriodObstruction.OpenPeriodicSolutionOn.stationaryProfile_constant_exponential
  ...
  have hperiod : ∀ y i, P (y + (length s)⁻¹ • EuclideanSpace.single i 1) = P y :=
    Holonics.Millennium.NavierStokesDynamicRescaling.OpenPeriodicSolutionOn.rescaled_pressure_period
  ...
  have hgrad : ∀ y, gradient P y = (amplitudeJet / amplitude s) • profile 0 := by
    intro y
    have hm :=
      Holonics.Millennium.NavierStokesDynamicRescaling.OpenSmoothSolutionOn.rescaled_momentum
...
end Holonics.Millennium.NavierStokesStationaryRescalingExclusion
