...
namespace Holonics.Millennium.PositiveForm
...
open Holonics.Millennium.UniversalBSDLedger
...
theorem theEasyInclusionSuppliesNoPositivity
    (D : Holonics.Millennium.HodgeConjecture.Datum) :
...
end Holonics.Millennium.PositiveForm
