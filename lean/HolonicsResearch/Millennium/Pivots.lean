...
namespace Holonics.Millennium.Pivots
...
theorem theFinerReceiverSeesTheRotation :
  ...
  · rw [PiLp.inner_apply, Fin.sum_univ_two]
    simp [rotate, graded]
    norm_num
  · exact Holonics.Millennium.MillenniumCoupling.ReceiverForm.theAntisymmetricPartIsInvisible
      (LinearMap.toContinuousLinearMap rotate) (fun x y => theRotationIsAntisymmetric x y) _

end Holonics.Millennium.Pivots