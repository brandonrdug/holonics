...
namespace Holonics.Millennium.NavierStokesRescalingEndpoint
...
open Holonics.Millennium.NavierStokesRescalingSpace
...
theorem OpenPeriodicSolutionOn.isMaximal_of_rescaled_value
  ...
  have hcontinuous : ContinuousAt (Function.uncurry extension.extendedVelocity) (xstar, T) :=
    (Holonics.Millennium.NavierStokesDynamicRescaling.OpenSmoothSolutionOn.joint_contDiffAt
...
theorem OpenPeriodicSolutionOn.isMaximal_of_rescaled_spatialDerivative
  ...
  have hlower' : ∀ᶠ s in atTop,
    ...
    have hjoint :=
      Holonics.Millennium.NavierStokesDynamicRescaling.OpenSmoothSolutionOn.joint_differentiableAt
...
end Holonics.Millennium.NavierStokesRescalingEndpoint
