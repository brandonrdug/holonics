...
namespace Holonics.Millennium.NavierStokesCofinalOutputReceiverParsevalJoin

open Holonics.Millennium.NavierStokes
open Holonics.Millennium.NavierStokesAnnularHodgeScaleChain
...
open Holonics.Millennium.NavierStokesCompleteStretchingReceiverWorkJoin
open Holonics.Millennium.NavierStokesDeLaValleePoussin
...
open Holonics.Millennium.NavierStokesFiniteLinearRadiusTailPassage
...
open Holonics.Millennium.NavierStokesVorticityDirectionKernelScaleAssembly
  ...
  have hvolume :
      @volume SpatialTorus
          (@MeasureSpace.pi (Fin 3) (Fin.fintype 3) (fun _ ↦ UnitAddCircle)
            (fun _ ↦
              Holonics.Millennium.NavierStokesCofinalOutputReceiverParsevalJoin.instMeasureSpaceUnitAddCircle_holonicsResearch)) =
        @volume SpatialTorus
          (@MeasureSpace.pi (Fin 3) (Fin.fintype 3) (fun _ ↦ UnitAddCircle)
...
end Holonics.Millennium.NavierStokesCofinalOutputReceiverParsevalJoin
