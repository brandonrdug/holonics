...
namespace Holonics.Millennium.GeneralMordell

open WeierstrassCurve.Affine
open Holonics.Millennium
open Holonics.Millennium.GeneralFace
open Holonics.Millennium.GeneralHeight
open Holonics.Millennium.FiveHeight
open Holonics.Millennium.GeneralCollision
...
theorem theRankIsBoundedOnEveryFullTwoTorsionCurve (r : ℕ)
    ...
    ¬ Holonics.Millennium.UniversalBSD.RankAtLeastOn
        (E ((a : ℚ)) ((b : ℚ))) r := by
  intro hR
  unfold Holonics.Millennium.UniversalBSD.RankAtLeastOn
    Holonics.Millennium.UniversalBSD.IndependentModTorsionOn
    Holonics.Millennium.UniversalBSD.IsTorsionOn at hR
  obtain ⟨Pts, hind⟩ := hR
...
end Holonics.Millennium.GeneralMordell
