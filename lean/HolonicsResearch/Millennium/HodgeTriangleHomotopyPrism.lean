...
namespace Holonics.Millennium.HodgeTriangleHomotopyPrism
...
open Holonics.Millennium.HodgeStellarSubdivision
open Holonics.Millennium.HodgeBarycentricChainSupport
open Holonics.Millennium.HodgeBarycentricTetrahedron
open Holonics.Millennium.HodgeRefinementWords
open Holonics.Millennium.HodgeIteratedBarycentricHomology
open Holonics.Millennium.HodgeRadialCurrent
open Holonics.Millennium.HodgeCommonStarAffineCarrier.CommonStarTriangle
open Holonics.Millennium.HodgeCommonStarAffineCarrier
open Holonics.Millennium.HodgeRefinedTriangleAffineCarrier
open Holonics.Millennium.HodgeRefinedTriangleClosedStar
open Holonics.Millennium.HodgePointCarry
open Holonics.Millennium.HodgeTetrahedralLabelCarry
open Holonics.Millennium.HodgeTetrahedralSphereComplex
open Holonics.Millennium.HodgeTetrahedralChainComplex
open Holonics.Millennium.HodgeRefinedCycleCarrier
...
theorem refinedAffineCarrierFamily_facePrism_congr
    {chain : SphereChain 2}
    {lebesgue :
      Holonics.Millennium.HodgeFiniteClosedStarLabeling.StarLebesgueLabel}
...
def affineLabelEdgeNormalizationHolon :
    Holonics.BoundaryHolon (SphereChain 1) (SphereChain 2) where
...
def trianglePrismHolon
    ...
    {lebesgue :
      Holonics.Millennium.HodgeFiniteClosedStarLabeling.StarLebesgueLabel}
    (family : RefinedAffineCarrierFamily chain lebesgue) :
    Holonics.BoundaryHolon (SphereChain 2) (SphereChain 3) where
...
theorem trianglePrismHolon_totalTarget
  ...
  unfold Holonics.BoundaryHolon.totalTarget trianglePrismHolon
...
end Holonics.Millennium.HodgeTriangleHomotopyPrism
