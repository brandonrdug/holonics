...
namespace Holonics.Millennium.ValuationDivisorLatticeAtlas

open Holonics.Geometry.DivisorAtlas
open Holonics.Millennium.PlaceLedger
...
theorem arithmeticDivisorIsAMultiplicationLift (divisor value : ℕ) :
    divisor ∣ value ↔
      Nonempty (Holonics.Foundation.ExactPartition.NatFactorWitness divisor value) :=
  (Holonics.Foundation.ExactPartition.NatFactorWitness.nonempty_iff_dvd
    divisor value).symm
...
end Holonics.Millennium.ValuationDivisorLatticeAtlas
