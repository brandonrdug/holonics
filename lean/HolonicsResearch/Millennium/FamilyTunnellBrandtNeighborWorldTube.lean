...
namespace Holonics.Millennium.FamilyTunnellBrandtNeighborWorldTube
...
def BrandtNeighborOccurrence.neighborMember (hp2 : p ≠ 2)
  ...
  match occurrence with
  | .inl d =>
      x ∈ Holonics.Millennium.FamilyTunnellIntegralNeighbors.integralNeighbor
        (p := p) 32 d
...
end Holonics.Millennium.FamilyTunnellBrandtNeighborWorldTube
