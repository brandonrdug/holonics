...
namespace Holonics.Millennium.FamilyTunnellBrandtGenusInvariants
...
theorem oddPrime_additive_local_isometry_and_global_separation (hp2 : p ≠ 2) :
  ...
  · exact
      Holonics.Millennium.FamilyTunnellBrandtGlobalSeparation.no_integral_receiver_equivalence
...
end Holonics.Millennium.FamilyTunnellBrandtGenusInvariants
