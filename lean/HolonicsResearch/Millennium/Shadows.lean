...
namespace Holonics.Millennium.Shadows
...
`Holonics.Geometry.AffineSwing.swing 0 t = −t`: the one move, about the anchor `ω` sits at, exchanges
...
theorem theSwingExchangesTheNullParameters (t : R) :
    Holonics.Geometry.AffineSwing.swing (0 : R) t = -t := by
...
end Holonics.Millennium.Shadows
