...
namespace Holonics.Millennium.NavierStokesFirstRadialLift
...
theorem linearProfile_jets (f g : ℝ → ℝ) (p : ℝ × ℝ) (f' g' : ℝ)
  ...
  have ja := Holonics.Millennium.NavierStokesAxialLift.axialOnly_jet f p f' hf
...
end Holonics.Millennium.NavierStokesFirstRadialLift
