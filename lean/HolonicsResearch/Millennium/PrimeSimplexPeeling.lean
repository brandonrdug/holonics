...
namespace Holonics.Millennium.PrimeSimplexPeeling
...
theorem roughFrom_two (N : ℕ) : roughFrom 2 N = Holonics.Millennium.PrimeSimplex.mertens N := by
  unfold roughFrom Holonics.Millennium.PrimeSimplex.mertens
  apply sum_congr rfl
  intro n _
...
theorem roughAbove_two (N : ℕ) : roughAbove 2 N = Holonics.Millennium.PrimeSimplex.oddSum N := by
  unfold roughAbove Holonics.Millennium.PrimeSimplex.oddSum
  apply sum_congr rfl
  intro n hn
...
theorem mertens_shell_two (N : ℕ) :
    Holonics.Millennium.PrimeSimplex.mertens N =
      Holonics.Millennium.PrimeSimplex.oddSum N -
        Holonics.Millennium.PrimeSimplex.oddSum (N / 2) := by
...
end Holonics.Millennium.PrimeSimplexPeeling
