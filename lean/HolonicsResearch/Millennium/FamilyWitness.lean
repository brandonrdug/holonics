...
namespace Holonics.Millennium.FamilyWitness

open Real Complex
open Holonics.Millennium.BirchSwinnertonDyer
open Holonics.Millennium.FamilyDuplication
open Holonics.Millennium.FamilyThetaFE
open Holonics.Millennium.HeckeTheta
open Holonics.Millennium.HeckeEuler
...
theorem theTraceTwistLawAtEveryModulus (n : ℕ) {q : ℕ} [Fact q.Prime]
  ...
  have hn0 : ((n : ℕ) : ZMod q) ≠ 0 := by
    ...
    exact hqn
  rw [Holonics.Millennium.FiveTwist.trace_eq_neg_charSum n hq2,
    Holonics.Millennium.FiveTwist.trace_eq_neg_charSum 1 hq2]
...
theorem pCoeff_prime_odd (p : ℕ) [Fact p.Prime] (hp2 : p ≠ 2)
  ...
  · -- the blind frame: both sides vanish
    have hzero : heckeCoeff q = 0 :=
      Holonics.Millennium.HeckeTheta.heckeCoeff_three_mod_four hq4
...
end Holonics.Millennium.FamilyWitness
