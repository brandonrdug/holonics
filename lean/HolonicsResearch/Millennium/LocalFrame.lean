...
namespace Holonics.Millennium.LocalFrame

open Holonics.Millennium.MillenniumCoupling
open Holonics.Millennium.MillenniumCoupling.ReceiverForm
open Holonics.Millennium.Pivots Finset
...
theorem theCollapseIsTheCommonKernel (r : ι → V) (v : V) :
    Holonics.Millennium.Separation.collapseOf (frameForm r).readings v 0 ↔ ∀ i, (inner ℝ (r i) v : ℝ) = 0 := by
...
end Holonics.Millennium.LocalFrame
