...
import HolonicsResearch.Millennium.NavierStokesRescalingClock
import HolonicsResearch.Millennium.NavierStokesRescalingPeriodObstruction
...
namespace Holonics.Millennium.NavierStokesAnisotropicViscousClock
open Holonics.Millennium.NavierStokes
open Holonics.Millennium.NavierStokesOpenLifespan
open Holonics.Millennium.NavierStokesAxisymmetricChart
open Holonics.Millennium.NavierStokesAnisotropicFrame
open Holonics.Millennium.NavierStokesAnisotropicDynamics
open Holonics.Millennium.NavierStokesLinearFrameSpace
open Holonics.Millennium.NavierStokesLinearFrameDynamics
open Holonics.Millennium.NavierStokesRescalingClock
open Holonics.Millennium.NavierStokesRescalingPeriodObstruction
...
theorem OpenSmoothSolutionOn.radial_clock_momentum
  ...
  have h := Holonics.Millennium.NavierStokesAnisotropicDynamics.OpenSmoothSolutionOn.anisotropic_momentum
  ...
  have hp : DifferentiableAt ℝ (fun x ↦ pressure x (clock t))
    ...
    (Holonics.Millennium.NavierStokesLinearFrameDynamics.OpenSmoothSolutionOn.pressureSlice_contDiff
...
end Holonics.Millennium.NavierStokesAnisotropicViscousClock
