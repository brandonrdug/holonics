...
namespace Holonics.Millennium.NavierStokesAnisotropicDynamics
...
open Holonics.Millennium.NavierStokesLinearFrameEnergy
...
theorem OpenSmoothSolutionOn.anisotropic_momentum
  ...
  dsimp only
  have h := Holonics.Millennium.NavierStokesLinearFrameDynamics.OpenSmoothSolutionOn.linearFrame_momentum
...
theorem OpenPeriodicSolutionOn.anisotropic_energy_hasDerivAt
  ...
  apply Holonics.Millennium.NavierStokesLinearFrameEnergy.OpenPeriodicSolutionOn.frame_energy_hasDerivAt
...
end Holonics.Millennium.NavierStokesAnisotropicDynamics
