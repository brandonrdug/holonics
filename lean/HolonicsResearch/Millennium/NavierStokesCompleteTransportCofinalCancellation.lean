...
namespace Holonics.Millennium.NavierStokesCompleteTransportCofinalCancellation
...
def openVorticityH3State
    ...
    (solution :
      OpenPeriodicSolutionOn T nu initial (0 : VelocityField) velocity pressure)
    (t : Set.Ioo 0 T) :
      Holonics.Millennium.NavierStokesInfiniteFourierHeatRestart.PeriodicVectorSobolevThree :=
...
end Holonics.Millennium.NavierStokesCompleteTransportCofinalCancellation
