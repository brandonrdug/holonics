...
import HolonicsResearch.Millennium.HodgeCommonStarAffineCarrier
...
namespace Holonics.Millennium.HodgeRefinedEdgeAffineCarrier
...
def refinedEdgeCommonStarCarrier
    ...
    (labeling : (refinedEdgeComplex chain scale).ClosedStarLabeling)
    (cell : RefinedEdgeCell chain scale) :
      Holonics.Millennium.HodgeCommonStarAffineCarrier.CommonStarEdge where
...
structure RefinedEdgeAffineCarrierFamily (chain : SphereChain 1)
  ...
  carrier : (refinedEdgeComplex chain scale).Cell →
    Holonics.Millennium.HodgeCommonStarAffineCarrier.CommonStarEdge
...
end Holonics.Millennium.HodgeRefinedEdgeAffineCarrier
