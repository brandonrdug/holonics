...
namespace Holonics.Millennium.RealizationCorollaries

open Holonics.Millennium.MillenniumCoupling
open Holonics.Millennium.RealizedMillenniumForms
open Holonics.Millennium.PositivityIsRealization
open Holonics.Millennium.RealizerJoints
open Holonics.Millennium.Pivots
open Holonics.Millennium.HodgeIndex
open Holonics.Millennium.LocalFrame
open Holonics.Millennium.HelicityAsLinking
open Holonics.Millennium.Crossings
open Finset
...
theorem collapse_iff_realizer_kernel (G : ReceiverForm V) (f : V →L[ℝ] W)
    (hf : ∀ x y, inner ℝ (f x) (f y) = G.B x y) (v : V) :
    Holonics.Millennium.Separation.collapseOf G.readings v 0 ↔ f v = 0 := by
...
theorem vacuum_is_realizer_kernel (G : ReceiverForm V) (f : V →L[ℝ] W)
  ...
  ⟨(nullCone_iff_realizer_kernel G f hf e).mp he,
    fun v c => Holonics.Millennium.MassGap.theVacuumIsInvisible
...
theorem not_coercive_of_realizer_kernel (G : ReceiverForm V) (f : V →L[ℝ] W)
    ...
    ¬ G.IsCoercive :=
  Holonics.Millennium.MassGap.theVacuumRefusesAGlobalGap hne
...
section Hilbert
open Holonics.Millennium.Coupling.HilbertTransportChain
universe u
...
variable (T : Holonics.Millennium.Coupling.HilbertTransportChain A B C)
...
end Holonics.Millennium.RealizationCorollaries
