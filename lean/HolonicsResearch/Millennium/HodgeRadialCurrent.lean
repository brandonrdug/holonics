...
namespace Holonics.Millennium.HodgeRadialCurrent
...
open Holonics.Millennium.HodgeBarycentricTriangleSubdivision
...
theorem edgeSimplex_vertex_radial (edge : TetraEdge) (index : Fin 2) :
  ...
  all_goals
    ...
    exact Holonics.Millennium.HodgePointCarry.simplexFaceMap_vertex _ _
...
theorem edgeSimplex_endpoint_label (lebesgue : StarLebesgueLabel)
    ...
    simplexPointLabels
        (Holonics.Millennium.HodgePointCarry.StarLebesgueLabel.toStarPointLabeling
...
theorem refinedEdgeCurrent_supported (lebesgue : StarLebesgueLabel)
  ...
  have hpoint := pointCarryMorphism_simplexGenerator
    (Holonics.Millennium.HodgePointCarry.StarLebesgueLabel.toStarPointLabeling lebesgue)
...
end Holonics.Millennium.HodgeRadialCurrent
