import HolonicsResearch.Millennium.NavierStokesMovingSwirlCirculation
import HolonicsResearch.Millennium.NavierStokesSwirlDiffusion
import HolonicsResearch.Millennium.NavierStokesDynamicRescaling
...
namespace Holonics.Millennium.NavierStokesViscousSwirlBalance
...
open Holonics.Millennium.NavierStokesMovingSwirlCirculation
open Holonics.Millennium.NavierStokesSwirlDiffusion
...
theorem centredMomentumResidual_of_physical_solution
  ...
  have h := Holonics.Millennium.NavierStokesDynamicRescaling.OpenSmoothSolutionOn.rescaled_momentum
...
theorem rescaled_angularMomentum_reconstruct (length normalizer clock : ℝ → ℝ)
    ...
    cartesianAngularMomentum (length t • y) (velocity (length t • y) (clock t)) =
      (length t / normalizer t) * cartesianAngularMomentum y
        (Holonics.Millennium.NavierStokesDynamicRescaling.rescaledVelocity
...
end Holonics.Millennium.NavierStokesViscousSwirlBalance
