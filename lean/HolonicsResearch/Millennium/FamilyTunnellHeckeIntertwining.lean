...
namespace Holonics.Millennium.FamilyTunnellHeckeIntertwining
...
def tunnellHalfIntegralHeckeDefect (p n : ℕ) : ℚ :=
  halfIntegralHeckeCoefficient normalizedTunnellCoefficient p n -
    (Holonics.Millennium.HeckeTheta.heckeCoeff p : ℚ) *
...
end Holonics.Millennium.FamilyTunnellHeckeIntertwining
