...
namespace Holonics.Mathematics.JacobiFiniteDiagonalCone
...
theorem SquareCone.eulerDerivative
    ...
    SquareCone
      (Holonics.Mathematics.JacobiEulerDerivative.bivariateEulerDerivative F) := by
  intro n m hcoeff
  simp only [Holonics.Mathematics.JacobiEulerDerivative.coeff_bivariateEulerDerivative,
    Holonics.Mathematics.JacobiEulerDerivative.coeff_laurentEulerDerivative] at hcoeff
...
end Holonics.Mathematics.JacobiFiniteDiagonalCone
