...
joined to the rational charts of `HolonicsResearch.Mathematics.Sturm` through their real
...
`Holonics.Mathematics.Sturm.TheReadingEqualsThePopulation`, which remains named open in the file
...
namespace Holonics.Mathematics.SignChange
...
end Holonics.Mathematics.SignChange
