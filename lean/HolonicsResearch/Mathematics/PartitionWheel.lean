...
`formal/elementary-holonics/.lake/packages/mathlib`, 2026-08-21, returns nothing), so the link
...
namespace Holonics.Mathematics.PartitionWheel
...
end Holonics.Mathematics.PartitionWheel
