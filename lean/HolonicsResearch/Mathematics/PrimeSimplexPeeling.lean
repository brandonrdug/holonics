...
namespace Holonics.Mathematics.PrimeSimplexPeeling
...
theorem roughFrom_two (N : ℕ) : roughFrom 2 N = Holonics.Mathematics.PrimeSimplex.mertens N := by
  unfold roughFrom Holonics.Mathematics.PrimeSimplex.mertens
  apply sum_congr rfl
  intro n _
...
theorem roughAbove_two (N : ℕ) : roughAbove 2 N = Holonics.Mathematics.PrimeSimplex.oddSum N := by
  unfold roughAbove Holonics.Mathematics.PrimeSimplex.oddSum
  apply sum_congr rfl
  intro n hn
...
theorem mertens_shell_two (N : ℕ) :
    Holonics.Mathematics.PrimeSimplex.mertens N =
      Holonics.Mathematics.PrimeSimplex.oddSum N -
        Holonics.Mathematics.PrimeSimplex.oddSum (N / 2) := by
...
end Holonics.Mathematics.PrimeSimplexPeeling
