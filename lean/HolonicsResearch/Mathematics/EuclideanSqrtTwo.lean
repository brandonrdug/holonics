...
(`EllipticCurve.QuarticSeventeen`).  What the descent needs next is **unique factorisation**, and
...
namespace Holonics.Mathematics.EuclideanSqrtTwo
...
end Holonics.Mathematics.EuclideanSqrtTwo
