...
import HolonicsResearch.Hodge.HodgeCommonStarAffineCarrier
...
namespace Holonics.Hodge.HodgeRefinedEdgeAffineCarrier
...
def refinedEdgeCommonStarCarrier
    ...
    (labeling : (refinedEdgeComplex chain scale).ClosedStarLabeling)
    (cell : RefinedEdgeCell chain scale) :
      Holonics.Hodge.HodgeCommonStarAffineCarrier.CommonStarEdge where
...
structure RefinedEdgeAffineCarrierFamily (chain : SphereChain 1)
  ...
  carrier : (refinedEdgeComplex chain scale).Cell →
    Holonics.Hodge.HodgeCommonStarAffineCarrier.CommonStarEdge
...
end Holonics.Hodge.HodgeRefinedEdgeAffineCarrier
