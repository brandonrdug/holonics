...
namespace Holonics.Hodge.HodgeSphereDegreeOneFilling
...
open Holonics.Hodge.HodgeBarycentricChainSupport
open Holonics.Hodge.HodgeFiniteClosedStarLabeling
open Holonics.Hodge.HodgePointCarry
open Holonics.Hodge.HodgeTetrahedralChainComplex
open Holonics.Hodge.HodgeTetrahedralSphereComplex
open Holonics.Hodge.HodgeTetrahedralRealizationChainMap
open Holonics.Hodge.HodgeRadialCurrent
open Holonics.Hodge.HodgeTriangleHomotopyPrism
open Holonics.Hodge.HodgeCommonStarAffineCarrier
open Holonics.Hodge.HodgeRefinedEdgeClosedStar
open Holonics.Hodge.HodgeRefinedEdgeAffineCarrier
...
theorem sum_refinedEdgeCoefficient_simplexGenerator
  ...
  calc
    ...
    _ = iteratedBarycentricEdgeSubdivision scale
      ...
      | empty =>
          exact Holonics.Hodge.HodgeIteratedBarycentricHomology.iteratedBarycentricEdgeSubdivision_zero scale
...
end Holonics.Hodge.HodgeSphereDegreeOneFilling
