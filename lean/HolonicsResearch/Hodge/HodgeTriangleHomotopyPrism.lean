...
namespace Holonics.Hodge.HodgeTriangleHomotopyPrism
...
open Holonics.Hodge.HodgeIteratedBarycentricHomology
open Holonics.Hodge.HodgeRadialCurrent
open Holonics.Hodge.HodgeCommonStarAffineCarrier.CommonStarTriangle
open Holonics.Hodge.HodgeCommonStarAffineCarrier
open Holonics.Hodge.HodgeRefinedTriangleAffineCarrier
open Holonics.Hodge.HodgeRefinedTriangleClosedStar
open Holonics.Hodge.HodgePointCarry
open Holonics.Hodge.HodgeTetrahedralLabelCarry
open Holonics.Hodge.HodgeTetrahedralSphereComplex
open Holonics.Hodge.HodgeTetrahedralChainComplex
open Holonics.Hodge.HodgeRefinedCycleCarrier
