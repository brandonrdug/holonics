...
namespace Holonics.Hodge.HodgeProductMixedFilling
...
theorem exists_firstOuterFundamentalReduction
  ...
  obtain ⟨lebesgue⟩ :=
    Holonics.Hodge.HodgeFiniteClosedStarLabeling.exists_starLebesgueLabel
  obtain ⟨sphereFilling, coefficient, sphereBoundary⟩ :=
    Holonics.Hodge.HodgeCommonStarNormalization.exists_commonStarReduction_to_fundamental
...
end Holonics.Hodge.HodgeProductMixedFilling
