...
namespace Holonics.Hodge.HodgeRadialCurrent
...
theorem edgeSimplex_vertex_radial (edge : TetraEdge) (index : Fin 2) :
  ...
  all_goals
    ...
    exact Holonics.Hodge.HodgePointCarry.simplexFaceMap_vertex _ _
...
theorem edgeSimplex_endpoint_label (lebesgue : StarLebesgueLabel)
    ...
    simplexPointLabels
        (Holonics.Hodge.HodgePointCarry.StarLebesgueLabel.toStarPointLabeling
...
theorem refinedEdgeCurrent_supported (lebesgue : StarLebesgueLabel)
  ...
  have hpoint := pointCarryMorphism_simplexGenerator
    (Holonics.Hodge.HodgePointCarry.StarLebesgueLabel.toStarPointLabeling lebesgue)
...
end Holonics.Hodge.HodgeRadialCurrent
