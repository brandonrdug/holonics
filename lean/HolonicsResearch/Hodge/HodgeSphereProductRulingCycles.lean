...
namespace Holonics.Hodge.HodgeSphereProductRulingCycles
...
abbrev Sphere :=
  Holonics.Hodge.HodgeTwoSphereFundamentalCycle.TwoSphere
...
end Holonics.Hodge.HodgeSphereProductRulingCycles
