...
namespace Holonics.Physics.HolonicTorusEntropyParametronEquivalence
...
theorem entropyAxisCrossCurrent_realizedWindingCurrent
    ...
    (plane :
      Holonics.Physics.HolonicRankFourInteractionPlanes.InteractionPlane) :
...
end Holonics.Physics.HolonicTorusEntropyParametronEquivalence
