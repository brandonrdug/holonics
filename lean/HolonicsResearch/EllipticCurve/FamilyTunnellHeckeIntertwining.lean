...
namespace Holonics.EllipticCurve.FamilyTunnellHeckeIntertwining
...
def tunnellHalfIntegralHeckeDefect (p n : ℕ) : ℚ :=
  halfIntegralHeckeCoefficient normalizedTunnellCoefficient p n -
    (Holonics.EllipticCurve.HeckeTheta.heckeCoeff p : ℚ) *
...
end Holonics.EllipticCurve.FamilyTunnellHeckeIntertwining
