...
namespace Holonics.EllipticCurve.FamilyTunnellBrandtNeighborWorldTube
...
def BrandtNeighborOccurrence.neighborMember (hp2 : p ≠ 2)
  ...
  match occurrence with
  | .inl d =>
      x ∈ Holonics.EllipticCurve.FamilyTunnellIntegralNeighbors.integralNeighbor
        (p := p) 32 d
...
end Holonics.EllipticCurve.FamilyTunnellBrandtNeighborWorldTube
