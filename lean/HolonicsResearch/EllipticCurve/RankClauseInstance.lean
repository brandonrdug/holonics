...
/-!
# RankClauseInstance: the Millennium rank clause is proved at a curve
...
namespace Holonics.EllipticCurve.RankClauseInstance

open Holonics.EllipticCurve.BirchSwinnertonDyer
open Holonics.EllipticCurve.UniversalBSD
...
theorem theCompleteMillenniumStatementAtOneReducesToTheLedger :
  ...
  exact ⟨theMillenniumRankClauseIsProvedAtOne, hrank,
    Holonics.EllipticCurve.UniversalBSDLedger.theRankZeroForcesAllTorsion _ hrank.2,
    HeckeWitness.theLFunctionDoesNotVanishAtOne⟩

end Holonics.EllipticCurve.RankClauseInstance
