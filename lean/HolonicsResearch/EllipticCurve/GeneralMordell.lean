...
namespace Holonics.EllipticCurve.GeneralMordell

open WeierstrassCurve.Affine
open Holonics.EllipticCurve.GeneralFace
open Holonics.EllipticCurve.GeneralHeight
open Holonics.EllipticCurve.FiveHeight
...
theorem theRankIsBoundedOnEveryFullTwoTorsionCurve (r : ℕ)
    ...
    ¬ Holonics.EllipticCurve.UniversalBSD.RankAtLeastOn
        (E ((a : ℚ)) ((b : ℚ))) r := by
  intro hR
  unfold Holonics.EllipticCurve.UniversalBSD.RankAtLeastOn
    Holonics.EllipticCurve.UniversalBSD.IndependentModTorsionOn
    Holonics.EllipticCurve.UniversalBSD.IsTorsionOn at hR
  obtain ⟨Pts, hind⟩ := hR
...
end Holonics.EllipticCurve.GeneralMordell
