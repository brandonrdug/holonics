...
import HolonicsResearch.Mathematics.JacobiTripleProductKernel
...
namespace Holonics.EllipticCurve.FamilyTunnellJacobiFiniteEulerConnection
...
theorem hasEulerConnection_finiteEulerFactor {d : ℕ} (hd : d ≠ 0) :
    Holonics.EllipticCurve.FamilyTunnellJacobiFourSquareEulerReturn.HasEulerConnection
      (finiteEulerFactorConnection d)
      (finiteEulerFactor d) := by
  rw [Holonics.EllipticCurve.FamilyTunnellJacobiFourSquareEulerReturn.HasEulerConnection,
...
end Holonics.EllipticCurve.FamilyTunnellJacobiFiniteEulerConnection
