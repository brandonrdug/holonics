...
namespace Holonics.EllipticCurve.QuarticSeventeen
...
theorem theBranchCrossesIntoTheTerminatingRing :
  ...
  ⟨(Holonics.Mathematics.EuclideanSqrtTwo.theSignDecidesTheOrbitSize).1,
...
end Holonics.EllipticCurve.QuarticSeventeen
