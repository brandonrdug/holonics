...
namespace Holonics.Geometry.HolonicClockedPantographicSwingApparatus

open Holonics
open Holonics.Transport.HolonicSensoryWorldTube
open Holonics.Geometry.HolonicClockedPantographicSwing
open Holonics.Computation.HolonicFiniteCausalAperture
...
end Holonics.Geometry.HolonicClockedPantographicSwingApparatus
