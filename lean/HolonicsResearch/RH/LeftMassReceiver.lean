...
theorem centredDivisor_ne_zero_iff (R : ℝ) (u : ℂ) :
  ...
  · rintro ⟨hmem, hzero⟩
    ...
    have htop : meromorphicOrderAt riemannXi u ≠ ⊤ :=
      Holonics.RH.WeightedArgumentPrinciple.meromorphicOrderAt_riemannXi_ne_top u
...
end Holonics.RH.LeftMassReceiver
