...
namespace Holonics.RH.FosterClassHeatFlow

open Complex
open Holonics.RH.RiemannXi
open Holonics.RH.XiGrowth
open Holonics.RH.EntireDerivativeGrowth
open Holonics.RH.HeatFlowEntire
open Holonics.RH.HeatEquationEntire
open Holonics.RH.ZeroDynamicsEntire
open Holonics.RH.PhaseFlowLedger
open Holonics.RH.FosterClassLandau
open Holonics.RH.FosterClassHeat
...
theorem rodgersTaoZeroDynamics_heatE : RodgersTaoZeroDynamics (fun t => heatE t riemannXi) := by
  ...
  rw [hv]
  exact Holonics.RH.FosterClassFlux.flux (f := heatE t riemannXi) (hzero t) hs

end Holonics.RH.FosterClassHeatFlow
