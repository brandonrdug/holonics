...
import HolonicsResearch.Computation.ReceiverIndexedCausalLengthTower
...
namespace Holonics.Computation.PVersusNPCausalLengthBridge

open Computability
open Holonics.Computation.PVersusNP
open Holonics.Computation.PVersusNPOfficialBridge
...
def OutputPreimageFibre (anchor : TowerTM2Anchor tower family)
    (face : Receiver) : Type :=
  Holonics.Foundation.Lift.TransportLift anchor.outputFace face
...
end Holonics.Computation.PVersusNPCausalLengthBridge
