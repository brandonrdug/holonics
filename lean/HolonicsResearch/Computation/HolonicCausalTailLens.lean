...
namespace Holonics.Computation.HolonicCausalTailLens

open scoped BigOperators TensorProduct
open Holonics.Computation.HolonicOrientedSiteTransport
...
end Holonics.Computation.HolonicCausalTailLens
