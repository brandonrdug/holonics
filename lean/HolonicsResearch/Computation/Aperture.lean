...
family **separates**, and `ReceiverForm.theDefinitenessIsSeparation` already proves those are
...
namespace Holonics.Computation.Aperture

open Holonics.Foundation.Separation Finset
...
end Holonics.Computation.Aperture
