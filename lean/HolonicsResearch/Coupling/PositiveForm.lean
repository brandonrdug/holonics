...
namespace Holonics.Coupling.PositiveForm
...
open Holonics.EllipticCurve.UniversalBSDLedger
...
theorem theEasyInclusionSuppliesNoPositivity
    (D : Holonics.Hodge.HodgeConjecture.Datum) :
...
end Holonics.Coupling.PositiveForm
