...
This source-neutral owner preserves its historical declaration namespace. The former
`Computation.HolonicInformationTheory` module forwards this import; no neural-ecology dependency
is needed to define these information receivers.
...
namespace Holonics.Computation.HolonicInformationTheory
...
end Holonics.Computation.HolonicInformationTheory
