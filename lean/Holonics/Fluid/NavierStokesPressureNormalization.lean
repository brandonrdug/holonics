...
namespace Holonics.Fluid.NavierStokesPressureNormalization
...
def OpenPeriodicSolutionOn.normalizePressure
  ...
  pressureSmooth :=
    Holonics.Fluid.NavierStokesRestartSeam.OpenPeriodicSolutionOn.anchoredPressureSmooth
      solution
...
end Holonics.Fluid.NavierStokesPressureNormalization
