...
namespace Holonics.Fluid.NavierStokesWeightedReconstructionContinuity
...
def reconstructedTorusComplexComponentCLM (component : Fin 3) :
    PeriodicVectorWeightedSobolev 3 →L[ℂ]
      C(Holonics.Fluid.NavierStokesTorusVorticity.SpatialTorus, ℂ) :=
...
end Holonics.Fluid.NavierStokesWeightedReconstructionContinuity
