...
namespace Holonics.Fluid.NavierStokesTorusVorticity
...
theorem openPeriodicSolutionOn_vorticityField_contDiffOn_interior
  ...
  have hnhds :
      Holonics.Fluid.NavierStokesFiniteTimeVorticity.openSpaceTimeSlab S ∈ nhds z := by
    simpa [Holonics.Fluid.NavierStokesFiniteTimeVorticity.openSpaceTimeSlab] using
...
end Holonics.Fluid.NavierStokesTorusVorticity
