...
namespace Holonics.Fluid.NavierStokesFiniteTimeVorticity
...
def PeriodicSolution.toPeriodicSolutionOn
  ...
  toSmoothSolutionOn :=
    Holonics.Fluid.NavierStokesFiniteTime.SmoothSolution.toSmoothSolutionOn
...
end Holonics.Fluid.NavierStokesFiniteTimeVorticity
