...
namespace Holonics.Computation.HolonicDiffusionCharts

open scoped BigOperators
open Holonics.Computation.HolonicArchitectureCharts
...
end Holonics.Computation.HolonicDiffusionCharts
