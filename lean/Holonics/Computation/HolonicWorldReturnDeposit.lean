...
namespace Holonics.Computation.HolonicWorldReturnDeposit
...
def threeSiteCultivationPassage :
    Holonics.Computation.HolonicIntelligence.CultivationPassage
...
end Holonics.Computation.HolonicWorldReturnDeposit

section Audit
open Holonics.Computation.HolonicWorldReturnDeposit
