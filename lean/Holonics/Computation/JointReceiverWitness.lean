...
import Holonics.Transport.ReceiverPotential
...
namespace Holonics.Computation.JointReceiverWitness
...
theorem jointFace_is_potential :
    Holonics.Transport.ReceiverPotential.outcomes (fun _ : Source ↦ ())
...
end Holonics.Computation.JointReceiverWitness

section Audit

open Holonics.Computation.JointReceiverWitness
