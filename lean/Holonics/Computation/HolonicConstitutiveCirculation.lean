...
namespace Holonics.Computation.HolonicConstitutiveCirculation
...
theorem graphScattering_eq_swing
    ...
    graphScattering D Dt Kinv x =
      Holonics.Geometry.AffineSwing.swing (graphProjection D Dt Kinv x) x := by
  simp [graphScattering, Holonics.Geometry.AffineSwing.swing, two_smul]
...
end Holonics.Computation.HolonicConstitutiveCirculation
