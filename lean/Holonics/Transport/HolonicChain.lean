...
namespace Holonics.Transport.HolonicChain
...
`Holonics.Foundation.Atlas.SeparatingAtlas.markov`, written at the chain's joint index type
...
theorem markov_is_the_separating_atlas_parameter {n m : ℕ}
    ...
    C * A ^ k * B = Holonics.Foundation.Atlas.SeparatingAtlas.markov C A B k :=
  rfl
...
end Holonics.Transport.HolonicChain
