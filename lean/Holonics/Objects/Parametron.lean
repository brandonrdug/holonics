...
namespace Holonics.Objects.Parametron
...
theorem lc_measuredAngularFrequency (ω φ : ℝ) {s t : ℝ} (hst : s ≠ t) :
  ...
  simp only [measuredAngularFrequency,
    Holonics.Foundation.MeasuredDifferenceReceiver.differenceRatio,
    Holonics.Foundation.MeasuredDifferenceReceiver.sectionDifference, id]
  field_simp
  ring
...
end Holonics.Objects.Parametron
