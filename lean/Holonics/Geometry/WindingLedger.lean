...
`Fluid/Crossings.lean` owns the sibling object — an **authored** crossing table over strands,
...
namespace Holonics.Geometry.WindingLedger
...
end Holonics.Geometry.WindingLedger
