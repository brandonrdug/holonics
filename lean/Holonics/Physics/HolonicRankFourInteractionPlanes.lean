...
namespace Holonics.Physics.HolonicRankFourInteractionPlanes
...
abbrev PeriodDirection :=
  Holonics.Physics.HolonicFourTorusCarrier.Direction
...
end Holonics.Physics.HolonicRankFourInteractionPlanes
