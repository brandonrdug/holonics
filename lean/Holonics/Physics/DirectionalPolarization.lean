...
namespace Holonics.Physics.DirectionalPolarization

open scoped BigOperators ComplexConjugate Matrix
open Holonics.Computation.HolonicPolarizedCrystalTransport
...
end Holonics.Physics.DirectionalPolarization
