...
import Holonics.Physics.HolonicFieldTheoryPassage
...
namespace Holonics.Physics.HolonicEntropyActionInduction

open scoped BigOperators
open Holonics
open Holonics.Physics.HolonicDiscreteInduction
open Holonics.Physics.HolonicFourTorusCarrier
open Holonics.Physics.HolonicRankFourInteractionPlanes
open Holonics.Geometry.HolonicInteractionExterior
open Holonics.Physics.HolonicFourForceSectorCarrier
...
end Holonics.Physics.HolonicEntropyActionInduction

section Audit
open Holonics.Physics.HolonicEntropyActionInduction
