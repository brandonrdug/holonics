...
namespace Holonics.Millennium.HolonicDifferenceCalculus
...
def swungEdge {G : Type*} [AddCommGroup G] (anchor body : G) : OrientedEdge G :=
  ⟨anchor, Holonics.Geometry.AffineSwing.swing anchor body⟩
...
theorem swing_reversesDifference {G : Type*} [AddCommGroup G] (anchor body : G) :
  ...
  exact Holonics.Geometry.AffineSwing.theSwingNegatesTheDisplacementFromTheAnchor anchor body
...
theorem localDifferences_integrateToBoundary (path : ℕ → G) (steps : ℕ) :
  ...
  exact Holonics.finite_telescoping path steps
...
theorem windowDifferences_integrateToBoundary
  ...
  have h := Holonics.finite_telescoping (fun offset ↦ path (start + offset)) length
...
end Holonics.Millennium.HolonicDifferenceCalculus

#print axioms Holonics.Millennium.HolonicDifferenceCalculus.OrientedEdge.difference_reverse
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.OrientedEdge.nonzeroReceiverDifference_isPolarized
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.swingDifference_isEulerHalfTurn
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.productDifference_leftThenRight
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.productDifference_pathInterchange
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.productDifference_sourceLinearizationWithRemainder
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.squareDifference_isDifferenceTimesSum
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.receiver_commutes_iteratedDifference
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.secondDifference_affinePath
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.transportDifference_eq_zero_iff_fixed
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.chart_preserves_transportDifference
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.firstDifference_transportOrbit
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.coarseDifference_isIntegratedWindow
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.modularDifference_eq_zero_iff_modEq
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.modularReceiver_reopensIntegralDifference
#print axioms Holonics.Millennium.HolonicDifferenceCalculus.localDifference_globalBoundary_areAdjoint
