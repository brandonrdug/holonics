...
namespace Holonics.Millennium.NavierStokesWeightedClassicalRestartCarrier
...
open Holonics.Millennium.NavierStokesWeightedMildPhysicalSource
...
open Holonics.Millennium.NavierStokesWeightedSmoothClassicalMomentum
...
theorem CoherentWeightedSmoothPathTower.fixedPoint_hasDerivAt_realClassicalMomentum_component
  ...
  have hcomplex :=
    Holonics.Millennium.NavierStokesWeightedSmoothClassicalMomentum.CoherentWeightedSmoothPathTower.fixedPoint_hasDerivAt_classicalMomentum_advection
...
structure JointSpacetimeSmoothnessUpgrade
  ...
  velocitySmooth :
    ContDiffOn ℝ ((↑(⊤ : ℕ∞)) : WithTop ℕ∞) (Function.uncurry velocity)
      (Holonics.Millennium.NavierStokesOpenLifespan.openSpaceTimeSlab T)
  pressureSmooth :
...
end Holonics.Millennium.NavierStokesWeightedClassicalRestartCarrier
