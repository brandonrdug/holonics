import Holonics.Millennium.NavierStokesCofinalConstruction
import Holonics.Millennium.NavierStokesDyadicHodgeCompletedKernelPassage
import Holonics.Millennium.NavierStokesOfficialAnalyticDischarges
...
namespace Holonics.Millennium.NavierStokesCriticalOfficialPassage

open Holonics.Millennium.NavierStokes
open Holonics.Millennium.NavierStokesCofinalConstruction
...
open Holonics.Millennium.NavierStokesOfficialAnalyticDischarges
...
theorem initialVelocityConditionPeriodic_of_openPeriodicSolution
  ...
  · rw [← hsection]
    exact
      Holonics.Millennium.NavierStokesOverlapUniqueness.OpenPeriodicSolutionOn.velocitySpatialSmooth
        solution hzero
  · rw [← hsection]
...
end Holonics.Millennium.NavierStokesCriticalOfficialPassage
