...
namespace Holonics.Millennium.NavierStokesOpenEnergySpacetime
...
open Holonics.Millennium.NavierStokesTerminalShellControl
...
theorem openPeriodicSolutionOn_periodicKineticEnergy_continuousOn_initial
  ...
  have hswapMem : ∀ z, swap z ∈
      Holonics.Millennium.NavierStokesOpenLifespan.openSpaceTimeSlab T := by
    rintro ⟨t, x⟩
...
end Holonics.Millennium.NavierStokesOpenEnergySpacetime
