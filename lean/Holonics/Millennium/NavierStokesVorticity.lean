...
namespace Holonics.Millennium.NavierStokesVorticity
...
theorem cross_swap_is_zeroAnchoredSwing (u v : Space) :
    cross v u = Holonics.Geometry.AffineSwing.swing 0 (cross u v) := by
  rw [cross_swap]
  ext i
...
end Holonics.Millennium.NavierStokesVorticity
