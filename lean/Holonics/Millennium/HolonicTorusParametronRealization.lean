...
namespace Holonics.Millennium.HolonicTorusParametronRealization

open scoped BigOperators
open Holonics
open Holonics.Millennium.HolonicPolygonalTorusCarrier
...
def crossSectionCurrentFibreEquivKernel
    ...
    (base : Holonics.Foundation.Lift.PreimageFibre
      (crossSectionCurrentAddHom (minor := minor) cut) value) :
    Holonics.Foundation.Lift.PreimageFibre
        (crossSectionCurrentAddHom (minor := minor) cut) value ≃
      (crossSectionCurrentAddHom (minor := minor) cut).ker :=
  Holonics.Foundation.Lift.fibreEquivKernel
...
def crossSectionCurrentInsufficiency
    (cut i : MajorIndex major) :
    Holonics.ReceiverInsufficiency
      (fun chain : Chain (ParametronBranch major minor) ↦
        crossSectionCurrent cut (chainDrive chain))
...
end Holonics.Millennium.HolonicTorusParametronRealization

section Audit
open Holonics.Millennium.HolonicTorusParametronRealization
