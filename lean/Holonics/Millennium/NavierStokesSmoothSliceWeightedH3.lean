...
namespace Holonics.Millennium.NavierStokesSmoothSliceWeightedH3
...
open Holonics.Millennium.NavierStokesCoordinateH3FullEstimate
      ...
      have hvolume :
          @volume SpatialTorus
              (@MeasureSpace.pi (Fin 3) (Fin.fintype 3) (fun _ ↦ UnitAddCircle)
                (fun _ ↦ instMeasureSpaceUnitAddCircle_holonics)) =
            @volume SpatialTorus
              (@MeasureSpace.pi (Fin 3) (Fin.fintype 3) (fun _ ↦ UnitAddCircle)
...
end Holonics.Millennium.NavierStokesSmoothSliceWeightedH3
