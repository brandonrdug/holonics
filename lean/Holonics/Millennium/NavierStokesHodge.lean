...
namespace Holonics.Millennium.NavierStokesHodge
...
theorem smoothSolution_pressureExactOneForm_closed
  ...
  apply Holonics.Millennium.NavierStokesHodge.pressureExactOneForm_closed
...
theorem smoothSolution_pressureExactOneForm_eq_loweredGradient
  ...
  apply Holonics.Millennium.NavierStokesHodge.pressureExactOneForm_eq_loweredGradient
  exact (spatialSlice_contDiffAt_of_contDiffOn_nonnegativeTime pressure x t
...
end Holonics.Millennium.NavierStokesHodge
