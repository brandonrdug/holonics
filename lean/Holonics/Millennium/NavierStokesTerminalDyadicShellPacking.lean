...
namespace Holonics.Millennium.NavierStokesTerminalDyadicShellPacking
...
theorem continuous_openPeriodicVorticityDyadicShellSpatialSup
  ...
  exact continuous_norm.comp
    (continuous_openPeriodicVorticityBandProjector solution
      (Holonics.Millennium.NavierStokesDyadicShellProjectors.dyadicFrequencyShell level))
...
theorem criticalVorticityTerminalControl_of_terminalDyadicShellPacking
    ...
    Holonics.Millennium.NavierStokesCriticalOfficialPassage.CriticalVorticityTerminalControl := by
...
end Holonics.Millennium.NavierStokesTerminalDyadicShellPacking
