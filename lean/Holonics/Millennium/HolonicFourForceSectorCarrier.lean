...
namespace Holonics.Millennium.HolonicFourForceSectorCarrier

open Holonics.Foundation.ConnectionLineage

open Holonics
open Holonics.Geometry.SixSphereMonodromy
...
end Holonics.Millennium.HolonicFourForceSectorCarrier
