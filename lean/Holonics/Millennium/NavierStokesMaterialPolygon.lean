...
namespace Holonics.Millennium.NavierStokesMaterialPolygon
...
def ReturnedQuadrilateral.swingThenTransport (q : ReturnedQuadrilateral G) : G :=
  Holonics.Geometry.AffineSwing.swing q.left q.source + (q.right - q.left)
...
theorem ReturnedQuadrilateral.swingThenTransport_eq_flatFourth
  ...
  simp [ReturnedQuadrilateral.swingThenTransport, ReturnedQuadrilateral.flatFourth, Holonics.Geometry.AffineSwing.swing]
  abel
...
end Holonics.Millennium.NavierStokesMaterialPolygon
