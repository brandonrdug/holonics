...
namespace Holonics.Millennium.HolonicRankFourInteractionPlanes

open Holonics.Geometry.SixSphereMonodromy
open Holonics.Geometry.SixSpherePeriods
open Holonics.Geometry.SixSphereTorusFibre
...
abbrev PeriodDirection :=
  Holonics.Millennium.HolonicFourTorusCarrier.Direction
...
end Holonics.Millennium.HolonicRankFourInteractionPlanes
