...
namespace Holonics.Millennium.NavierStokesFiniteTimeVorticity
...
def PeriodicSolution.toPeriodicSolutionOn
  ...
  toSmoothSolutionOn :=
    Holonics.Millennium.NavierStokesFiniteTime.SmoothSolution.toSmoothSolutionOn
...
end Holonics.Millennium.NavierStokesFiniteTimeVorticity
