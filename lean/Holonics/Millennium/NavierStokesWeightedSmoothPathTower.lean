...
namespace Holonics.Millennium.NavierStokesWeightedSmoothPathTower
...
theorem CoherentWeightedSmoothPathTower.reconstructedVelocity_eq_base
    ...
    tower.reconstructedVelocity t =
      Holonics.Millennium.NavierStokesWeightedFourierReconstruction.reconstructedVelocity
        (base t) :=
  rfl
...
end Holonics.Millennium.NavierStokesWeightedSmoothPathTower
