...
namespace Holonics.Millennium.NavierStokesWeightedDivergenceFree
...
theorem weightedLerayDivergenceConvolution_divergenceFree_native
  ...
  let mode : Fin 3 → ℂ := fun component ↦
    (Holonics.Millennium.NavierStokesH3DivergenceBilinear.h3DivergenceConvolution
...
end Holonics.Millennium.NavierStokesWeightedDivergenceFree
