...
namespace Holonics.Millennium.NavierStokesTorusVorticity
...
theorem openPeriodicSolutionOn_vorticityField_contDiffOn_interior
  ...
  have hnhds :
      Holonics.Millennium.NavierStokesFiniteTimeVorticity.openSpaceTimeSlab S ∈ nhds z := by
    simpa [Holonics.Millennium.NavierStokesFiniteTimeVorticity.openSpaceTimeSlab] using
...
end Holonics.Millennium.NavierStokesTorusVorticity
