...
import Holonics.Millennium.HolonicFieldTheoryPassage
...
namespace Holonics.Millennium.HolonicEntropyActionInduction

open scoped BigOperators
open Holonics
open Holonics.Millennium.HolonicDiscreteInduction
open Holonics.Millennium.HolonicFourTorusCarrier
open Holonics.Millennium.HolonicRankFourInteractionPlanes
open Holonics.Millennium.HolonicInteractionExterior
open Holonics.Millennium.HolonicFourForceSectorCarrier
...
theorem CurrentBalance.telescopes
  ...
  rw [← Holonics.finite_telescoping balance.storage steps]
...
theorem entropyAxisCrossCurrent_eq_cycleWedge
    (left right : Holonics.Geometry.SixSphereMonodromy.Lattice)
...
theorem entropyAxisCrossCurrent_natural
    (transport : Holonics.Geometry.SixSphereMonodromy.LatticeEnd)
    (left right : Holonics.Geometry.SixSphereMonodromy.Lattice) :
    (fun index : Fin 6 ↦
...
end Holonics.Millennium.HolonicEntropyActionInduction

section Audit
open Holonics.Millennium.HolonicEntropyActionInduction
