...
namespace Holonics.Millennium.NavierStokesTerminalFourier

open Holonics.Millennium.NavierStokes
open Holonics.Millennium.NavierStokesOpenLifespan
open Holonics.Millennium.NavierStokesTerminalTrace
...
theorem TerminalTorusVelocityTrace.complexDot_terminalFourierCoeff_eq_zero
  ...
  have hmode :=
    Holonics.Millennium.NavierStokesTerminalFourier.TerminalTorusVelocityTrace.tendsto_continuousTorusVectorFourierCoeff
      terminal k
  change Tendsto
    (fun s : ClosedTailPreterminalTimes a T =>
      continuousTorusVectorFourierCoeff
...
end Holonics.Millennium.NavierStokesTerminalFourier
