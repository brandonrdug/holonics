...
namespace Holonics.Millennium.NavierStokesWeightedReconstructionContinuity
...
def reconstructedTorusComplexComponentCLM (component : Fin 3) :
    PeriodicVectorWeightedSobolev 3 →L[ℂ]
      C(Holonics.Millennium.NavierStokesTorusVorticity.SpatialTorus, ℂ) :=
...
end Holonics.Millennium.NavierStokesWeightedReconstructionContinuity
