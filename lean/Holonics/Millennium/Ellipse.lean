...
namespace Holonics.Millennium.Ellipse
...
theorem theFocalSumLawIsTheSwing (a r₁ r₂ : ℝ) :
    r₁ + r₂ = 2 * a ↔ r₂ = Holonics.Geometry.AffineSwing.swing a r₁ := by
  unfold Holonics.Geometry.AffineSwing.swing
...
theorem theCircleIsTheFixedPointOfTheOrbit (a r : ℝ) :
    Holonics.Geometry.AffineSwing.swing a r = r ↔ r = a := by
  unfold Holonics.Geometry.AffineSwing.swing
  constructor <;> intro h <;> linarith
...
end Holonics.Millennium.Ellipse
