...
namespace Holonics.Millennium.HolonicDiscreteInduction
...
theorem faradayHistory_telescopes
  ...
  calc
    ...
    _ = -(flux steps face - flux 0 face) := by
      rw [Holonics.finite_telescoping (fun time ↦ flux time face) steps]
...
end Holonics.Millennium.HolonicDiscreteInduction
