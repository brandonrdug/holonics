...
namespace Holonics.Millennium.NavierStokesWeightedJointSmoothnessBootstrap
...
theorem CoherentWeightedSmoothPathTower.weightedSobolevCoefficients_nativeProjectedTimeDerivative
  ...
  have hsymbol :
    ...
    have h :=
      Holonics.Millennium.NavierStokesWeightedSmoothClassicalMomentum.sum_orderedDerivativeMultiplier_diagonalSecondWord k
    change
      (∑ coordinate : Fin 3,
        orderedDerivativeMultiplier 2 (fun _ : Fin 2 ↦ coordinate) k) =
...
end Holonics.Millennium.NavierStokesWeightedJointSmoothnessBootstrap
