...
namespace Holonics.Millennium.HolonicPantographicSwingJets
...
theorem pantographicPoint_neg_one_eq_swing (anchor input : Carrier) :
    pantographicPoint anchor (-1 : Scalar) input = Holonics.Geometry.AffineSwing.swing anchor input := by
  simp [pantographicPoint, Holonics.Geometry.AffineSwing.swing]
  abel
...
end Holonics.Millennium.HolonicPantographicSwingJets
