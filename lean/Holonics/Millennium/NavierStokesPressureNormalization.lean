...
namespace Holonics.Millennium.NavierStokesPressureNormalization
...
def OpenPeriodicSolutionOn.normalizePressure
  ...
  pressureSmooth :=
    Holonics.Millennium.NavierStokesRestartSeam.OpenPeriodicSolutionOn.anchoredPressureSmooth
      solution
...
end Holonics.Millennium.NavierStokesPressureNormalization
