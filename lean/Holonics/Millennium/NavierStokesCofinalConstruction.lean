import Holonics.Millennium.NavierStokesPressureNormalization
...
namespace Holonics.Millennium.NavierStokesCofinalConstruction
...
open Holonics.Millennium.NavierStokesPressureNormalization
...
def normalizedPeriodicStateOfSolution
  ...
  solution :=
    Holonics.Millennium.NavierStokesPressureNormalization.OpenPeriodicSolutionOn.normalizePressure
      solution
  pressureNormalized :=
    Holonics.Millennium.NavierStokesPressureNormalization.OpenPeriodicSolutionOn.normalizePressure_pressureNormalized
      solution
...
theorem normalizedPeriodicState_pressure_eq
  ...
  have hagree := uniqueness.unique hnu leftOn rightOn
  have hleftSmooth :=
    Holonics.Millennium.NavierStokesOverlapUniqueness.OpenPeriodicSolutionOn.pressureSpatialSmooth
...
end Holonics.Millennium.NavierStokesCofinalConstruction
