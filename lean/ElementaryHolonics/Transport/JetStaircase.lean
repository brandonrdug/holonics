...
namespace Soma.Holonics.Transport.JetStaircase
...
theorem delta_eq_difference (f : ℕ → ℚ) :
    Delta f = Soma.Holonics.HigherDifferenceTransport.difference step () f := rfl
...
end Soma.Holonics.Transport.JetStaircase
